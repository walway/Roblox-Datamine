(!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "7649369a-e4b4-4c51-b37f-db34ff1a353d"),
      (e._sentryDebugIdIdentifier = "sentry-dbid-7649369a-e4b4-4c51-b37f-db34ff1a353d"));
  } catch (e) {}
})(),
  (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [792],
    {
      ...
      9094: (e, t, r) => {
        ...
        let n = r(90135),
          a = r(19783);
        function o(e, t) {
          return (0, a.normalizePathTrailingSlash)((0, n.addPathPrefix)(e, "/store"));
        }
        ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
          void 0 === t.default.__esModule &&
          (Object.defineProperty(t.default, "__esModule", { value: !0 }),
          ...
          ((() => {
            ...
            function n(e, t, r) {
              ...
              return function (r) {
                var n = e.exec(r);
                if (!n) return !1;
                for (var o = n[0], i = n.index, s = Object.create(null), u = 1; u < n.length; u++)
                  !(function (e) {
                    if (void 0 !== n[e]) {
                      var r = t[e - 1];
            ...
            function s(t, r, n) {
              if (t instanceof RegExp) {
                var a;
                if (!r) return t;
                for (var u = /\((?:\?<(.*?)>)?(?!\?)/g, l = 0, c = u.exec(t.source); c;)
      ...
      45700: (e, t, r) => {
        ...
        function l(e, t) {
          let {
            ...
            { parameterizedRoute: o, groups: i } = u(e, r, n),
            s = o;
        ...
        function p(e, t) {
          let { parameterizedRoute: r } = u(e, !1, !1),
            { catchAll: n = !0 } = t;
          ...
          return (
            ...
            i
              ...
              .then((r) => {
                ...
                ).then((t) => ei({ ...e, err: s, Component: u, styleSheets: l, props: t }));
              })
          );
        }
        function Q(e) {
      ...
      58340: (e, t, r) => {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }), r(55824), r(61091));
        let n = r(51467);
        ((window.next = {
          version: n.version,
          get router() {
              ...
              if (
                ...
                if (u.startsWith("/")) {
                  ...
                  return Promise.all([
                    ...
                    {
                      let e = n(u, i, s, t.query, (e) => B(e, i), r.router.locales);
                      e.matchedPage &&
        ...
        class Y {
          ...
          async change(e, t, r, a, o) {
            ...
            let es = !!(
              ...
              eu = !a.shallow && (await U({ asPath: r, locale: G.locale, router: this }));
            ...
            try {
              ...
              let s = a.shallow && G.route === (null != (T = n.route) ? T : eo),
                c = null != (A = a.scroll) ? A : !H && !s,
          ...
          async prefetch(e, t, r) {
            ...
            if (t.startsWith("/")) {
              ...
              (O || (d = (0, P.removeLocale)((0, v.removeBasePath)(o.asPath), this.locale)),
                o.matchedPage &&
                  o.resolvedHref &&
                  ((a.pathname = u = o.resolvedHref), O || (e = (0, y.formatWithValidation)(a))));
            }
      ...
      61091: (e, t, r) => {
        ...
        ((globalThis._sentryRewritesTunnelPath = void 0),
          (globalThis.SENTRY_RELEASE = { id: "7820b664c29b4b15235ad49217c53b00e6f2d065" }),
          (globalThis._sentryBasePath = void 0),
          (globalThis._sentryNextJsVersion = "15.5.15"),
          (globalThis._sentryRewriteFramesAssetPrefixPath =
            "/store/7820b664c29b4b15235ad49217c53b00e6f2d065"),
          (globalThis._sentryAssetPrefix =
            "https://assets.create.roblox.com/store/7820b664c29b4b15235ad49217c53b00e6f2d065"),
          (globalThis._sentryExperimentalThirdPartyOriginStackFrames = void 0),
          (globalThis._sentryRouteManifest =
            '{"isrRoutes":[],"dynamicRoutes":[],"staticRoutes":[]}'),
          (e.exports = r(19393)));
      },
      61481: (e, t, r) => {
        "use strict";
      ...
      92025: (e, t, r) => {
          ...
          let a = {},
            o = (r) => {
              ...
              switch (r.type) {
                ...
                case "cookie":
                  n =
                    "cookies" in e ? e.cookies[r.key] : (0, i.getCookieParser)(e.headers)()[r.key];
                  break;
                case "query":
                  n = t[o];
                  break;
        ...
        function f(e) {
          ...
          for (let r of Object.keys({ ...e.params, ...e.query }))
            r &&
              (t = t.replace(RegExp(":" + (0, n.escapeStringRegexp)(r), "g"), "__ESC_COLON_" + r));
          ...
          l && (l = u(l));
          let c = r.search;
          return (c && (c = u(c)), { ...r, pathname: o, hostname: s, href: i, hash: l, search: c });
        }
        function d(e) {
          let t,
            r,
          ...
          for (let [r, n] of (a && (t = (0, s.safeCompile)(a, { validate: !1 })),
          Object.entries(i)))
            Array.isArray(n)
              ? (i[r] = n.map((t) => c(u(t), e.params)))
              : "string" == typeof n && (i[r] = c(u(n), e.params));
    ...
    (e) => {
      (e.O(0, [593], () => e((e.s = 58340))), (_N_E = e.O()));
    }
  ]));
