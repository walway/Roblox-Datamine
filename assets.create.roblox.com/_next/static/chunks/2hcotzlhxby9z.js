          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "63efc4f3-5f5c-77fc-9b41-c9c2ae24e325");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let M = function (e) {
        let {
          ...
          {
            classes: { createButton: b, inputFormPadding: M }
          } = (0, N.default)(),
          {
            formState: D,
            handleSubmit: P,
            ...
            defaultValues: { name: c || "", confirmedName: c || "" },
            shouldUnregister: !0
          }),
          ...
          V = (0, t.useCallback)(
            async (e) => {
              ...
              try {
                (await m.default.confirmShortenedExperienceName(f, a),
                  g(i("Message.SENCreationSuccess"), !0),
                  u());
              } catch (r) {
                let a = (0, E.getResponseFromError)(r);
                if ((null == a ? void 0 : a.status) === 500)
                  return void g(i("Error.UnknownSubscriptionError"), !1);
                let c = await (null == a ? void 0 : a.json());
                switch (c.failureReason) {
                  case s.FailureReason.ShortenedNameModerated:
                    var t;
                    (R("name", null != (t = c.hint) ? t : e.name),
                      R("confirmedName", ""),
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsx)(j.DialogTitle, { children: i("Heading.SEN") }),
              ...
              children: [
                (0, a.jsxs)(k.DialogContentText, {
                  children: [
                    ...
                    (0, a.jsx)("br", {}),
                    (0, a.jsx)("br", {}),
                    (0, a.jsx)(d.Typography, { children: i("Description.SENActivationWarning") })
                  ]
                }),
                (0, a.jsxs)(y.Grid, {
                  container: !0,
      ...
      D = (0, i.withTranslation)(
        function (e) {
          let { creation: b, handleClose: h, updateItem: p } = e,
            ...
            L = (0, t.useCallback)(
              (e, t) => {
                x({
                  children: (0, a.jsx)(r.Alert, { severity: t ? "success" : "error", children: e }),
            ...
            I = (0, t.useCallback)(async () => {
              if (b.universeId) {
                let { shortenedName: e, suggestedShortenedName: a } =
                    await m.default.getOrSuggestShortenedExperienceName(b.universeId),
                  t = void 0 === e;
            ...
            N = (0, t.useCallback)(async () => {
              var e, a;
              T(!0);
              let t = (null == (e = b.subscriptionProductId) ? void 0 : e.startsWith("EXP-"))
                ? b.subscriptionProductId.slice(4)
                : b.subscriptionProductId;
              try {
                let { success: e } = await m.default.activateExperienceSubscription(
                  null != (a = b.universeId) ? a : 0,
                  null != t ? t : ""
                );
                e
                  ? (p({ ...b, productStatus: 2 }), L(_("Message.ActivateSubscriptionSuccess"), e))
            ...
            D = (0, t.useMemo)(() => {
              ...
              return w
                ? (0, a.jsx)(M, {
                    universeId: null != (t = b.universeId) ? t : 0,
                    translate: _,
                    translateHTML: k,
            ...
            }, [_, S, w, N, b.name, b.universeId, C, k, q, L, h]),
            P = (0, t.useCallback)(() => {
              I()
                .catch(() => {
                  L(_("Error.UnknownSubscriptionError"), !1);
          ...
          b.productStatus !== s.ProductStatusType.Inactive &&
            b.productStatus !== s.ProductStatusType.OffSale)
            ? null
            : (0, a.jsx)(
                l.MenuItem,
                {
        ...
        [
          b.TranslationNamespace.ConfigureItem,
          b.TranslationNamespace.Creations,
          b.TranslationNamespace.ExperienceSubscriptions
        ]
      );
    e.s(["default", 0, D], 653022);
    let P = (0, i.withTranslation)(
      function (e) {
        let { creation: c, handleClose: n, updateItem: b } = e,
          ...
          C = (0, t.useCallback)(async () => {
            var e, a;
            S(!0);
            let t = (null == (e = c.subscriptionProductId) ? void 0 : e.startsWith("EXP-"))
              ? c.subscriptionProductId.slice(4)
              : c.subscriptionProductId;
            try {
              let { success: e } = await m.default.deactivateExperienceSubscription(
                null != (a = c.universeId) ? a : 0,
                null != t ? t : "",
                !0
              );
              e
                ? (b({ ...c, productStatus: 1 }), y(x("Message.DeactivateSubscriptionSuccess"), e))
        ...
        c.productStatus !== s.ProductStatusType.OffSale)
          ? null
          : (0, a.jsx)(
              l.MenuItem,
              {
      ...
      [b.TranslationNamespace.ExperienceSubscriptions, b.TranslationNamespace.Creations]
    );
    e.s(["default", 0, P], 578268);
    var z = e.i(86125);
    let O = (0, i.withTranslation)(
      function (e) {
        let { creation: s, removeItem: c } = e,
          { enqueue: o, close: n } = (0, f.useSnackbar)(),
          { translate: b } = (0, i.useTranslation)(),
          ...
          O = (0, t.useCallback)(async () => {
            try {
              ...
              let t = (null == (a = s.subscriptionProductId) ? void 0 : a.startsWith("EXP-"))
                ...
                { success: i } = await m.default.deleteExperienceSubscription(
                  null != (e = s.universeId) ? e : 0,
                  null != t ? t : ""
                );
              i
                ? (c(), P(b("Message.SubscriptionDeleted"), i))
                : P(b("Message.SubscriptionDeletionError"), !1);
            } catch (t) {
            ...
            k();
          }, [s.universeId, s.subscriptionProductId, k, c, P, b]),
          R = (0, t.useMemo)(() => {
            var e, t;
            return (0, a.jsxs)(a.Fragment, {
              children: [
                (0, a.jsx)(j.DialogTitle, { children: b("Heading.DeleteSubscription") }),
                (0, a.jsxs)(_.DialogContent, {
                  dividers: !0,
                  children: [
                    (0, a.jsx)(d.Typography, {
                      color: "primary",
                      children: b("Message.DeleteSubscriptionConfirmation")
                    }),
                    (0, a.jsx)("br", {}),
                    (0, a.jsx)("br", {}),
                    (0, a.jsx)(d.Typography, {
                      color: "primary",
                      children: b("Message.SubscriptionDigitConfirmation", {
                    ...
                    (0, a.jsx)(h.Controller, {
                      ...
                      render: (e) => {
                        ...
                        return (0, a.jsx)(q.TextField, {
                          ...
                          required: !0,
                          id: "confirmedId",
                          label: b("Label.Last4SubscriptionIdDigits"),
                  ...
                  children: (0, a.jsxs)(y.Grid, {
                    ...
                    children: [
                      (0, a.jsx)(x.Button, {
                        ...
                        disabled: I,
                        size: "large",
                        children: b("Action.KeepSubscription")
                      }),
                      (0, a.jsx)(x.Button, {
                        classes: { root: C },
                        variant: "contained",
          ...
          }, [k, D, L, C, s.name, s.subscriptionProductId, O, M.confirmedId, I, b]),
          U = (0, t.useCallback)(() => {
            (S(R), p());
          }, [S, R, p]);
        return (
          ...
          (0, a.jsx)(
            ...
            {
              onClick: U,
              children: (0, a.jsx)(d.Typography, { color: "error", children: b("Action.Delete") })
            },
            "Action.Delete"
          )
        );
    ...
    let H = (0, i.withTranslation)(
      function (e) {
        let { creation: c, handleClose: n, updateItem: b } = e,
          ...
          E = (0, t.useCallback)(
            async (e) => {
              var a, t;
              S(!0);
              let i = (null == (a = c.subscriptionProductId) ? void 0 : a.startsWith("EXP-"))
                ? c.subscriptionProductId.slice(4)
                : c.subscriptionProductId;
              try {
                let { success: a } = await m.default.deactivateExperienceSubscription(
                  null != (t = c.universeId) ? t : 0,
                  null != i ? i : "",
                  e
                );
                if (a) {
                  let t = e ? s.ProductStatusType.Inactive : s.ProductStatusType.OffSale;
                  (b({ ...c, productStatus: t }), T(x("Message.DeactivateSubscriptionSuccess"), a));
        ...
        c.productStatus !== s.ProductStatusType.Active)
          ? null
          : (0, a.jsx)(
              l.MenuItem,
              {
  ...
  (e) => {
    ...
    let ed = {
      ...
      tokens: { light: ei.default, dark: ec.default },
      chart: { light: L.default, dark: A.default },
      badge: { light: m.default, dark: f.default },
    ...
    let em = (0, s.makeStyles)()(() => ({
      ...
      eg = (e) => {
        let { illustration: t, size: s = "large" } = e,
          c = t && ed[t];
        if (c) return (0, a.jsx)(i.default, { lightSrc: c.light, darkSrc: c.dark, alt: t });
        let r = t ? ef[s][t] : null;
        return (
          r &&
          (0, a.jsx)("img", {
      ...
      eb = (e) => {
        ...
        return (0, a.jsxs)(c.default, {
          classes: { root: m({ [l]: "small" === o, [d]: "large" === o }) },
          flexDirection: "column",
          alignItems: "center",
          children: [
            (0, a.jsx)(eg, { illustration: n, size: o }),
            (0, a.jsxs)(c.default, {
              classes: { root: m({ [u]: "small" === o, [f]: "large" === o }) },
              flexDirection: "column",
              alignItems: "center",
              children: [
    ...
    var h = (0, s.default)({ name: "AlertTitle" })(function (e) {
      ...
      p = (0, t.forwardRef)(function (e, s) {
        var i = e.classes,
          ...
          n = h(void 0, { props: { classes: (0, c.default)(i, r) } });
        return t.default.createElement(b, (0, a._)({}, o, { classes: n.classes, ref: s }));
      });
        ...
        [
          ...
          function (e) {
            ...
            return t.default.createElement(
              s.M,
              (0, a._)({}, i, { ref: c, viewBox: "0 0 28 28" }),
...
//# debugId=63efc4f3-5f5c-77fc-9b41-c9c2ae24e325
//# sourceMappingURL=398q_cro2eydd.js.map
