          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "da4b0b94-3e11-4eea-6dd3-516c0caf24bc");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
      ...
      w = (0, o.withTranslation)(
        (e) => {
          ...
          let { universeId: C, showCallToAction: A = !0 } = e,
            ...
            M = (0, r.useRef)(!1),
            [F, U] = (0, r.useState)(!1),
            L = (null == P ? void 0 : P.ageBracket) === n.AgeBracketEnum.Over18,
            G = (null == P ? void 0 : P.ageBracket) === n.AgeBracketEnum.Between13And18,
            O =
              null !=
                (w =
                  null == P
                    ? void 0
                    : P.creatorEligibility.includes(n.CreatorEligibilityEnum.IdVerified)) && w,
            B = L || G,
            H = _ && x && !(N || D) && !!P && !O;
          (0, r.useEffect)(() => {
            H &&
  ...
  (e) => {
    ...
    var t = e.i(364494),
      r = e.i(650502),
      a = e.i(272593);
    let n = (0, r.getBEDEV2ServiceBasePath)("universe-analytics-insights"),
      i = (0, a.createClientConfiguration)("universe-analytics-insights", "bedev2"),
      ...
      l = {
        ...
        getUniverseBenchmarkScorecard: async (e) => {
          var t, r;
          let a = await s.v2UniversesUniverseIdInsightsBenchmarkScorecardGet(e);
          if (
            !a ||
            !a.metricTime ||
            void 0 === a.currentValue ||
            void 0 === a.currentPercentile ||
            void 0 === a.percentChange ||
            (null == (t = a.percentileMap) ? void 0 : t["50"]) === void 0 ||
            (null == (r = a.percentileMap) ? void 0 : r["90"]) === void 0 ||
            void 0 === a.availableBenchmarks ||
            void 0 === a.benchmarkTime ||
            void 0 === a.metricCurrentValue ||
            void 0 === a.metricPercentChange ||
            void 0 === a.recommendedType
          )
            throw Error(
          ...
          let n = new Map(),
            i = new Set();
          return (
            a.availableBenchmarks &&
              a.availableBenchmarks.forEach((e) => {
                e.benchmarkType && (n.set(e.benchmarkType, e), i.add(e.benchmarkType));
              }),
            {
              metricTime: a.metricTime,
              currentValue: a.currentValue,
              currentPercentile: a.currentPercentile,
              percentChange: a.percentChange,
              P50Value: a.percentileMap["50"],
              P90Value: a.percentileMap["90"],
              availableBenchmarks: a.availableBenchmarks,
              benchmarkTime: a.benchmarkTime,
              metricCurrentValue: a.metricCurrentValue,
              metricPercentChange: a.metricPercentChange,
              recommendedType: a.recommendedType,
              benchmarkDataByType: n,
    ...
    async function n(e, i, s) {
      ...
      return (
        await new Promise((e, t) => {
          ...
          let a = setTimeout(() => {
              (null == s || s.removeEventListener("abort", n), e());
            }, 1e3),
            n = () => {
              (clearTimeout(a), t(r()));
            };
          null == s || s.addEventListener("abort", n, { once: !0 });
        }),
        n(e, i + 1, s, d)
      );
    }
  ...
  (e) => {
    ...
    let r = (0, e.i(272593).createClientConfiguration)("experience-releases", "bedev2"),
      ...
      o = async (e) => await a.v1beta1ExperienceReleasesApiMultiReleaseStatusesPost(e);
    e.s([
  ...
  (e) => {
    ...
    async function i(e, r, s) {
      ...
      if (h && (null == m ? void 0 : m.error) == null) {
        let e = null == m || null == (l = m.response) ? void 0 : l.assetId,
          r = e ? e.toString() : "",
          i = await t.default.updateAssetAndGetOperationId(s, n, {
            assetId: s,
    ...
    async function o(e, a, n, s, o) {
      let l = {
          assetType: r.AssetType.Image,
          displayName: "Asset Icon",
          creationContext: { creator: n ? { groupId: o } : { userId: s } }
        },
        c = await fetch(a)
          .then((e) => e.blob())
    ...
    async function l(e, a, n, s, o) {
      let l = {
          assetType: r.AssetType.Image,
          displayName: "Asset Icon",
          creationContext: { creator: n ? { groupId: o } : { userId: s } }
        },
        c = await t.default.createAssetAndGetOperationId(l, a, !0);
      await i(c, 0, e);
    }
    e.s([
  ...
  (e) => {
    ...
    let i = (e) => {
      ...
      return (0, t.jsxs)(r.Grid, {
        ...
        children: [
          (0, t.jsx)(r.Grid, {
            item: !0,
            children: (0, t.jsx)(a.Typography, { variant: o.metricsTypographyVariant, children: i })
          }),
          (0, t.jsx)(r.Grid, {
            item: !0,
    ...
    e.s(
      [
        ...
        0,
        (e) => {
          let { metrics: n, metricsHeader: s, valuesHeader: o, styleConfig: l } = e,
            c = n.map((e) =>
              (0, t.jsx)(
                r.Grid,
                {
    ...
    e.s([
      ...
      () => {
        let e = (0, i.useAnalyticsOwnerOverride)(),
          ...
          c = null != l,
          u = c ? a.OwnerType.Group : a.OwnerType.User,
  ...
  (e) => {
    ...
    let u = {
        INSIGHT_TYPE_PERCENT_CHANGE: {
          header: (0, a.translationKey)("Header.WeeklyChange", s.TranslationNamespace.Insights),
          button: (0, a.translationKey)(
            "Action.ExploreThisMetric",
            s.TranslationNamespace.Insights
          ),
          caption: (0, a.translationKey)("Caption.WeeklyChange", s.TranslationNamespace.Insights)
        },
        INSIGHT_TYPE_LOW_END_ANDROID_CRASH_RATE: {
          header: (0, a.translationKey)(
            "Header.LowEndAndroidOpportunity",
            s.TranslationNamespace.Insights
          ),
          button: (0, a.translationKey)("Action.TakeActionNow", s.TranslationNamespace.Insights),
          caption: (0, a.translationKey)(
        ...
        INSIGHT_TYPE_SUMMARY_REPORT: {
          ...
          button: (0, a.translationKey)("Action.ViewReport", s.TranslationNamespace.Insights),
          caption: (0, a.translationKey)(
        ...
        INSIGHT_TYPE_PLAYER_FEEDBACK_REPORT_7_DAYS: {
          header: (0, a.translationKey)("Header.FeedbackReport", s.TranslationNamespace.Insights),
          button: (0, a.translationKey)("Action.ViewReport", s.TranslationNamespace.Insights),
          caption: { key: "", namespace: void 0 }
        },
        ...
        INSIGHT_TYPE_ADS_PERFORMANCE_7_DAYS: {
          header: (0, a.translationKey)("Header.AdsPerformance", s.TranslationNamespace.Insights),
          button: (0, a.translationKey)("Action.ViewAdsManager", s.TranslationNamespace.Insights),
          caption: { key: "", namespace: void 0 }
        }
      },
      d = {
      ...
      [
        ...
        (e, t) =>
          t === o.default.QualifiedPTRAndImpressionComparison
            ? (0, a.translationKey)("Action.ExploreRFYSignals", s.TranslationNamespace.Insights)
            : u[e].button,
        ...
        (e, t, r) => {
          ...
          switch (a) {
            case "INSIGHT_TYPE_PERCENT_CHANGE": {
              let { benchmarkComparisonRank: a, benchmarkPercentChange: s } = r.captionInfo;
              return e(u.INSIGHT_TYPE_PERCENT_CHANGE.caption, {
                benchmarkPercentChange:
                  (s > 0 ? "+" : "") +
                  (0, n.formatNumberWithSpec)(s, i.percentageFormattingSpec, {
                    translate: e,
                    locale: t
                  }),
                benchmarkComparisonRank: (0, n.formatNumberWithSpec)(
                  a,
                  {
                    abbreviate: !1,
            ...
            case "INSIGHT_TYPE_LOW_END_ANDROID_CRASH_RATE": {
              let { totalCrashRate: a } = r.captionInfo;
              return e(u.INSIGHT_TYPE_LOW_END_ANDROID_CRASH_RATE.caption, {
                percentage: (0, n.formatNumberWithSpec)(a, i.percentageFormattingSpec, {
                  translate: e,
                  locale: t
                })
              });
            ...
            case "INSIGHT_TYPE_ADS_PERFORMANCE_7_DAYS":
              return null;
            default:
              throw Error("Unhandled Insight type ".concat(String(a)));
          }
        },
        ...
        return {
          topics: c.reduce((n, i) => {
            let o = i.data.topic_list.topics
              ...
              .map((n) => {
                var i;
                let s = a(n.created_at, e) || m(n.created_at, 2);
                (s && (d = !0), p.add(n.id));
                let o = ((e) => {
                  if (!e) return null;
                ...
                return {
                  ...
                  users: n.posters.map((e) => u[e.user_id]),
        ...
        try {
          ...
          try {
            if (o) {
              ...
              try {
                l({ placeId: m, userId: o, file: a, assetType: i.AssetType.Image, price: 0 });
              } catch (r) {
                let e =
                  r instanceof Error
                    ? r
    ...
    e.s(
      [
        ...
        (e) => {
          ...
          return (0, n.jsx)("div", { className: s(a, null == t ? void 0 : t.root), children: r });
        }
      ],
      110621
    );
  ...
  (e) => {
    ...
    let i = (e) => {
      ...
      return (0, t.jsx)(a.Avatar, {
        className: l,
        variant: o.creatorType === n.default.Group ? "rounded" : "circular",
        alt: "avatar",
        children: (0, t.jsx)(r.Thumbnail2d, {
          targetId: null != (i = o.creatorId) ? i : 0,
          type:
            o.creatorType === n.default.Group
  ...
  (e) => {
    ...
    var t = e.i(221628),
      ...
      l = e.i(789283),
      c = e.i(982690);
    let { getCurrentPlatform: u } = a.device,
    ...
    e.s([
      ...
      (e) => {
        ...
        let { children: g, onClickNext: f, onClickPrevious: y, contentStyle: v } = e,
          ...
          P = (0, r.useMemo)(() => b === a.Platform.iOS || b === a.Platform.Android, [b]),
          {
            classes: {
              wrapper: N,
              carousel: D,
  ...
  (e) => {
    ...
    var t = e.i(221628),
      ...
      n = e.i(706442),
      i = e.i(982690);
    let { getCurrentPlatform: s } = a.device,
      o = (0, n.makeStyles)()((e) => ({
        wrapper: { position: "relative" },
        carousel: {
          overflowX: "hidden",
      ...
      [
        ...
        (e) => {
          let { pollForCompletedOperationAsync: t } = (0, s.default)(),
            ...
            { mutate: c, mutateAsync: u } = (0, a.useMutation)({
              mutationFn: async (e) => {
                var r;
                let {
                    placeId: a,
                ...
                let f = g.response,
                  ...
                  v = await i.default.updateAssetAndGetOperationId(a, [i.FieldMask.PREVIEWS], {
                    assetId: a,
                    previews: y
                  }),
                  b = await l(v);
          ...
          let { user: t } = (0, l.useAuthentication)(),
            { mutate: n, mutateAsync: i } = (0, a.useMutation)({
              mutationFn: async (e) => {
                ...
                await (0, c.setAutogeneratedPlaceIcon)(a, r, !1, null == t ? void 0 : t.id, void 0);
              },
              retry: !0,
              onSuccess: e,
              onError: (e) => {
      ...
      function (e, t) {
        ...
        return "prev" === t
          ...
          : (function (e) {
              ...
              if (i <= 0) return t;
              let { offsetLeft: s, offsetWidth: o } = n[i - 1];
              return s + o - r;
            })(i) || r;
      }
    ]);
    ...
    e.s([
      ...
      function () {
        ...
        return (0, t.useQuery)({
          ...
          queryFn: async () => a.default.coreContentGetCreatorEligibility({ userId: o }),
          enabled: n && !!o
        });
      }
    ]);
  ...
  (e) => {
    ...
    let s = (0, e.i(272593).createClientConfiguration)("creator-settings", "bedev2"),
      o = new n.CreatorSettingsAPIApi(s),
            ...
            queryFn: async () => {
              ...
              return null !=
                (r = (
                  ...
                  o.v1NotificationsSettingsPost(n))
                ).categories)
                ? r
                : [];
            },
      ...
      [
        ...
        function (e, t) {
          ...
          return (0, r.useQuery)({
            ...
            queryFn: () => E(e, t),
            retry: (e, t) => (t instanceof l || t instanceof c) && e < n,
            retryDelay: i,
            enabled: a && e !== s.uninitializedUniverseId
          });
        },
        ...
        (e, t, a, n) =>
          (0, r.useQuery)({
            queryKey: ["getInsights", e, ...t, null != a ? a : null, null != n ? n : null],
            queryFn: () => b(e, t, a, n),
            enabled: e !== s.uninitializedUniverseId
          }),
              ...
              children: (0, t.jsx)("div", {
                ...
                children: E.map((e) => {
                  ...
                  return (0, t.jsxs)(
                    "div",
                    {
                      className: (0, n.clsx)("flex gap-medium", y ? "items-start" : "items-center"),
                      children: [
                        r,
                        (0, t.jsxs)("div", {
                          className: (0, n.clsx)(
          ...
          i.default.createElement(
            "div",
            {
              className: (0, n.default)(
                ...
                F ? "items-start" : "items-center wrap"
              )
            },
            i.default.createElement(
              "div",
                  ...
                  i.default.createElement(
                    "div",
                    {
                      className: (0, n.default)(
                        ...
                        F ? "min-width-0" : "grow-1 basis-0 min-width-[min(200px,100%)]"
                      )
                    },
                    y &&
                      M &&
                    ...
                    i.default.createElement(
                      "span",
                      {
                        className: (0, n.default)(
                          ...
                          F ? "" : "block padding-y-xsmall min-width-0 grow-1 basis-0"
                        )
                      },
                      p
                    )
      ...
      p = (0, r.forwardRef)(function (e, l) {
        ...
        return r.default.createElement(
          ...
          r.default.createElement(
            ...
            r.default.createElement(a.default, { classes: { root: T }, variant: "h3" }, v),
          ...
          !F &&
            ...
            r.default.createElement(
              "div",
              { className: P, style: { width: "min(30%, ".concat(Y, "px)") } },
              r.default.createElement("img", {
                ...
                onLoad: function (e) {
                  ...
                  G(t.naturalWidth / t.naturalHeight);
                }
              })
            ),
          E &&
  ...
  (e) => {
    ...
    var _ =
      ...
      class extends E.Subscribable {
        ...
        setQueries(e, t) {
          ((0, v._)(this, a, e),
            ...
            C.notifyManager.batch(() => {
              let e = (0, f._)(this, i),
                t = (0, b._)(this, p, T).call(this, (0, f._)(this, a));
              ((0, v._)(this, c, t),
              ...
              let n = t.map((e) => e.observer),
                ...
                d =
                  ...
                  s.some((e, t) => {
                    ...
                    return !a || !(0, I.shallowEqualObjects)(e, a);
                  });
              (u || d) &&
                (u && (0, v._)(this, i, n),
                (0, v._)(this, r, s),
        ...
        getOptimisticResult(e, t) {
          ...
          return [
            a,
            (e) => (0, b._)(this, d, k).call(this, null != e ? e : a, t),
            () => (0, b._)(this, u, x).call(this, a, r)
          ];
        }
        constructor(e, g, f) {
          (super(),
        ...
        e.forEach((e) => {
          ...
          i
            ...
            : a.push({
                ...
                observer: new A.QueryObserver((0, f._)(this, t), n)
              });
        }),
        a
      );
    ...
    function R(e, t) {
      ...
      if (-1 !== a) {
        var n;
        let e;
        ((0, v._)(this, r, ((n = (0, f._)(this, r)), ((e = n.slice(0))[a] = t), e)),
          (0, b._)(this, h, P).call(this));
      }
    }
    function P() {
      if (this.hasListeners()) {
        var e;
        let t = (0, f._)(this, s),
          a = (0, b._)(this, u, x).call(this, (0, f._)(this, r), (0, f._)(this, c));
        t !==
          (0, b._)(this, d, k).call(
            this,
            a,
    ...
    e.s(
      [
        ...
        function (e, t) {
          ...
          let [l] = g.useState(() => new _(n, o, a)),
            [c, u, d] = l.getOptimisticResult(o, a.combine),
            p = !i && !1 !== a.subscribed;
      ...
      function r(e) {
        ...
        return (
          ...
          Object.defineProperty(o, "enabled", {
            ...
            configurable: !1,
            get: () =>
              null !== s ? s : (n !== r.namespaces && ((n = r.namespaces), (i = r.enabled(e))), i),
            set: (e) => {
              s = e;
            }
          }),
...
//# debugId=da4b0b94-3e11-4eea-6dd3-516c0caf24bc
//# sourceMappingURL=1skuru73ihqmz.js.map
