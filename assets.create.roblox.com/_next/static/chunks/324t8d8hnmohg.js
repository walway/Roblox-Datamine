...
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
      ...
      function (e, s) {
        ...
        ((0, a.useMemo)(() => {
          ...
          (0, a.useEffect)(() => {
            ...
            let a = new IntersectionObserver(u, { threshold: null != c ? c : 0.5 });
            return (
              a.observe(e.current),
              () => {
                a.disconnect();
  ...
  (e) => {
    ...
    let ed = {
      ...
      noUsers: { light: b.default, dark: f.default },
      ...
      badge: { light: m.default, dark: g.default },
    ...
    let em = (0, r.makeStyles)()(() => ({
      ...
      eh = (e) => {
        ...
        return (0, a.jsxs)(s.default, {
          classes: { root: m({ [l]: "small" === n, [d]: "large" === n }) },
          flexDirection: "column",
          alignItems: "center",
          children: [
            (0, a.jsx)(ep, { illustration: i, size: n }),
            (0, a.jsxs)(s.default, {
              classes: { root: m({ [u]: "small" === n, [g]: "large" === n }) },
              flexDirection: "column",
              alignItems: "center",
              children: [
  ...
  (e) => {
    e.q(
      "https://assets.create.roblox.com/8740eac218911649d4556ec0f9a5a366c21ec8d2/_next/static/media/alert_dark.1spa8ixzmujxs.svg"
    );
  },
  858517,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/8740eac218911649d4556ec0f9a5a366c21ec8d2/_next/static/media/alert_light.3o6_fob3g_8zu.svg"
    );
  },
  343885,
  (e) => {
  ...
  (e) => {
    ...
    var f = (0, r.default)({ name: "AlertTitle" })(function (e) {
      ...
      b = (0, t.forwardRef)(function (e, r) {
        var o = e.classes,
          ...
          i = f(void 0, { props: { classes: (0, s.default)(o, c) } });
        return t.default.createElement(h, (0, a._)({}, n, { classes: i.classes, ref: r }));
      });
  ...
  (e) => {
    ...
    let b = (0, i.s)("span", { name: "MuiRadioButtonIcon", shouldForwardProp: i.r })({
      ...
      v = (0, i.s)(h, { name: "MuiRadioButtonIcon" })({ transform: "scale(1)" }),
      x = (0, i.s)(f, { name: "MuiRadioButtonIcon" })((e) => {
      ...
      function (e) {
        ...
        return t.default.createElement(
          ...
          t.default.createElement(
            r.S,
            (0, a._)({}, (null == (o = f[0]) ? void 0 : o.props) || {}, d, {
              TransitionProps: (0, a._)(
                (0, a._)(
                  {},
                  (null == (n = null == (c = f[0]) ? void 0 : c.props)
                    ? void 0
                    : n.TransitionProps) || {}
                ),
                {
                  onExited: function (e) {
                    ...
                    (b(function (e) {
                      ...
                      (null == (r = null == (t = f[0]) ? void 0 : t.props.TransitionProps)
                        ? void 0
                        : r.onExited) &&
                        (null == (o = null == (s = f[0]) ? void 0 : s.props.TransitionProps) ||
                          o.onExited(e)));
                  }
                }
              ),
              onClose: function (e, a) {
                var t, r, s;
                ((null == (t = f[0]) ? void 0 : t.shouldClose(a)) && p(!1),
                  (null == (r = f[0]) ? void 0 : r.props.onClose) &&
                    (null == (s = f[0]) || s.props.onClose(e, a)));
              },
              open: m
            }),
    ...
    e.s([
      ...
      (e) => {
        ...
        let { children: n, unifiedLogger: i, pageLoggerConfig: l, path: d } = e,
          ...
          m = (0, a.useMemo)(() => ({ tags: u, rosId: g, path: d }), [u, g, d]),
          p = (0, a.useRef)(m),
          h = (0, a.useRef)(m);
        ((0, a.useLayoutEffect)(() => {
          ((h.current = m),
            void 0 === p.current.path &&
              void 0 !== m.path &&
              (p.current = { ...p.current, path: m.path }));
        }, [m]),
          (0, a.useLayoutEffect)(() => {
            let e = (e) => {
              var a;
        ...
        let f = (0, a.useMemo)(() => ({ unifiedLogger: i, pageContext: m }), [i, m]);
        return a.default.createElement(t.Provider, { value: f }, n);
      },
