          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "d5afe47b-332c-a976-4888-9bca0f688e8d");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let R = ["slots", "slotProps"],
      M = (0, I.s)(w.B, { name: "MuiBreadcrumbCollapsed" })((e) => {
        let { theme: t } = e;
        return (0, T._)(
          {
            display: "flex",
            ...
            : { backgroundColor: t.palette.grey[700], color: t.palette.grey[100] },
          {
            ...
            "&:active": (0, T._)(
              ...
              "light" === t.palette.mode
                ? { backgroundColor: (0, x.n)(t.palette.grey[200], 0.12) }
                : { backgroundColor: (0, x.n)(t.palette.grey[600], 0.12) }
            )
          }
        );
      }),
    ...
    let _ = [
      ...
      z = (0, I.s)(S.T, {
        name: "MuiBreadcrumbs",
        slot: "Root",
        overridesResolver: (e, t) => [{ ["& .".concat(G.li)]: t.li }, t.root]
      })({}),
    ...
    var K = (0, N.default)({ name: "Breadcrumbs" })(function (e) {
      ...
      q = (0, a.forwardRef)(function (e, t) {
        ...
        return a.default.createElement(F, (0, k._)({ classes: o.classes }, i, { ref: t }));
      });
    ...
    let et = (e, t) =>
      ...
      en = {
        ...
        "game-details": {
          displayName: (e) => {
            let { translate: t } = e;
            return et({ key: "Heading.GameDetails" }, t);
          },
        ...
        "content-rating": {
          displayName: (e) => {
            let { translate: t } = e;
            return et({ key: "Heading.ContentRatings" }, t);
          },
        ...
        "game-join": {
          displayName: (e) => {
            let { translate: t } = e;
            return et({ key: "Title.GameJoin" }, t);
          },
      ...
      ec = (0, i.withTranslation)(
        (e) => {
          let { inLayoutHeader: i = !1 } = e,
            ...
            x = "string" == typeof s.dashboardId ? s.dashboardId : void 0,
            I = "string" == typeof s.id ? s.id : void 0,
            P =
              o.endsWith("/analytics/dashboards/[dashboardId]/edit") && I && x
                ? "/dashboard/creations/experiences/".concat(I, "/analytics/dashboards/").concat(x)
                : void 0,
            w = (0, a.useCallback)(
              (e, a) =>
                g
            ...
            { breadcrumbsContents: D, breadcrumbNames: R } = (0, a.useMemo)(() => {
              let e = (e) => {
                  if (e.withId) {
                    var t;
                ...
                (n, r, s) => {
                  ...
                  if (s === a.length - 1) {
                    ...
                    if (
                      ...
                      return {
                        contents: [
                          ...n.contents,
                          w(e, el(o, null == (c = r.getLinkPath) ? void 0 : c.call(r, C))),
                          w(s, P)
                        ],
                        names: [...n.names, e, s]
                      };
                  ...
                  return m
                    ? {
                        contents: [
                          ...n.contents,
                          w(m, null == (l = u.getLinkPath) ? void 0 : l.call(u, C))
                        ],
                        names: [...n.names, m]
                      }
                    : n;
            ...
            }, [k, i, h, T, N, C, c, w, P, A, o]),
            M = (0, a.useMemo)(() => R[R.length - 1], [R]),
            L = (0, a.useMemo)(() => (0, n.buildBreadcrumb)(...R), [R]),
            j = E && (0, t.jsx)(n.HubMeta, { title: M, breadcrumb: L, seoTitle: E, ...H });
          return h
            ? (0, t.jsxs)(m.Grid, {
        ...
        [
          ...
          h.TranslationNamespace.Publishing
        ]
      ),
      ed = () => {
        let {
      ...
      em = (0, i.withTranslation)(
        (e) => {
          ...
          let {
            ...
            x = a.default.isValidElement(o) && o.type === i.Translate,
            I =
              "string" == typeof o
        ...
        [
          ...
          (e) => {
            let {
              ...
              { translate: x } = (0, i.useTranslation)(),
              I =
                "string" == typeof p
                  ? x(p)
                  : a.default.isValidElement(p) && p.type === i.Translate
                    ? x(p.props.translationKey, p.props.args)
                    : void 0;
      ...
      [
        ...
        (e) => {
          let {
            ...
            { translate: w } = (0, n.useTranslation)(),
            [A, S] = (0, a.useState)(!1),
            [E, H] = (0, a.useState)(),
            D = (0, a.useCallback)(async function (e, t, a) {
              let n = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
              if (t && e) {
                S(!0);
                try {
                  let i = n
                      ? r.ThumbnailClient.reloadThumbnailImage
                      : r.ThumbnailClient.getThumbnailImage,
                    o = await i(e, t, a);
                  H(o);
                } catch (e) {
                  H({ state: i.ThumbnailResponseState.TemporarilyUnavailable });
                } finally {
                  S(!1);
                }
              }
            ...
            R = (0, a.useMemo)(() => {
              ...
              switch (null == E ? void 0 : E.state) {
                case i.ThumbnailResponseState.InReview:
                  ((e = w("Label.InReview")),
                    (a = (0, t.jsx)(l.HourglassEmptyIcon, {
                      fontSize: "large",
                ...
                case i.ThumbnailResponseState.TemporarilyUnavailable:
                  ((e = w("Label.Unavailable")),
                    (a = (0, t.jsx)(o.BrokenImageOutlinedIcon, {
                      fontSize: "large",
                      color: "dark" === f ? void 0 : "secondary"
                    })));
                  break;
            ...
            }, [p, y, g, D]),
            {
              thumbnailImage: (0, t.jsx)(s.Grid, {
                ...
                children: (0, t.jsxs)("div", {
                  className: T,
                  children: [
                    (null == E ? void 0 : E.state) === i.ThumbnailResponseState.Completed
                      ? (0, t.jsx)("img", {
                          className: x,
                          src: null == E ? void 0 : E.imageUrl,
                          alt: b
                        })
                      : (0, t.jsx)("div", { className: C, children: R }),
                    v ? (0, t.jsx)("div", { className: I, children: v }) : null
                  ]
                })
              }),
              thumbnailData: E,
  ...
  (e) => {
    ...
    let E = (0, A.makeStyles)()(() => ({
                  ...
                  children: (() => {
                    ...
                    if (y)
                      return g
                        ...
                        : l(M, [{ opening: "aTagStart", closing: "aTagEnd", content: b }], {
                            lineBreak: v
                          });
                    let e = g
                      ? {
                    ...
                    if ("signal-with-changes" === i.scenario)
                      return g ? k(R, f) : l(D, e.tags, e.args);
                    let t = g ? R : D;
      ...
      G = (e) => {
        let { inline: r = !1 } = e,
          { translate: o, translateHTML: s } = (0, x.useTranslation)(),
          l = (0, x.useLocalization)(),
        ...
        let { user: I } = (0, S.useAuthentication)(),
          ...
          M = (0, a.useMemo)(
            () => (l.locale ? (0, x.toRobloxLocale)(l.locale) : "en_us"),
            [l.locale]
          ),
          L = (0, a.useMemo)(() => {
  ...
  (e) => {
    ...
    let o = (0, n.createContext)({
      ...
      c = { Small: "padding-top-large", Medium: "padding-top-xlarge", Large: "padding-top-xlarge" },
      d = {
      ...
      u = (e) => {
        ...
        return (
          ...
          n.default.createElement(
            o.Provider,
            { value: h },
            n.default.createElement(r.Root, { open: t, onOpenChange: a }, i)
          )
        );
      };
    ...
    let p = (e) => {
      let {
        ...
        { size: m, isModal: y, hasCloseAffordance: g, closeLabel: h, hasDescription: b } = s(),
        f = (0, a.default)(
          "foundation-web-dialog-overlay padding-medium foundation-web-portal-zindex",
          y && "bg-common-backdrop",
          c
        ),
        v = (0, a.default)(
    ...
    let m = (e) => {
      let { children: t, className: r, ...i } = e,
        ...
        m = (0, a.default)(l[o], u && c[o], p && d[o], r);
      return n.default.createElement("div", { className: m, ...i }, t);
    };
    m.displayName = "DialogBody";
    let y = (e) => {
      let { children: t, className: a, hidden: o, ...s } = e,
        l = n.default.createElement(r.Title, { className: a, ...s }, t);
    ...
    let g = (e) => {
      let { children: t, className: r, ...i } = e,
        { size: o } = s(),
        c = (0, a.default)(l[o], d[o], r);
      return n.default.createElement("div", { className: c, ...i }, t);
    };
  ...
  (e) => {
    ...
    var A,
      S,
      E =
        (((A = E || {}).BannerTitle = "Heading.CookieBanner"),
        (A.CookieBannerContent = "Description.CookieBannerContent"),
        (A.CookieBannerButton = "Action.CookieBanner"),
        (A.PrivacyPolicy = "Description.PrivacyPolicy"),
        (A.ConsentToolModalTitle = "Heading.CookieSettings"),
        (A.SaveBtn = "Action.SavePreferences"),
        (A.CancelBtn = "Action.Cancel"),
        (A.InfoCollectionHeader = "Heading.InformationCollection"),
        (A.InfoCollectionContent = "Description.InformationCollection"),
        (A.InfoCollectionHeader2 = "Heading.InformationCollection2"),
        (A.InfoCollectionContent2 = "Description.InformationCollection2"),
        (A.InfoPartnerCollectionHeader = "Heading.InformationPartnerCollection"),
        (A.InfoPartnerCollectionContent = "Description.InformationPartnerCollection"),
        (A.RBXViralAcquisition = "RBXViralAcquisition"),
        (A.RBXViralAcquisitionDescription = "Description.RBXViralAcquisition"),
        (A.RBXSource = "RBXSource"),
        (A.RBXSourceDescription = "Description.RBXSource"),
        (A.GoogleAnalytics = "Heading.GoogleAnalytics"),
        (A.OwnedBy = "Label.OwnedBy"),
        (A.GoogleInc = "Google Inc."),
        (A.Website = "Label.Website"),
        (A.GoogleAnalyticsPurposeHeader = "Heading.GoogleAnalyticsPurpose"),
        (A.GoogleAnalyticsPurposeDescription = "Description.GoogleAnalyticsPurpose"),
        (A.CompanyCollectionHeader = "Heading.CompanyCollection"),
        (A.DataCollected = "Label.DataCollected"),
        (A.DataCollectedContent = "Description.DataCollected"),
        (A.DataSharing = "Label.DataSharing"),
        (A.DataSharingContent = "Description.DataSharing"),
        (A.DataRetention = "Label.DataRetention"),
        (A.DataRetentionContent = "Description.DataRetention"),
        (A.DataUse = "Label.DataUse"),
        (A.DataUseContent = "Description.DataUse"),
        (A.DataStorage = "Label.DataStorage"),
        (A.DataStorageContent = "Description.Undisclosed"),
        (A.RequestData = "Action.RequestData"),
        (A.SetCookieOptions = "Action.SetCookieOptions"),
        (A.DeclineAll = "Action.DeclineAll"),
        (A.AcceptAll = "Action.AcceptAll"),
        (A.EssentialCookie = "Heading.EssentialCookies"),
        (A.AnalyticsCookie = "Heading.AnalyticsCookies"),
        (A.GAReadMore = "Description.GAReadMore"),
        (A.GAReadMoreUrl = "{googleAnalyticsLink}"),
        A);
    let H = (0, n.makeStyles)()((e) => ({
          ...
          b = (0, a.useMemo)(
            () =>
              a.default.createElement(
                o.Link,
                { href: x, target: "_blank", underline: "hover", color: "inherit" },
                y(E.PrivacyPolicy)
              ),
            [y]
          ),
      ...
      R = "RBXcb",
      M = { RBXViralAcquisition: !0, RBXSource: !0, GoogleAnalytics: !0 },
    ...
    let O = (e) => {
        ...
        return m
          ? a.default.createElement(
              ...
              a.default.createElement(
                ...
                a.default.createElement(q, { href: x, text: u(E.PrivacyPolicy) }),
                a.default.createElement(
                  "div",
      ...
      J = (e) => {
        let { isOpen: t, onClose: n, onSave: r } = e,
          { cookiePolicy: i, acceptAll: o, declineAll: s, hasAcceptedAnalyticsCookie: l } = j(),
          [c, d] = (0, a.useState)(l),
          u = (0, a.useCallback)(() => {
            (c ? o() : s(), r());
          }, [o, s, c, r]);
      ...
      Q = (0, t.withTranslation)(() => {
        let { acceptAll: e, declineAll: t, shouldShowBanner: n } = j(),
          [r, i] = (0, a.useState)(!1),
          [o, s] = (0, a.useState)(!1);
        (0, a.useEffect)(() => {
          n && s(!0);
      ...
      [
        ...
        (e) => {
            ...
            g = (0, a.useMemo)(
              () =>
                ...
                (!!(null == s ? void 0 : s.ShouldDisplayCookieBannerV3) &&
                  !(
                    !("u" < typeof document) &&
                    document.cookie.split("; ").some((e) => e.startsWith("".concat(R, "=")))
                  )),
          ...
          let h = (0, a.useCallback)((e, t) => {
            ...
            b = (0, a.useCallback)(() => {
              if (!s) return;
              let e = s.NonEssentialCookieList.reduce((e, t) => ({ ...e, [t]: !0 }), M);
              (B(e), d(e));
            }, [s]),
            f = (0, a.useCallback)(() => {
              if (!s) return;
              let e = s.NonEssentialCookieList.reduce((e, t) => ({ ...e, [t]: !1 }), M);
              (B(e), d(e));
            }, [s]),
...
//# debugId=d5afe47b-332c-a976-4888-9bca0f688e8d
//# sourceMappingURL=0lpkackb1t_h2.js.map
