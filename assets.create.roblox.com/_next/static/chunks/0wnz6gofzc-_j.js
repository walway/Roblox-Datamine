          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "c461ffea-d827-7ad3-f7dc-792bc60dd946");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let m = (0, e.i(706442).makeStyles)()((e, t) => {
      ...
      return (
        i
          ? ((d = e.palette.content.muted), (l = e.palette.content.muted))
          : a
            ? ((d = e.palette.content.alert.active), (l = e.palette.content.alert.active))
            : !a &&
              r &&
              ((d = e.palette.content.alert.important), (l = e.palette.content.alert.important)),
        {
          labelColor: { color: d, backgroundColor: n, lineHeight: "140%" },
          icon: { stroke: l },
          ...
          let {
            ...
            C = (0, a.useMemo)(() => {
              let e = Math.abs(p) > 10,
                t = e ? 10 : p,
                a = e ? (t > 0 ? ">" : "<") : "",
                s = +(null == b || !b.inRoundedComparisonChipContext),
                i = (null == b ? void 0 : b.inRoundedComparisonChipContext) ? 0 : v;
            ...
            }, [I, v, null == b ? void 0 : b.inRoundedComparisonChipContext, p, T]),
            R = (0, a.useMemo)(
              () =>
                (0, t.jsx)(d.Label, {
                  labelText: C,
  ...
  (e) => {
    ...
    (e.s(["default", 0, l, "isValidInsight", 0, d], 184757),
  ...
  (e) => {
    ...
    e.s(
      [
        ...
        0,
        (e, t) =>
          t === d.default.QualifiedPTRAndImpressionComparison
        ...
        (e, t, a) => {
          ...
          switch (s) {
            case "INSIGHT_TYPE_PERCENT_CHANGE": {
              ...
              return e(c.INSIGHT_TYPE_PERCENT_CHANGE.caption, {
            ...
            case "INSIGHT_TYPE_LOW_END_ANDROID_CRASH_RATE": {
              ...
              return e(c.INSIGHT_TYPE_LOW_END_ANDROID_CRASH_RATE.caption, {
  ...
  (e) => {
    ...
    let ec = {
      ...
      experiences: { light: el.default, dark: ed.default },
      ...
      noUsers: { light: b.default, dark: _.default },
      ...
      apiKeys: { light: d.default, dark: n.default },
    ...
    let eu = (0, s.makeStyles)()(() => ({
      ...
      ep = (e) => {
        let { children: s, title: r, description: n, size: d = "large", illustration: l } = e,
          {
            classes: { smallContainer: o, largeContainer: c, smallText: m, largeText: g },
            cx: u
          } = eu();
        return (0, t.jsxs)(i.default, {
          classes: { root: u({ [o]: "small" === d, [c]: "large" === d }) },
          flexDirection: "column",
          alignItems: "center",
          children: [
            (0, t.jsx)(eh, { illustration: l, size: d }),
            (0, t.jsxs)(i.default, {
              classes: { root: u({ [m]: "small" === d, [g]: "large" === d }) },
              flexDirection: "column",
              alignItems: "center",
              children: [
  ...
  (e) => {
    ...
    let _ = (0, h.createClientConfiguration)("universe-analytics-insights", "bedev2"),
      b = new c.UniverseAnalyticsInsightsAPIApi(_),
      v = (e, t, a, s) =>
        b.v2UniversesUniverseIdInsightsSnoozePost({
          universeId: e,
          insightType: t,
          snoozeKey: a,
          snoozeDuration: s
    ...
    let T = async (e, t) => {
      try {
        let a = await b.v2UniversesUniverseIdInsightsMetricsSummaryPost({
          universeId: e,
  ...
  (e) => {
    ...
    let n = { Small: "XSmall", Medium: "Small", Large: "Medium" },
      ...
      _ = (e) => {
        ...
        return null != t
          ? r.default.createElement(s.Icon, { name: t, size: n[d] })
          : null != a
      ...
      b = (0, r.forwardRef)((e, s) => {
        let {
          ...
          A = r.default.createElement(
            ...
            r.default.createElement(_, { iconName: x, node: I, size: f }),
            r.default.createElement(
              "span",
              {
                className: (0, i.default)(
            ...
            r.default.createElement(_, { iconName: T, node: E, size: f })
          ),
        ...
        let R = (0, s.default)(
          ...
          A = i.default.createElement(
            ...
            i.default.createElement("span", {
              className: (0, s.default)("icon", b, d[I], f ? u[E][T] : g[E][T])
            })
          );
        if (k) {
          let { as: e, ...t } = C,
    ...
    var _ = (0, s.default)({ name: "AlertTitle" })(function (e) {
      ...
      b = (0, a.forwardRef)(function (e, s) {
        var r = e.classes,
          ...
          l = _(void 0, { props: { classes: (0, i.default)(r, n) } });
        return a.default.createElement(p, (0, t._)({}, d, { classes: l.classes, ref: s }));
      });
...
//# debugId=c461ffea-d827-7ad3-f7dc-792bc60dd946
//# sourceMappingURL=0-l61d6_v7fl9.js.map
