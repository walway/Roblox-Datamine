          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "2bcec23e-dc8e-af70-59e1-b9ee82fba24e");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
            ...
            async (e) => {
              ...
              try {
                (await g.default.confirmShortenedExperienceName(m, t),
                  b(i("Message.SENCreationSuccess"), !0),
                  u());
              } catch (r) {
                let t = (0, E.getResponseFromError)(r);
                if ((null == t ? void 0 : t.status) === 500)
                  return void b(i("Error.UnknownSubscriptionError"), !1);
                let c = await (null == t ? void 0 : t.json());
                switch (c.failureReason) {
                  case s.FailureReason.ShortenedNameModerated:
                    var a;
                    (R("name", null != (a = c.hint) ? a : e.name),
                      R("confirmedName", ""),
                  ...
                  case s.FailureReason.ShortenedNameTaken:
                    ...
                    break;
                  default:
                    b(i("Error.UnknownSubscriptionError"), !1);
                }
              }
            },
            [u, U, R, b, i, m]
                ...
                (0, t.jsxs)(k.DialogContentText, {
                  children: [
                    (0, t.jsx)(l.Typography, {
                      children: d("Description.SENContext", [
                        {
                          opening: "LinkStart",
                          closing: "LinkEnd",
                          content: (e) =>
                    ...
                    (0, t.jsx)("br", {}),
                    (0, t.jsx)("br", {}),
                    (0, t.jsx)(l.Typography, { children: i("Description.SENActivationWarning") })
                  ]
                }),
                (0, t.jsxs)(y.Grid, {
                  container: !0,
                      ...
                      children: (0, t.jsx)(p.Controller, {
                        ...
                        render: (e) => {
                          ...
                          return (0, t.jsx)(q.TextField, {
                            ...
                            helperText: (0, t.jsx)(l.Typography, {
                              variant: "subtitle2",
                              children:
        ...
        function (e) {
          let { creation: h, handleClose: p, updateItem: f } = e,
            ...
            L = (0, a.useCallback)(
              (e, a) => {
                x({
                  ...
                  autoHideDuration: b.toastDurationTime,
                  autoHide: !0,
                  onClose: v
                });
              },
            ...
            D = (0, a.useMemo)(() => {
              ...
              return w
                ...
                : (0, t.jsx)(d.DialogTemplate, {
                    onConfirm: N,
                    onCancel: S,
                    title: _("Heading.ActivateSubscription"),
                    content: (0, t.jsxs)(l.Typography, {
                      color: "primary",
                      children: [
          ...
          h.productStatus !== s.ProductStatusType.Inactive &&
            ...
            : (0, t.jsx)(
                ...
                {
                  onClick: P,
                  children: (0, t.jsx)(l.Typography, { children: _("Action.Activate") })
                },
                "Action.Activate"
              );
        },
    ...
    let P = (0, i.withTranslation)(
      function (e) {
        let { creation: c, handleClose: o, updateItem: h } = e,
          { enqueue: p, close: f } = (0, m.useSnackbar)(),
          ...
          C = (0, a.useCallback)(async () => {
            var e, t;
            S(!0);
            let a = (null == (e = c.subscriptionProductId) ? void 0 : e.startsWith("EXP-"))
            ...
            try {
              ...
              e
                ? (h({ ...c, productStatus: 1 }), y(x("Message.DeactivateSubscriptionSuccess"), e))
          ...
          T = (0, a.useMemo)(() => {
            var e;
            return (0, t.jsx)(d.DialogTemplate, {
              onConfirm: C,
              onCancel: _,
              title: x("Heading.DeactivateSubscription"),
              content: (0, t.jsx)(l.Typography, {
                color: "primary",
        ...
        c.productStatus !== s.ProductStatusType.OffSale)
          ...
          : (0, t.jsx)(
              ...
              {
                onClick: q,
                children: (0, t.jsx)(l.Typography, { children: x("Action.DeactivateOffSale") })
              },
              "Action.Deactivate"
            );
      },
    ...
    let O = (0, i.withTranslation)(
      function (e) {
        let { creation: s, removeItem: c } = e,
          { enqueue: d, close: o } = (0, m.useSnackbar)(),
          ...
          O = (0, a.useCallback)(async () => {
            try {
              ...
              let a = (null == (t = s.subscriptionProductId) ? void 0 : t.startsWith("EXP-"))
                ...
                { success: i } = await g.default.deleteExperienceSubscription(
                  null != (e = s.universeId) ? e : 0,
                  null != a ? a : ""
                );
              i
                ? (c(), P(h("Message.SubscriptionDeleted"), i))
            ...
            k();
          }, [s.universeId, s.subscriptionProductId, k, c, P, h]),
          R = (0, a.useMemo)(() => {
            var e, a;
            return (0, t.jsxs)(t.Fragment, {
              children: [
        ...
        return (
          ...
          (0, t.jsx)(
            ...
            {
              onClick: U,
              children: (0, t.jsx)(l.Typography, { color: "error", children: h("Action.Delete") })
            },
            "Action.Delete"
          )
        );
      ...
      function (e) {
        let { creation: c, handleClose: o, updateItem: h } = e,
          ...
          E = (0, a.useCallback)(
            async (e) => {
              var t, a;
              S(!0);
              let i = (null == (t = c.subscriptionProductId) ? void 0 : t.startsWith("EXP-"))
                ? c.subscriptionProductId.slice(4)
                : c.subscriptionProductId;
              try {
                ...
                if (t) {
                  ...
                  (h({ ...c, productStatus: a }), T(x("Message.DeactivateSubscriptionSuccess"), t));
        ...
        c.productStatus !== s.ProductStatusType.Active)
          ...
          : (0, t.jsx)(
              ...
              {
                onClick: A,
                children: (0, t.jsx)(l.Typography, { children: x("Action.TakeOffSale") })
              },
              "Action.TakeOffSale"
            );
      },
  ...
  (e) => {
    ...
    let el = {
      ...
      avatarItem: { light: u.default, dark: l.default },
      ...
      barGraph: { light: h.default, dark: b.default },
    ...
    let eg = (0, s.makeStyles)()(() => ({
      ...
      eb = (e) => {
        let { illustration: a, size: s = "large" } = e,
          c = a && el[a];
        if (c) return (0, t.jsx)(i.default, { lightSrc: c.light, darkSrc: c.dark, alt: a });
        let r = a ? em[s][a] : null;
        return (
          r &&
          (0, t.jsx)("img", {
      ...
      eh = (e) => {
        let { children: s, title: i, description: r, size: d = "large", illustration: o } = e,
          {
            classes: { smallContainer: n, largeContainer: l, smallText: u, largeText: m },
            cx: g
          } = eg();
        return (0, t.jsxs)(c.default, {
          classes: { root: g({ [n]: "small" === d, [l]: "large" === d }) },
          flexDirection: "column",
          alignItems: "center",
          children: [
            (0, t.jsx)(eb, { illustration: o, size: d }),
            (0, t.jsxs)(c.default, {
              classes: { root: g({ [u]: "small" === d, [m]: "large" === d }) },
              flexDirection: "column",
              alignItems: "center",
              children: [
    ...
    ((eh.displayName = "EmptyState"),
      e.s(["EmptyStateIllustration", 0, eb, "default", 0, eh], 493924));
  },
  343885,
  (e) => {
    e.q(
    ...
    var p = (0, s.default)({ name: "AlertTitle" })(function (e) {
      ...
      f = (0, a.forwardRef)(function (e, s) {
        var i = e.classes,
          ...
          o = p(void 0, { props: { classes: (0, c.default)(i, r) } });
        return a.default.createElement(h, (0, t._)({}, d, { classes: o.classes, ref: s }));
      });
        ...
        [
          ...
          function (e) {
            ...
            return a.default.createElement(
              s.M,
              (0, t._)({}, i, { ref: c, viewBox: "0 0 28 28" }),
...
//# debugId=2bcec23e-dc8e-af70-59e1-b9ee82fba24e
//# sourceMappingURL=1obwvuupul-sr.js.map
