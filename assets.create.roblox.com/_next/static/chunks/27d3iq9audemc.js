          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "7774667c-5cf7-cc1e-b97b-eea6e5b9b0d7");
  } catch (e) {}
})();
  ...
  (t) => {
        ...
        if (!ip) {
          ...
          var t = iH(),
            ...
            ee =
              ...
              !Z(Y, O) ||
              !!o(function () {
                var t = Y(new r.AggregateError([1], J, { cause: 3 }));
                return (
        ...
        v =
          (s_ ||
            ...
            f &&
              f.inspect &&
              f.inspect.custom &&
              (sz.exports.prototype[f.inspect.custom] = function () {
    ...
    let lW = null,
      ...
      lK = () => {
        ...
        return r ? (0, v.jsx)(lH, { flags: lF, contexts: a }) : null;
      };
    var lz = t.i(911502);
    let lJ = (t) => {
    ...
    let l6 = (t) => {
          ...
          i.current.setConfig({
            ...
            api: {
              retCodeHandler(t, n, r) {
                let i = !(
                    (r.status === l2.StatusCodes.FORBIDDEN && r.headers.has("x-csrf-token")) ||
                    r.status === l2.StatusCodes.OK ||
                    r.status === l2.StatusCodes.ACCEPTED
                  ),
                  a = "unknown";
                try {
                  let n = JSON.parse(t);
      ...
      return (0, v.jsx)(l3.default.Provider, { value: a, children: n });
    };
    var l8 = t.i(37819),
      l5 = t.i(431346),
      l9 = t.i(881670);
    ...
    let cm = cc.$constructor("ZodMiniType", (t, n) => {
        ...
        (cf.$ZodType.init(t, n),
          (t.def = n),
          (t.type = n.type),
          (t.parse = (n, r) => cv.parse(t, n, r, { callee: t.parse })),
          (t.safeParse = (n, r) => cv.safeParse(t, n, r)),
          (t.parseAsync = async (n, r) => cv.parseAsync(t, n, r, { callee: t.parseAsync })),
          (t.safeParseAsync = async (n, r) => cv.safeParseAsync(t, n, r)),
          (t.check = function () {
    ...
    function cx(t, n) {
      return new cw({ type: "array", element: t, ...ch.normalizeParams(n) });
    }
    let cP = cc.$constructor("ZodMiniObject", (t, n) => {
      (cf.$ZodObject.init(t, n), cm.init(t, n), ch.defineLazy(t, "shape", () => n.shape));
    });
    function cR(t, n) {
      return new cP({ type: "object", shape: null != t ? t : {}, ...ch.normalizeParams(n) });
    }
    ...
    function cA(t) {
      return new ck({ type: "optional", innerType: t });
    }
    (t, n) => {
    ...
    var cj = t.i(694257),
      ...
      c_ = (t) => {
        ...
        return (0, v.jsx)(cD.Provider, { value: n, children: r });
      },
      cM = () => {
      ...
      cU =
        (((i = cU || {}).AccountReactivationPageRendered = "accountReactivationPageRendered"),
    ...
    function cV() {
      let { sendAnalyticsEvent: t, platform: n, readOnly: r } = cM();
    ...
    var cJ = (0, ol.createContext)(void 0),
      ...
      c$ = (t) => {
        let { punishmentData: n, commutationEligibility: r } = t,
          { isFirstPage: i, currentPageConfigs: a, currentPageName: o } = cX(),
          s = a
            .map((t) => {
      ...
      c1 = (t) => {
        ...
        let { punishmentData: r } = t,
          { isFirstPage: i, totalPages: a } = cX(),
          { readOnly: o } = cM(),
          s = cM().translate,
          { punishmentTypeDescription: u, verificationCategory: l } = r,
          c = l
            ? s("Heading.Suspended")
            : s(null != (n = cW[u]) ? n : "") || s("Heading.Suspended");
        return i
          ? (0, v.jsx)("div", {
      ...
      c2 = (t) => {
        let { punishmentData: n, setIsDialogOpen: r } = t,
          { CurrentCtaComponent: i, currentPageName: a } = cX();
        return i
          ? (0, v.jsx)("div", {
        ...
        return (
          ...
          (0, v.jsx)("div", {
            ...
            children: (0, v.jsxs)("div", {
              ...
              children: [
                (0, v.jsx)(cr.Icon, { name: "icon-regular-triangle-exclamation", size: "XLarge" }),
                (0, v.jsx)("span", {
    ...
    var c9 = cR({
      ...
      c7 = new cS({
        ...
        options: [
          cR({
            ...
            text: cA(cg()),
            textKey: cA(cg()),
            textKeyParameters: cA(
              ((s = cg()),
              new cT(
                (u = cg()) && u._zod
                  ? { type: "record", keyType: s, valueType: u, ...ch.normalizeParams(void 0) }
                  : { type: "record", keyType: cg(), valueType: s, ...ch.normalizeParams(u) }
              ))
            )
          }).check(
            cI((t) => void 0 !== t.text || void 0 !== t.textKey, {
          ...
          cR({ type: cq("image"), labelKey: cg(), url: cg(), altLabelKey: cA(cg()) })
        ],
      ...
      dt = cR({ ...c9.shape, elements: cA(cx(c7)) }),
      dn = (t) => {
        let n = t.violation;
        if (!n) return !1;
        let { evidence: r } = n;
      ...
      di = (t) => {
        let { enableIxp: n = !1, children: r } = t,
          i = cM().translate,
          {
            ...
            let { httpGet: t, userModerationApiUrl: n } = cM();
          ...
          { data: d, isLoading: f } = (() => {
            let { httpGet: t, apiGatewayUrl: n } = cM();
            return (0, cn.useQuery)({
          ...
          p = (0, ol.useMemo)(() => {
            let t = new Set(),
              n = new Set();
            if ((null == h ? void 0 : h.violation) && dn(h))
        ...
        return (0, v.jsx)(dr.Provider, { value: y, children: r });
      },
      da = () => {
      ...
      du = (t) => {
        let { children: n } = t,
          { currentPage: r, currentPageName: i, unmappedViolationKeys: a } = cX(),
          o = cV(),
        ...
        return (0, v.jsx)(ds.Provider, { value: h, children: n });
      },
      dl = () => {
      ...
      dg = (t, n) => (r, i, a, o) => {
        var s;
        let [u, l] = t(r, { startLink: dm, endLink: dy, ...a }).split(dm, 2),
          [c, d] = null != (s = null == l ? void 0 : l.split(dy, 2)) ? s : [];
        return (0, v.jsxs)("p", {
    ...
    var dk = (t) => {
      ...
      dC = {
        ...
        renderComponent: (t) => {
          ...
          let { punishmentData: i } = t,
            ...
            d = null != (n = null == c ? void 0 : c.filter((t) => de(t))) ? n : [],
            f = [],
            h = [];
          d.forEach((t) => {
            var n;
            "image" === t.type
              ? f.push((0, v.jsx)(dT, { url: t.url, altLabelKey: t.labelKey }, t.url))
              : h.push(
                  (0, v.jsx)(
                    dk,
                    {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              ...
              (0, v.jsxs)("div", {
                ...
                children: [
                  h,
                  (0, v.jsx)(dk, { fieldLabel: s("Label.ReviewDate"), fieldValue: u(i.beginDate) }),
                  o && (0, v.jsx)(dk, { fieldLabel: s("Label.DecisionMethod"), fieldValue: o }),
                  (0, v.jsx)(dA, {})
                ]
              })
            ]
      ...
      dj = {
        getIsVisible: (t) => {
          var n, r;
          return (
            !dn(t) && (null != (n = null == (r = t.badUtterances) ? void 0 : r.length) ? n : 0) > 0
          );
        },
        renderComponent: (t) => {
          let { punishmentData: n } = t,
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              (0, v.jsx)(dI, { badUtterances: null != a ? a : [] }),
              (0, v.jsx)(cO.Divider, {}),
              (0, v.jsx)(dk, { fieldLabel: r("Label.ReviewDate"), fieldValue: i(n.beginDate) }),
              o && (0, v.jsx)(dk, { fieldLabel: r("Label.DecisionMethod"), fieldValue: o }),
              (0, v.jsx)(dA, {})
            ]
          });
        },
      ...
      dL = {
        ...
        renderComponent: (t) => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              (0, v.jsx)(dk, { fieldLabel: n("Label.ReviewDate"), fieldValue: r(a) }),
              o && (0, v.jsx)(dk, { fieldLabel: n("Label.DecisionMethod"), fieldValue: o }),
              (0, v.jsx)(dA, {})
            ]
          });
        },
      ...
      dF =
        (((l = dF || {})[(l.Reactivate = 0)] = "Reactivate"),
        (l[(l.Paused = 1)] = "Paused"),
      ...
      dX = () => {
        let t = cM().translate,
          { sendPageEvent: n } = dl(),
          { httpPost: r, apiGatewayUrl: i, onAccountReactivated: a } = cM(),
          { handleAppealsClick: o } = dR(),
          [s, u] = (0, ol.useState)(!1),
          l = (0, ci.useMutation)({
            mutationFn: () => dQ(i, r),
            onMutate: () => {
      ...
      dZ = (t) => {
        let { onOpenChange: n, children: r } = t,
          ...
          d = (0, ol.useMemo)(() => (null != c ? c : []).some((t) => t in dv), [c]),
        ...
        return s
          ? r({
              header: (0, v.jsx)(c4, { readOnly: !!i }),
              body: (0, v.jsx)(c3, {}),
              ctas: (0, v.jsx)(c6, {})
            })
          : u || !a
            ? r({ header: (0, v.jsx)(c8, {}), body: (0, v.jsx)(c5, { error: u }) })
            : (0, v.jsx)(cQ, {
                pages: f,
                ...
                children: (0, v.jsx)(du, {
                  children: r({
                    header: (0, v.jsx)(c1, { punishmentData: a }),
                    body: (0, v.jsx)(c$, { punishmentData: a, commutationEligibility: l }),
                    ctas: (0, v.jsx)(c2, { punishmentData: a, setIsDialogOpen: n })
                  })
                })
              });
      },
      dY = (t) => {
        let { impressionEvent: n } = t,
          { translate: r, websiteUrl: i, onLogout: a } = cM(),
          o = cV(),
          s = dg(r, o),
          [u, l] = (0, ol.useState)(!1);
        (0, ol.useEffect)(() => {
        ...
        return (0, v.jsx)(ct.Dialog, {
          ...
          children: (0, v.jsxs)(ct.DialogContent, {
            ...
            children: [
              (0, v.jsxs)(ct.DialogBody, {
                className: "gap-large flex flex-col",
                children: [
                  (0, v.jsx)(ct.DialogTitle, {
      ...
      d0 = (t) => {
        ...
        let { open: r, onClose: i } = t,
          ...
          p = cV(),
          { punishmentData: m, isLoading: y, error: g, ixpData: b } = da(),
        ...
        if (x && (null == (n = m.context) ? void 0 : n.SelfServiceDeactivated))
          return c
            ...
            : (0, v.jsx)(dY, { impressionEvent: "accountReactivationRedirectRendered" });
        let R = x && (null == d ? void 0 : d(m));
        return R
          ? (0, v.jsx)(dY, { impressionEvent: R })
          : (0, v.jsx)(ct.Dialog, {
              open: null != r ? r : a,
              size: "Large",
                  ...
                  children: (0, v.jsx)(dZ, {
                    ...
                    children: (t) => {
                      ...
                      return (0, v.jsxs)("div", {
                        ...
                        children: [
                          (0, v.jsx)(ct.DialogTitle, { className: "padding-none", children: n }),
                          (0, v.jsxs)("div", {
      ...
      d2 = function (t) {
        ...
        return (0, v.jsx)(op.QueryClientProvider, {
          ...
          children: (0, v.jsx)(di, {
            enableIxp: !0,
            children: (0, v.jsx)(d0, { open: n, onClose: r })
          })
        });
      },
      d4 = t.i(894244),
    ...
    let d6 = function () {
        let { translate: t } = (0, ob.useTranslation)(),
          ...
          l = (0, ol.useCallback)(
            (t) => !!t.verificationCategory && cU.VerificationRedirectRendered,
            []
          ),
      ...
      d8 = () => {
        let t = d6();
        return (0, v.jsx)(c_, { config: t, children: (0, v.jsx)(d2, {}) });
      },
      d5 = (0, ob.withTranslation)(() => {
        let { themeMode: t } = (0, lr.useThemeMode)();
        return (0, v.jsx)(ls.UIThemeProvider, { theme: t, children: (0, v.jsx)(d8, {}) });
      }, [
        l9.TranslationNamespace.NotApproved,
        l9.TranslationNamespace.Moderation,
        l9.TranslationNamespace.AppealsPortal,
        l9.TranslationNamespace.CommonUIControls,
        l9.TranslationNamespace.Error,
        l9.TranslationNamespace.DashboardModeration
      ]),
      d9 = () => {
    ...
    let fe = (0, ly.default)(() => t.A(14667), {
      ...
      ft = (t) => {
        let { children: n } = t;
        return (0, v.jsx)(d7.UniversalFeatureRestrictionsProvider, { Surface: fe, children: n });
      };
    var fn = t.i(336964);
    function fr(t) {
    ...
    function fi(t) {
      ...
      if (
        ...
        return null;
      if ((null == o ? void 0 : o.mode) === "standalone" && fr(a))
    ...
    function fs() {
      let { current: t } = (0, ol.useSyncExternalStore)(
        fo.snackbarStore.subscribe,
        fo.snackbarStore.getSnapshot,
        fo.snackbarStore.getSnapshot
      );
      return null === t
        ? null
        : (0, v.jsx)(fa.Snackbar, { ...t.props, onClose: () => fo.snackbarStore.dismiss() }, t.id);
    }
    var fu = t.i(943758);
    ...
    let fc = (t) => {
      ...
      return (0, v.jsx)(fl.Provider, { value: a, children: n });
    };
    var fd = t.i(729904),
      ff = t.i(486736),
      fh = t.i(47033),
    ...
    let fx = {
      ...
      fR = (0, ob.withTranslation)(() => {
        let t = (0, oc.useRouter)(),
          ...
          a = (0, ol.useRef)(!1),
          { captureError: o, error: s, info: u } = (0, fw.useMetricsMonitoring)(),
          [l, c] = (0, ol.useState)(!1),
          [d, f] = (0, ol.useState)(!1),
          [h, p] = (0, ol.useState)([]),
          m = (0, ol.useCallback)(
            async (t) => {
              async function n(t, r) {
                ...
                try {
                  var i;
                  let a =
                    null == (i = (await fg.userAgreementsClient.acceptUserAgreements(t)).results)
                      ? void 0
                      : i.reduce((t, n) => (0 !== n.errorCode ? [...t, n.agreementId] : t), []);
                  a && a.length > 0 && (await n(a, r - 1));
                } catch (a) {
                  let i = (0, fb.getResponseFromError)(a);
                  (null == i ? void 0 : i.status) === l2.StatusCodes.UNAUTHORIZED
        ...
        return (
          (0, ol.useEffect)(() => {
            (null == r ? void 0 : r.id) === void 0 ||
              a.current ||
              !t.isReady ||
              fP.some((n) => t.pathname.startsWith(n)) ||
              (b(), (a.current = !0));
      ...
      { authenticationApi: fS } = { authenticationApi: u5 },
      { discoveryApi: fT } = uT.ApplicationAuthorizationsClient,
      { usersApi: fE } = u9.UsersClient,
      fq =
        ((r = ld.default),
        (t) => {
    ...
    let fA = { locale: l1.defaultLocale, nativeName: l1.defaultNativeName },
      ...
      fO = () => (
        (() => {
          ...
          ((0, l$.default)(void 0, n),
            (0, ol.useEffect)(() => n(), [n]),
            (0, ol.useEffect)(() => {
              ld.default.trackPageLoad();
            }, []));
        })(),
        (0, od.useReportWebVitals)(fq),
        null
      ),
      fN = (t) => {
        let { children: n } = t,
          { settings: r, isFetched: i } = (0, ff.useSettings)();
      ...
      fM = (t) => {
        ...
        let { Component: r, pageProps: i, cache: a } = t,
          ...
          l = null != (n = r.getPageLayout) ? n : fL,
          c = (0, ol.useMemo)(() => ({ ...fj, ...r.pageMetadata }), [r.pageMetadata]);
        return (
          ...
          (0, v.jsx)(of.ErrorBoundary, {
            children: (0, v.jsx)(ud, {
              ...
              children: (0, v.jsxs)(lJ, {
                providers: [
                  (0, v.jsx)(fu.BreadcrumbItemNameProvider, {}),
                  (0, v.jsx)(op.QueryClientProvider, { client: fD }),
                  (0, v.jsx)(lp.CustomDashboardServiceProvider, {}),
                  (0, v.jsx)(lp.UniverseFlaggedCustomDashboardProvider, {}),
                  (0, v.jsx)(fI, { universeId: u }),
                  (0, v.jsx)(lY, { pageLoggerConfig: r.loggerConfig }),
                ...
                children: [
                  (0, v.jsx)(fO, {}),
                  (0, v.jsx)(ln, { provider: fC }),
                  (0, v.jsx)(fs, {}),
                  (0, v.jsx)(fi, {}),
                  (0, v.jsx)(d9, {}),
                  (0, v.jsx)(fR, {}),
                  (0, v.jsx)(lK, {}),
                  (0, v.jsx)(ce, { openGraphMetadata: c }),
...
//# debugId=7774667c-5cf7-cc1e-b97b-eea6e5b9b0d7
//# sourceMappingURL=2qw52m_a9ipni.js.map
