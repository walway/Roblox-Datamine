    ...
    let l = { Large: "size-1200", Medium: "size-1000", Small: "size-800", XSmall: "size-600" },
      ...
      p = (0, r.forwardRef)((e, p) => {
        ...
        if (O) {
          ...
          return r.default.createElement(
            i.Slot,
            { ref: p, ...t, className: N, "aria-label": y, "aria-disabled": b || void 0 },
        ...
        return r.default.createElement(
          "button",
          { ref: p, type: "button", ...L, "aria-label": y, disabled: b, className: N },
          R
        );
      });
    e.s(["IconButton", 0, p]);
            ...
            M &&
              (y
                ? l.default.createElement(
                    ...
                    M,
                    l.default.createElement(n.LabelTooltip, y)
                  )
                : M),
            l.default.createElement(
              s.Root,
      ...
      [
        ...
        (e) => {
          ...
          return "dropdown" === x
            ...
            : l.default.createElement(y.Item, { asChild: !0, focusable: !0, tabStopId: n }, a);
        },
        "MenuLabel",
        0,
        (e) => {
      ...
      return i.default.createElement(
        "div",
        {
          ...
          className: (0, r.default)(
            ...
            "exit" === y ? "ease-standard-in" : "ease-standard-out",
            v
          ),
          style: {
            ...k,
  ...
  (e) => {
    ...
    e.s([
      ...
      function (e) {
        ...
        var x = (0, a.useMemo)(
          function () {
            return { ref: c, enqueue: y, close: b };
          },
          [b, y]
        );
        return a.default.createElement(
