...
((globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  {
    otherChunks: [
      "static/chunks/337_wsggbsb4g.js",
  ...
  (() => {
    ...
    u.a = function (t, e) {
      let n = this.m,
        ...
        s = new Set(),
        { resolve: o, reject: c, promise: u } = x(),
        i = Object.assign(u, {
          [v]: n.exports,
          [O]: (t) => {
        ...
        t(
          function (t) {
            let e = t.map((t) => {
              ...
              { promise: o, resolve: c } = x(),
              u = Object.assign(() => c(n), { queueCount: 0 });
            function i(t) {
              t !== r &&
                !s.has(t) &&
            ...
            !(function (t, e) {
              ...
              for (; n < t.length;) {
                ...
                for (let r = n; r < s; r++) {
                  ...
                  e.has(n) ||
                    (u ||
                      (c === o && Object.defineProperty(o, "name", { value: "module evaluation" }),
                      (u = !0)),
                    e.set(n, c));
                }
                n = s + 1;
