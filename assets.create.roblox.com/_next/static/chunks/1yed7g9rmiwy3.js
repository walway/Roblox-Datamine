          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "1b1073c4-0824-33c6-7865-35c834102862");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let ed = {
      ...
      badge: { light: b.default, dark: g.default },
    ...
    let eb = (0, r.makeStyles)()(() => ({
      ...
      ef = (e) => {
        let { children: r, title: o, description: n, size: i = "large", illustration: l } = e,
          {
            classes: { smallContainer: c, largeContainer: d, smallText: u, largeText: g },
            cx: b
          } = eb();
        return (0, a.jsxs)(s.default, {
          classes: { root: b({ [c]: "small" === i, [d]: "large" === i }) },
          flexDirection: "column",
          alignItems: "center",
          children: [
            (0, a.jsx)(em, { illustration: l, size: i }),
            (0, a.jsxs)(s.default, {
              classes: { root: b({ [u]: "small" === i, [g]: "large" === i }) },
              flexDirection: "column",
              alignItems: "center",
              children: [
    ...
    e.s(
      [
        ...
        (e) => {
          ...
          }, [null == i ? void 0 : i.groups, x, l, b, null == n ? void 0 : n.id]);
          let k = (0, t.useMemo)(
            () => ({
              groups: x,
              currentGroup: _,
  ...
  (e) => {
    e.q(
      "https://assets.create.roblox.com/0404a87af731d10c499a9aa5379b6f9d59b9ac79/_next/static/media/alert_dark.1spa8ixzmujxs.svg"
    );
  },
  858517,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/0404a87af731d10c499a9aa5379b6f9d59b9ac79/_next/static/media/alert_light.3o6_fob3g_8zu.svg"
    );
  },
  343885,
  (e) => {
    ...
    e.s([
      ...
      (e) => {
        ...
        let { children: i, unifiedLogger: l, pageLoggerConfig: c, path: d } = e,
          ...
          g = null == c ? void 0 : c.rosId,
          b = (0, a.useMemo)(() => ({ tags: u, rosId: g, path: d }), [u, g, d]),
          m = (0, a.useRef)(b),
          f = (0, a.useRef)(b);
        ((0, a.useLayoutEffect)(() => {
          ((f.current = b),
            void 0 === m.current.path &&
              void 0 !== b.path &&
              (m.current = { ...m.current, path: b.path }));
        }, [b]),
          (0, a.useLayoutEffect)(() => {
            let e = (e) => {
              var a;
        ...
        let p = (0, a.useMemo)(() => ({ unifiedLogger: l, pageContext: b }), [l, b]);
...
//# debugId=1b1073c4-0824-33c6-7865-35c834102862
//# sourceMappingURL=28nx_f3bglr_n.js.map
