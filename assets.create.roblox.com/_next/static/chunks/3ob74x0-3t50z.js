          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "05dd02e0-1bd8-e512-0510-bdb7d1ebe455");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
      ...
      [
        ...
        (e) => {
          let {
            ...
            {
              classes: { icon: M, labelColor: x, tooltipWrapper: w }
            } = c({
              isGood: p,
              hasBackground: S,
              dimmedLabel: b,
            ...
            }, [C, h, null == v ? void 0 : v.inRoundedComparisonChipContext, f, A]),
            N = (0, a.useMemo)(
              () =>
                (0, t.jsx)(o.Label, {
                  labelText: k,
                  ...
                  icon: g
                    ? (0, t.jsx)(n.ArrowUpwardIcon, { className: M })
                    : (0, t.jsx)(l.ArrowDownwardIcon, { className: M }),
                  classes: { root: x }
                }),
              [k, S, M, g, x]
            );
          return y
            ? (0, t.jsx)(i.Tooltip, {
                ...
                placement: "right",
                arrow: !0,
                children: (0, t.jsx)("div", { className: w, children: N })
              })
            : N;
        }
      ],
    ...
    let y = (e, t) => {
      ...
      v = (e, t, a, o, s, d) => {
        let { translate: c } = o,
          ...
          b = (0, f.getIsPositiveGoodFromMetricLike)(a.metric),
          S = y(e, t),
    ...
    e.s([
      ...
      (e, n, i, u, c, p) => {
        ...
        if (f) {
          ...
          t &&
            f.filter(m.isRAQIV2SingleMetricSummaryType).forEach((e, a) => {
              let r = null;
              c && 0 === a && (r = h(c, null));
              let l = v(t, e, n, u, r, p);
              g.push(l);
              ...
              let c = ((e, n, i, u, c) => {
                ...
                if (g === l.default.TopBreakdown) {
                  ...
                  let b =
                    null !=
                    (f =
                      null != (y = null == n ? void 0 : n.specificLabel)
                        ? y
    ...
    e.s([
      ...
      (e) => {
        let {
          ...
          { series: f } = (0, n.ingestAllRaqiV2Series)({
            response: c,
            translationDependencies: u,
            granularity: p,
            spec: o
        ...
        return (0, l.summarizeSeriesInfo)(
          ...
          u,
          y
            ? { series: y.series, startTime: g.comparisonStartDate, endTime: g.comparisonEndDate }
            : null,
          d
        );
      }
  ...
  (e) => {
    ...
    var t,
      ...
      d = e.i(772147),
      c =
        (((t = c || {}).NewRequestMade = "NewRequestMade"),
    ...
    e.s([
      ...
      0,
      (e, t) => {
        let [o, c] = (0, a.useState)(!0),
          [p, g] = (0, a.useState)(!1),
          [f, y] = (0, a.useState)(!1),
          [v, h] = (0, a.useState)(null),
          [b, S] = (0, a.useState)(null),
          [T, C] = (0, a.useState)(() => e),
          A = (0, a.useRef)(new AbortController()),
          M = (0, a.useRef)(!1),
          x = (0, a.useRef)(0),
          {
            enabled: w = !0,
            refetchShouldSetLoading: k = !1,
            invalidateCache: N,
            trackRequestVersion: L = !1
          } = null != t ? t : {},
          E = (0, a.useCallback)(() => {
            (L && M.current ? (x.current += 1) : (M.current = !0),
              A.current.abort("NewRequestMade"));
            ...
            (async () => {
              try {
                ...
                (h(r), g(!1), y(!1), c(!1), S(null), k && C(() => e));
              } catch (h) {
                var o, p, f, v, b, T, A;
                if (t.signal.aborted || (0, u.isRAQIV2LoadingException)(h)) return;
                (g(!0), c(!1), k && C(() => e), h instanceof Error && S(h));
                let a = (0, i.getResponseFromError)(h);
                if (a) y((null != (o = null == a ? void 0 : a.status) ? o : 500) === m);
                else if (h instanceof d.RAQIV2ValidationError);
                else if ((0, l.isRAQIQueryError)(h))
                  (0, r.captureException)(h, {
                    tags: {
                      ...
                      raqiValidationField:
                        null != (p = null == (f = h.validationDetails) ? void 0 : f.field)
                          ? p
                          : "none"
                    },
                    extra: {
                  ...
                  let e = null == (A = h.context) || null == (T = A.complexity) ? void 0 : T.kind;
                  (0, r.captureException)(h, {
                    tags: {
                      module: "analytics",
                      errorType: h.name,
                      aceErrorCode: null != (v = h.code) ? v : "none",
                      aceErrorSeverity: null != (b = h.severity) ? b : "none",
      ...
      [
        ...
        function (e, p, g) {
          let f = !(arguments.length > 3) || void 0 === arguments[3] || arguments[3],
            { clearCache: y, createClientCacheTracking: v } = (0, a.useRAQIV2Client)(
              null != g && g
            ),
            h = (0, t.useRef)(void 0),
            b = (0, t.useMemo)(() => {
              ...
              return !s.fetchComparison ||
                ((e, t, a) => {
                  let s = (0, l.getAtomicMetricsFromMetricLike)(e).filter(r.isNumericUIMetric),
                    u = (0, o.default)(s);
                  if (void 0 === u) return !0;
                  let { comparisonStartDate: d } = (0, i.default)(
                    t,
                    a.granularity,
                    a.relativeOffset,
                    a.customStartDate
                  );
                  return d >= new Date(Date.now() - u * n.DAY_MS);
  ...
  (e) => {
      ...
      [
        ...
        (e) => {
          ...
          let { children: r } = e,
            ...
            [g, f] = (0, t.useState)(i);
          g !== i && (f(i), c(new Set()));
          let y = (0, t.useCallback)(async (e) => (null == i ? new Map() : p(i, e)), [i]),
            v = (0, u.default)({
              ids: s,
              batchSize: 50,
              fetchBatch: y,
    ...
    let g = new Map(),
      f = (0, t.createContext)({ avatarItemNamesMap: g, setAvatarItemNamesMap: () => {} }),
      y = () => (0, t.useContext)(f);
    e.s(
      [
        ...
        (e) => {
          ...
          return (0, l.jsx)(f.Provider, { value: d, children: a });
        },
      ...
      [
        ...
        () => {
          let {
            ...
            { avatarItemNamesMap: g } = y(),
            { announcementNamesMap: f } = c(),
            T = (0, n.default)();
          return (0, t.useMemo)(
            () => ({
              translate: l,
              ...
              announcementNamesMap: f,
              ready: e,
              locale: T
            }),
            [e, l, i, o, s, u, d, m, p, g, f, T]
          );
        }
      ],
      589843
  ...
  (e) => {
    ...
    e.s([
      ...
      (e) => {
        ...
        if (a)
          return r.reduce(
            (e, a) => Math.min(e, t.RAQIV2MetricDisplayConfig[a].retentionDurationDays),
            t.RAQIV2MetricDisplayConfig[a].retentionDurationDays
          );
      }
    ]);
  },
      ...
      v = (0, l.forwardRef)((e, r) => {
        let {
          ...
          L = l.default.createElement(
            ...
            l.default.createElement(y, { iconName: T, node: C, size: b }),
            l.default.createElement(
              "span",
              {
                className: (0, n.default)(
            ...
            l.default.createElement(y, { iconName: A, node: M, size: b })
          ),
          E = { textDecoration: "none", ...f };
        if ("a" === x.as) {
          let { as: e, href: t, ...a } = x;
        ...
        let { as: V, isChecked: R, onCheckedChange: I, ...D } = x;
        return l.default.createElement(
          "button",
          {
            ref: r,
  ...
  (e) => {
    ...
    let i = { Large: "size-1200", Medium: "size-1000", Small: "size-800", XSmall: "size-600" },
      ...
      g = (0, n.forwardRef)((e, g) => {
        ...
        let N = (0, r.default)(
          ...
          L = n.default.createElement(
            ...
            n.default.createElement("span", {
              className: (0, r.default)("icon", v, o[C], b ? p[M][A] : m[M][A])
            })
          );
        if (x) {
          let { as: e, ...t } = k,
            a = n.default.Children.only(w);
          return n.default.createElement(
            l.Slot,
            { ref: g, ...t, className: N, "aria-label": h, "aria-disabled": b || void 0 },
            n.default.cloneElement(a, {}, L)
          );
        }
        if ("a" === k.as) {
          let { as: e, href: t, ...a } = k;
        ...
        return n.default.createElement(
          "button",
          { ref: g, type: "button", ...V, "aria-label": h, disabled: b, className: N },
          L
        );
      });
    e.s(["IconButton", 0, g]);
...
//# debugId=05dd02e0-1bd8-e512-0510-bdb7d1ebe455
//# sourceMappingURL=30kfld74poq7p.js.map
