          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "5d5382ea-a215-cfe7-da55-df962b4299e5");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    e.q(
      "https://assets.create.roblox.com/d8e6c06c1319c7591734659af0220232f4dd0c32/_next/static/media/devex-cashout-payout-info-icon.410ygaikesj45.svg"
    );
  },
  996829,
  (e) => {
  ...
  (e) => {
    ...
    let g = new x((0, e.i(272593).createClientConfiguration)("creator-tax", "bedev2")),
      b = (e) => g.getTaxDevexStatus(e);
    function y(e) {
    ...
    let T = async (e) => {
      if (!(await g.startTaxOnboarding({ body: {} }, e)).accepted)
        throw Error("Tax onboarding start response was not accepted");
      let t = Date.now();
      for (; Date.now() - t < 12e4;) {
        var n, a;
        let t = await g.getTaxOnboardingResult(e);
        if (
    ...
    (e.s(
      [
        ...
        0,
        (e) => g.getTaxOnboardingStatus(e),
        "getWithholdingRate",
        0,
        (e, t) => g.getWithholdingRate({ paymentType: e }, t)
      ],
      558726
    ),
      ...
      [
        ...
        () => {
          ...
          return (0, t.jsxs)(t.Fragment, {
            children: [
              (0, t.jsx)(S.default, { activeKey: g, header: c("Heading.Finances"), items: b }),
              (0, t.jsx)(o.Divider, { sx: { margin: "12px 0px" } }),
              (0, t.jsx)(S.default, { activeKey: g, items: y })
            ]
          });
        }
      ],
  ...
  (e) => {
    ...
    let em = (e) => {
      ...
      eh = (e) => {
        ...
        let { cashoutInfo: x, submitRequest: g, onCancelCashout: b } = e,
          {
            register: y,
            watch: T,
            handleSubmit: R,
          ...
          { locale: en } = (0, a.useLocalization)(),
          {
            classes: {
              ...
              helperText: ef,
              expandIcon: ex,
              expandIconExpanded: eg
            }
          } = ep(),
          eb = "".concat(ef, " text-body-small"),
            ...
            children: [
              ...
              (0, t.jsx)(L.Grid, {
                ...
                children: (0, t.jsx)(q.TextField, {
                  ...
                  FormHelperTextProps: { className: eb },
                                  ...
                                  children: [
                                    ...
                                    (0, t.jsx)("button", {
                                      ...
                                      children: (0, t.jsx)(X.ExpandMoreIcon, {
                                        className: "".concat(ex, " ").concat(j ? eg : "")
                                      })
                                    })
                                  ]
                                })
    ...
    let eq = (0, ei.makeStyles)()((e) => ({
      ...
      eH = (e) => {
        ...
        let { userRobux: s, cashoutInfo: l, onCashoutClick: u } = e,
          ...
          { translate: g, translateHTML: b } = (0, a.useTranslation)(),
                    ...
                    (0, t.jsx)(O.Typography, {
                      ...
                      children:
                        !0 === l.isDevExSuspended
                          ? g("Message.DevExSuspendedStatus")
                          : l.canProceedToCashout && (void 0 === j || 100 === j)
                            ? g("Message.CashOutEligible")
                            : "Completed" === l.lastImbursementStatus
                              ? g("Message.CashOutRecentRequestV2")
                              : l.emailIsVerified
                                ? g(
                                    l.isImbursementBlacklistUser
                            ...
                            ? (0, t.jsxs)(t.Fragment, {
                                children: [
                                  (0, t.jsx)(O.Typography, {
                                    ...
                                    color: "primary",
                                    className: h,
                                    children: b("Label.RobuxEligible", [
                                      {
                                        opening: "robuxStart",
                                        closing: "robuxEnd",
                                        content: () => {
    ...
    let e2 = (0, ei.makeStyles)()((e) => ({
      ...
      e8 = (e) => {
        ...
        let { cashoutInfo: s, userRobux: l, onCashoutClick: u } = e,
          ...
          { isFetched: g, params: b } = (0, ey.useIXPParameters)(eb.IXPLayers.CreatorDashboard),
          ...
          children: [
            ...
            (0, t.jsxs)(L.Grid, {
              ...
              children: [
                ...
                g &&
                  (null == b ? void 0 : b.enableDevexEarnedRobux) &&
                  (0, t.jsx)(O.Typography, {
                    color: "secondary",
                    component: "p",
                    variant: "caption",
            ...
            (0, t.jsx)(L.Grid, {
              ...
              children: (0, t.jsx)(O.Typography, {
                ...
                variant: "body1",
                children: f(
                  g && (null == b ? void 0 : b.enableDevexEarnedRobux)
                  ...
                  (0, t.jsxs)(ef.ListItem, {
                    ...
                    children: [
                      (0, t.jsx)(ex.ListItemIcon, {
                        className: p,
                        children: (0, t.jsx)(eg.CheckIcon, { fontSize: "small" })
                      }),
                      (0, t.jsx)(O.Typography, {
                        color: "secondary",
                        variant: "body1",
    ...
    let to = (e) => {
      ...
      ts = (e) => {
        let {
          ...
          g = "string" == typeof c && c.trim().length > 0 ? c : x,
          b = (0, n.useCallback)(() => {
            m || p || l();
          }, [m, p, l]);
      ...
      tc = (0, a.withTranslation)(
        (e) => {
          ...
          let {
            ...
            [f, x] = (0, n.useState)(l),
            [g, b] = (0, n.useState)(u);
          (l !== f && (x(l), l && !m && p(!1)), u !== g && (b(u), u && !c && d(!1)));
...
//# debugId=5d5382ea-a215-cfe7-da55-df962b4299e5
//# sourceMappingURL=3kr_vo7l65e1_.js.map
