...
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
      ...
      [
        ...
        (e) => {
          let { children: o } = e,
            ...
            { isFetched: C, user: S } = (0, a.useRobloxAuthentication)(),
          ...
          return (0, t.jsx)(g.Provider, { value: P, children: o });
        },
      ...
      0,
      {
        ...
        invitationClient: {
          createInvitation: async (e, t) =>
            s.v1OrganizationsOrganizationIdInvitationsPost({
              organizationId: e,
              createInvitationRequestModel: t
            }),
          getInvitationsByOrganizationId: async (e, t, n) =>
            s.v1OrganizationsOrganizationIdInvitationsGet({
              organizationId: e,
              pageToken: t,
              maxPageSize: n
            }),
          getInvitation: async (e, t) =>
            s.v1OrganizationsOrganizationIdInvitationsInvitationIdGet({
              organizationId: e,
              invitationId: t
            }),
          acceptOrDeclineInvitation: async (e, t, n) =>
            s.v1OrganizationsOrganizationIdInvitationsInvitationIdPatch({
              organizationId: e,
              invitationId: t,
              updateInvitationRequestModel: n
            }),
          deleteInvitationById: async (e, t) =>
            s.v1OrganizationsOrganizationIdInvitationsInvitationIdDelete({
              organizationId: e,
              invitationId: t
            }),
          getRoleIdsByInvitationId: async (e, t) =>
            s.v1OrganizationsOrganizationIdInvitationsInvitationIdRoleIdsGet({
              organizationId: e,
              invitationId: t
            })
        },
        roleClient: {
          createRole: async (e, t) =>
            o.v1OrganizationsOrganizationIdRolesPost({
              organizationId: e,
              createOrUpdateRoleRequestModel: t
            }),
          getRoleMetadata: async (e, t, n) =>
            o.v1OrganizationsOrganizationIdRolesRoleIdMetadataGet({
              organizationId: e,
              roleId: t,
              isDefault: n
            }),
          updateRoleMetadata: async (e, t, n) =>
            o.v1OrganizationsOrganizationIdRolesRoleIdMetadataPatch({
              organizationId: e,
              roleId: t,
              createOrUpdateRoleRequestModel: n
            }),
          updateRolePosition: async (e, t, n) =>
            o.v1OrganizationsOrganizationIdRolesRoleIdPositionPatch({
              organizationId: e,
              roleId: t,
              updateRolePositionRequestModel: n
            }),
          getRolesByOrganization: async (e, t, n) =>
            o.v1OrganizationsOrganizationIdRolesGet({
              organizationId: e,
              pageToken: t,
              maxPageSize: n
            }),
          getUsersWithRole: async (e, t, n, a, i) =>
            o.v1OrganizationsOrganizationIdRolesRoleIdUsersGet({
              organizationId: e,
              roleId: t,
              pageToken: n,
              maxPageSize: a,
          ...
          deleteRole: async (e, t) =>
            o.v1OrganizationsOrganizationIdRolesRoleIdDelete({ organizationId: e, roleId: t }),
          getInvitationsWithRole: async (e, t, n, a) =>
            o.v1OrganizationsOrganizationIdRolesRoleIdInvitationsGet({
              organizationId: e,
              roleId: t,
              pageToken: n,
              maxPageSize: a
  ...
  (e) => {
    ...
    let i = new (class {
        ...
        searchUsers(e, t, n) {
          return this.userSearchApi.v1UsersSearchGet({ keyword: e, limit: t, cursor: n });
        }
        getUserById(e) {
        ...
        constructor() {
          ...
          ((this.displayNameApi = new n.DisplayNamesApi(e)),
            (this.usersApi = new n.UsersApi(e)),
            (this.userSearchApi = new n.UserSearchApi(e)));
        }
      })(),
      r = new n.UsersApi((0, a.createClientConfiguration)("users", "bedev1"));
    e.s(["UsersClient", 0, { usersApi: r }, "default", 0, i]);
  },
  127403,
  (e) => {
    "use strict";
  ...
  (e) => {
    ...
    let w = (0, h.makeStyles)()(() => ({
                    ...
                    (0, t.jsx)(g.Grid, {
                      ...
                      children: (0, t.jsx)(v.Typography, {
                        ...
                        children: z
                          ...
                          : c("Message.JoinOrganization", { username: null != k ? k : "" })
                      })
                    })
                  ]
                })
      ...
      P = (0, i.withTranslation)(
        (e) => {
          let { open: a, onClose: r, invitation: s, accepted: o } = e,
    ...
    let R = (0, i.withTranslation)(
      (e) => {
        let { children: i } = e,
          ...
          { currentItemGroupId: f } = (0, c.default)(),
          [m, g] = (0, n.useState)(),
          [v, h] = (0, n.useState)(),
          [y, b] = (0, n.useState)(),
          [C, S] = (0, n.useState)(!1),
                ...
                y &&
                  (0, t.jsxs)(t.Fragment, {
                    children: [
                      (0, t.jsx)(E, {
                        open:
                          y.invitationStatusType === o.InvitationStatusType.Open && void 0 === A,
                        onClose: (e) => {
  ...
  (e) => {
    ...
    let c = (0, e.i(272593).createClientConfiguration)("creator-home-api", "bedev2"),
      ...
      d = function () {
        ...
        return (0, r.useQuery)({
          ...
          queryFn: () => {
            let e;
            return ((e = { surface: s.GroupListSurface.CreatorHub }), u.groupsListGroups(e));
          }
        });
      },
    ...
    e.s(
      [
        ...
        (e) => {
          let { children: r } = e,
            { user: s } = (0, a.useRobloxAuthentication)(),
            { data: o, isLoading: l, refetch: c } = d(),
            [u, f] = (0, i.useLocalStorage)(
              "creatorHubGroups.".concat(null == s ? void 0 : s.id),
              null
            ),
            [m, g] = (0, i.useLocalStorage)(
              "creatorHubGroup.".concat(null == s ? void 0 : s.id),
              null
            ),
            [v, h] = (0, i.useLocalStorage)(
              "creatorHubGroupData.".concat(null == s ? void 0 : s.id),
              {}
            ),
            y = (0, n.useCallback)(
              (e) => {
          ...
          return (0, t.jsx)(p.Provider, { value: S, children: r });
        },
        "useCurrentGroup",
        0,
        () => {
    ...
    var t = e.i(416340),
      ...
      i = (e) => {
        ...
        let l,
            ...
            return (
              ...
              (0, a.useLayoutEffect)(() => {
                if (s) {
                  var e;
                  let t,
                    n = null != (e = s.ownerDocument.defaultView) ? e : window,
                    a = (e) => {
          ...
          f = "function" == typeof d ? d({ present: p.isPresent }) : t.Children.only(d),
          m = (0, n.useComposedRefs)(
            p.ref,
            (c =
              (l =
                null == (s = Object.getOwnPropertyDescriptor((i = f).props, "ref"))
                  ? void 0
                  : s.get) &&
              "isReactWarning" in l &&
              l.isReactWarning)
              ...
              : (c =
                    (l =
                      null == (o = Object.getOwnPropertyDescriptor(i, "ref")) ? void 0 : o.get) &&
                    "isReactWarning" in l &&
                    l.isReactWarning)
                ? i.props.ref
                : i.props.ref || i.ref
          );
        return "function" == typeof d || p.isPresent ? t.cloneElement(f, { ref: m }) : null;
      };
    function r(e) {
  ...
  (e) => {
    ...
    function b(e) {
      ...
      return (0, f.jsx)(h, { scope: t, ...A, children: "function" == typeof g ? g(A) : a });
    }
    var C = "CheckboxTrigger",
      S = i.forwardRef((e, t) => {
        let { __scopeCheckbox: n, onKeyDown: a, onClick: s, ...l } = e,
          {
            control: c,
            value: u,
            disabled: d,
      ...
      return (0, f.jsx)(b, {
        ...
        internal_do_not_use_render: (e) => {
          ...
          return (0, f.jsxs)(f.Fragment, {
            children: [
              (0, f.jsx)(S, { ...d, ref: t, __scopeCheckbox: n }),
              a && (0, f.jsx)(P, { __scopeCheckbox: n })
            ]
          });
        }
      });
        ...
        let {
          ...
          S =
            ...
            n.default.createElement(
              ...
              v ? C : n.default.createElement("span", null)
            );
    ...
    e.s([
      ...
      function (e) {
        var r = e.children,
          ...
          v = (0, n.useCallback)(
            function (e, t) {
              (void 0 === t && (t = {}), u({ props: t, children: e }));
            },
            [u]
          ),
          h = (0, n.useMemo)(
            function () {
              return { ref: o, open: m, close: g, configure: v };
            },
            [g, v, m]
          );
        return n.default.createElement(
          n.default.Fragment,
          null,
          n.default.createElement(i.Provider, { value: h }, r),
          n.default.createElement(
            a.default,
            (0, t._)({}, c.props, s, {
          ...
          function (e) {
            ...
            return t.default.createElement(
              ...
              t.default.createElement(
                a.default,
                null,
                t.default.createElement(s.D, { id: "dialog-content-text-describe-id" }, p)
              ),
              t.default.createElement(
                i.default,
                null,
    ...
    e.s([
      ...
      function (e) {
        ...
        return n.default.createElement(
          n.default.Fragment,
          null,
          n.default.createElement(i.Provider, { value: C }, c),
          n.default.createElement(
            a.S,
            (0, t._)({}, (null == (r = v[0]) ? void 0 : r.props) || {}, u, {
              TransitionProps: (0, t._)(
                (0, t._)(
                  {},
                  (null == (o = null == (s = v[0]) ? void 0 : s.props)
                    ? void 0
                    : o.TransitionProps) || {}
                ),
                {
              ...
              onClose: function (e, t) {
                var n, a, i;
                ((null == (n = v[0]) ? void 0 : n.shouldClose(t)) && m(!1),
      ...
      [
        ...
        (e) => {
          ...
          return (0, s.jsxs)(o.Provider, {
            value: d,
            children: [n, a && (0, s.jsx)(t, { request: a, open: i, onDismiss: u })]
          });
        },
  ...
  (e) => {
    ...
    e.s([
      ...
      (e) => {
        var s;
        let { children: o, unifiedLogger: l, pageLoggerConfig: c, path: u } = e,
          d = null != (s = null == c ? void 0 : c.tags) ? s : a,
          p = null == c ? void 0 : c.rosId,
          f = (0, t.useMemo)(() => ({ tags: d, rosId: p, path: u }), [d, p, u]),
          m = (0, t.useRef)(f),
          g = (0, t.useRef)(f);
        ((0, t.useLayoutEffect)(() => {
          ((g.current = f),
        ...
        let v = (0, t.useMemo)(() => ({ unifiedLogger: l, pageContext: f }), [l, f]);
        return t.default.createElement(n.Provider, { value: v }, o);
      },
