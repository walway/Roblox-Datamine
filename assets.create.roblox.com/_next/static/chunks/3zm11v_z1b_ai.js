...
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
          ...
          (0, h._)(
            ...
            l,
            {
              children: [
                ...
                "determinate" === s
                  ? null
                  : (0, y.jsx)(G, { className: c.bar2, ownerState: u, style: g })
              ]
            }
          )
        );
  ...
  (e) => {
    ...
    function C(e, t) {
      return null == e
        ...
        : {
            ...
            categoryJustification: (0, d.exists)(e, "categoryJustification")
              ? e.categoryJustification
              : void 0
          };
    }
    function U(e, t) {
    ...
    function E(e, t) {
      return null == e ? e : { resourceInfos: e.resource_infos.map(g) };
    }
    function G(e) {
      var t;
      return null == (t = e)
    ...
    function $(e, t) {
      return null == e ? e : { keys: e.keys.map(Z) };
    }
    var Y = (function (e) {
        function t() {
    ...
    var ev =
      (((eo = {}).Default = "Default"),
      (eo.ReturnFromLogin = "ReturnFromLogin"),
      (eo.EditPlace = "EditPlace"),
      (eo.ViewAsset = "ViewAsset"),
      eo);
    let ef = async (e, t, i) => {
        let n = ""
    ...
    let eg = async (e) => {
        ...
        try {
          ...
          if (null == e ? void 0 : e.enableDummyCodeInInstaller)
            return eb(33).replaceAll("+", "-").replaceAll("/", "_").replace(/=+$/, "");
          if (
            !e ||
        ...
        return (
          ...
          e.task === ev.ViewAsset
            ...
            : (t.push("launchmode:edit"),
              ...
              (e.task === ev.Default || e.task === ev.ReturnFromLogin) &&
    ...
    e.s(
      [
        ...
        (e) => {
          ...
          return i.default.createElement(en.Provider, { value: t }, n);
        },
        ...
        function (e) {
          ...
          return {
            ...
            bedev2BasePath:
              i === ed ? "https://apis.roblox.com" : "https://apis.".concat(i, ".robloxlabs.com"),
            clientId: l,
          ...
          let b = (0, i.useCallback)(
              async (e, i) => {
                ...
                try {
                  ...
                  switch (e.task) {
                    case ev.EditPlace:
                      A = ex({ ...g, task: e.task, universeId: e.universeId, placeId: e.placeId });
                      break;
                    case ev.ViewAsset:
                      A = ex({ ...g, task: e.task, assetId: e.assetId });
                      break;
                    case ev.Default:
            ...
            dialog: (0, i.useMemo)(
              () =>
                i.default.createElement(
                  ...
                  "Loading" === s &&
                    i.default.createElement(ea, { logoSrc: o.logoSrc, translations: e }),
                  "Error" === s &&
