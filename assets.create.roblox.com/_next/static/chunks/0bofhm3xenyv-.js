          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "bf7677ee-e588-19c7-3a71-bcc5830899e6");
  } catch (e) {}
})();
    ...
    let K = (e) => {
        let { open: s, onClose: r, creation: i, groupId: l } = e,
          ...
          Q = (0, n.useCallback)(() => {
            ...
            W({ itemId: String(null != n ? n : ""), itemType: t, folderId: h });
          }, [W, i, h]),
          X = (0, n.useCallback)(
            (e) => {
              (g(!1),
      ...
      let { itemType: s, creation: r, removeItem: i, handleClose: o, isDisabled: l } = e,
        ...
        C = (0, n.useCallback)(async () => {
          ...
          try {
            (await a,
              i(),
              g(r.isArchived ? f("Message.RestoreSuccess") : f("Message.ArchiveSuccess")));
          } catch (e) {
            g(f("Response.UnknownError"));
          } finally {
            (d(!1), E(), o());
          }
        }, [s, r, i, g, f, o, E]),
  ...
  (e) => {
    ...
    let P = function (e) {
      ...
      U = (0, r.withTranslation)(
        function (e) {
          let { creation: A, handleClose: v, updateItem: f } = e,
            { enqueue: h, close: T } = (0, p.useSnackbar)(),
            ...
            N = (0, n.useCallback)(async () => {
              ...
              try {
                ...
                e
                  ? (f({ ...A, productStatus: 2 }), k(b("Message.ActivateSubscriptionSuccess"), e))
    ...
    let j = (0, r.withTranslation)(
      function (e) {
        let { creation: a, handleClose: l, updateItem: A } = e,
          { enqueue: v, close: f } = (0, p.useSnackbar)(),
          ...
          x = (0, n.useCallback)(async () => {
            ...
            try {
              ...
              e
                ? (A({ ...a, productStatus: 1 }), C(h("Message.DeactivateSubscriptionSuccess"), e))
                : C(h("Error.UnknownSubscriptionError"), !1);
            } catch (e) {
              C(h("Error.UnknownSubscriptionError"), !1);
            }
            (E(!1), b(), l());
          ...
          R = (0, n.useMemo)(() => {
            ...
            return (0, t.jsx)(o.DialogTemplate, {
              onConfirm: x,
              onCancel: b,
              title: h("Heading.DeactivateSubscription"),
              content: (0, t.jsx)(c.Typography, {
                color: "primary",
                children: h("Message.DeactivateSubscriptionPrompt", {
                  name: null != (e = a.name) ? e : ""
                })
              }),
              confirmText: h("Action.Deactivate"),
        ...
        a.productStatus !== s.ProductStatusType.OffSale)
          ...
          : (0, t.jsx)(
              ...
              {
                onClick: S,
                children: (0, t.jsx)(c.Typography, { children: h("Action.DeactivateOffSale") })
              },
              "Action.Deactivate"
            );
      },
    ...
    let _ = (0, r.withTranslation)(
      function (e) {
        let { creation: s, removeItem: a } = e,
          ...
          { open: f, close: g, configure: E } = (0, d.useDialog)(),
          {
      ...
      function (e) {
        let { creation: a, handleClose: l, updateItem: A } = e,
            ...
            async (e) => {
              ...
              try {
                ...
                if (t) {
                  ...
                  (A({ ...a, productStatus: n }), R(h("Message.DeactivateSubscriptionSuccess"), t));
                } else R(h("Error.UnknownSubscriptionError"), !1);
              } catch (e) {
                R(h("Error.UnknownSubscriptionError"), !1);
              }
              (E(!1), b(), l());
            },
            [a, b, l, A, R, h]
          ...
          B = (0, n.useMemo)(() => {
            ...
            return (0, t.jsx)(o.DialogTemplate, {
              onConfirm: () => w(C),
              onCancel: b,
              title: h("Heading.SubscriptionOffSale"),
              content: (0, t.jsxs)(t.Fragment, {
                children: [
                  (0, t.jsx)(c.Typography, {
                    color: "primary",
                    children: h("Description.SubscriptionOffSale", {
                      name: null != (e = a.name) ? e : ""
                    })
                  }),
                      ...
                      children: [
                        (0, t.jsx)(O.FormControlLabel, {
                          ...
                          control: (0, t.jsx)(V.Radio, {
                            size: "small",
                            color: "primary",
                            "aria-label": h("Label.KeepRenewals")
                          }),
                          label: (0, t.jsx)(c.Typography, {
                            variant: "captionBody",
                            children: h("Label.KeepRenewals")
                          })
                        }),
                        (0, t.jsx)(O.FormControlLabel, {
                          value: "true",
                          ...
                          control: (0, t.jsx)(V.Radio, {
                            size: "small",
                            color: "primary",
                            "aria-label": h("Label.CancelRenewals")
                          }),
                          label: (0, t.jsx)(c.Typography, {
                            variant: "captionBody",
                            children: h("Label.CancelRenewals")
                          })
                        })
                      ]
                    })
              ...
              confirmText: h("Action.TakeOffSale"),
              cancelText: h("Action.KeepOnSale"),
              loading: I
            });
          }, [w, b, h, a.name, I, C]),
          M = (0, n.useCallback)(() => {
        ...
        a.productStatus !== s.ProductStatusType.Active)
          ...
          : (0, t.jsx)(
              ...
              {
                onClick: M,
                children: (0, t.jsx)(c.Typography, { children: h("Action.TakeOffSale") })
              },
              "Action.TakeOffSale"
            );
      },
    ...
    let C = ["actions", "children", "className", "defaultValue", "name", "onChange", "value"],
      x = s.forwardRef(function (e, r) {
        let {
          ...
          [I, x] = (0, l.u)({ controlled: h, default: y, name: "RadioGroup" });
...
//# debugId=bf7677ee-e588-19c7-3a71-bcc5830899e6
//# sourceMappingURL=2lgqfhtk84dy5.js.map
