          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "5a44b4e2-89df-4ec2-f6f2-bdea61083952");
  } catch (e) {}
})();
  ...
  (t) => {
    ...
    let cF = null,
      ...
      cW = () => {
        ...
        return r ? (0, v.jsx)(cG, { flags: cB, contexts: a }) : null;
      };
    var cH = t.i(911502);
    let cK = (t) => {
    ...
    let c4 = (t) => {
          ...
          i.current.setConfig({
            ...
            api: {
              retCodeHandler(t, n, r) {
                let i = !(
                    (r.status === c0.StatusCodes.FORBIDDEN && r.headers.has("x-csrf-token")) ||
                    r.status === c0.StatusCodes.OK ||
                    r.status === c0.StatusCodes.ACCEPTED
                  ),
                  a = "unknown";
                try {
                  let n = JSON.parse(t);
      ...
      return (0, v.jsx)(c2.default.Provider, { value: a, children: n });
    };
    var c3 = t.i(37819),
      c6 = t.i(431346),
      c8 = t.i(881670);
    ...
    let lp = lu.$constructor("ZodMiniType", (t, n) => {
        ...
        (ll.$ZodType.init(t, n),
          (t.def = n),
          (t.type = n.type),
          (t.parse = (n, r) => lh.parse(t, n, r, { callee: t.parse })),
          (t.safeParse = (n, r) => lh.safeParse(t, n, r)),
          (t.parseAsync = async (n, r) => lh.parseAsync(t, n, r, { callee: t.parseAsync })),
          (t.safeParseAsync = async (n, r) => lh.safeParseAsync(t, n, r)),
          (t.check = function () {
    ...
    function lb(t, n) {
      return new lg({ type: "array", element: t, ...ld.normalizeParams(n) });
    }
    let lw = lu.$constructor("ZodMiniObject", (t, n) => {
      (ll.$ZodObject.init(t, n), lp.init(t, n), ld.defineLazy(t, "shape", () => n.shape));
    });
    function lx(t, n) {
      return new lw({ type: "object", shape: null != t ? t : {}, ...ld.normalizeParams(n) });
    }
    ...
    function lq(t) {
      return new lE({ type: "optional", innerType: t });
    }
    (t, n) => {
    ...
    var lC = t.i(694257),
      ...
      lN = (t) => {
        ...
        return (0, v.jsx)(lO.Provider, { value: n, children: r });
      },
      lD = () => {
      ...
      l_ =
        (((i = l_ || {}).AccountReactivationPageRendered = "accountReactivationPageRendered"),
    ...
    function lU() {
      let { sendAnalyticsEvent: t, platform: n, readOnly: r } = lD();
    ...
    var lK = (0, oc.createContext)(void 0),
      lJ = (t) => {
        ...
        return (0, v.jsx)(lK.Provider, { value: P, children: u });
      },
      lz = () => {
      ...
      lQ = (t) => {
        let { punishmentData: n, commutationEligibility: r } = t,
          { isFirstPage: i, currentPageConfigs: a, currentPageName: o } = lz(),
          s = a
            .map((t) => {
      ...
      lY = (t) => {
        ...
        let { punishmentData: r } = t,
          { isFirstPage: i, totalPages: a } = lz(),
          { readOnly: o } = lD(),
          s = lD().translate,
          { punishmentTypeDescription: u, verificationCategory: c } = r,
          l = c
            ? s("Heading.Suspended")
            : s(null != (n = lF[u]) ? n : "") || s("Heading.Suspended");
        return i
          ? (0, v.jsx)("div", {
      ...
      l0 = (t) => {
        let { punishmentData: n, setIsDialogOpen: r } = t,
          { CurrentCtaComponent: i, currentPageName: a } = lz();
        return i
          ? (0, v.jsx)("div", {
        ...
        return (
          ...
          (0, v.jsx)("div", {
            ...
            children: (0, v.jsxs)("div", {
              ...
              children: [
                (0, v.jsx)(lt.Icon, { name: "icon-regular-triangle-exclamation", size: "XLarge" }),
                (0, v.jsx)("span", {
    ...
    var l8 = lx({
      ...
      l5 = new lP({
        ...
        options: [
          lx({
            ...
            text: lq(lm()),
            textKey: lq(lm()),
            textKeyParameters: lq(
              ((s = lm()),
              new lR(
                (u = lm()) && u._zod
                  ? { type: "record", keyType: s, valueType: u, ...ld.normalizeParams(void 0) }
                  : { type: "record", keyType: lm(), valueType: s, ...ld.normalizeParams(u) }
              ))
            )
          }).check(
            lA((t) => void 0 !== t.text || void 0 !== t.textKey, {
          ...
          lx({ type: lT("image"), labelKey: lm(), url: lm(), altLabelKey: lq(lm()) })
        ],
      ...
      l7 = lx({ ...l8.shape, elements: lq(lb(l5)) }),
      de = (t) => {
        let n = t.violation;
        if (!n) return !1;
        let { evidence: r } = n;
      ...
      dn = (t) => {
        let { enableIxp: n = !1, children: r } = t,
          i = lD().translate,
          {
            ...
            let { httpGet: t, userModerationApiUrl: n } = lD();
          ...
          { data: d, isLoading: f } = (() => {
            let { httpGet: t, apiGatewayUrl: n } = lD();
            return (0, le.useQuery)({
          ...
          p = (0, oc.useMemo)(() => {
            let t = new Set(),
              n = new Set();
            if ((null == h ? void 0 : h.violation) && de(h))
        ...
        return (0, v.jsx)(dt.Provider, { value: y, children: r });
      },
      dr = () => {
      ...
      da = (t) => {
        let { children: n } = t,
          { currentPage: r, currentPageName: i, unmappedViolationKeys: a } = lz(),
          o = lU(),
        ...
        return (0, v.jsx)(di.Provider, { value: h, children: n });
      },
      ds = () => {
      ...
      dm = (t, n) => (r, i, a, o) => {
        var s;
        let [u, c] = t(r, { startLink: dp, endLink: dv, ...a }).split(dp, 2),
          [l, d] = null != (s = null == c ? void 0 : c.split(dv, 2)) ? s : [];
        return (0, v.jsxs)("p", {
    ...
    var dE = (t) => {
      ...
      dk = {
        ...
        renderComponent: (t) => {
          ...
          let { punishmentData: i } = t,
            ...
            d = null != (n = null == l ? void 0 : l.filter((t) => l9(t))) ? n : [],
            f = [],
            h = [];
          d.forEach((t) => {
            var n;
            "image" === t.type
              ? f.push((0, v.jsx)(dR, { url: t.url, altLabelKey: t.labelKey }, t.url))
              : h.push(
                  (0, v.jsx)(
                    dE,
                    {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              ...
              (0, v.jsxs)("div", {
                ...
                children: [
                  h,
                  (0, v.jsx)(dE, { fieldLabel: s("Label.ReviewDate"), fieldValue: u(i.beginDate) }),
                  o && (0, v.jsx)(dE, { fieldLabel: s("Label.DecisionMethod"), fieldValue: o }),
                  (0, v.jsx)(dq, {})
                ]
              })
            ]
      ...
      dC = {
        getIsVisible: (t) => {
          var n, r;
          return (
            !de(t) && (null != (n = null == (r = t.badUtterances) ? void 0 : r.length) ? n : 0) > 0
          );
        },
        renderComponent: (t) => {
          let { punishmentData: n } = t,
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              (0, v.jsx)(dA, { badUtterances: null != a ? a : [] }),
              (0, v.jsx)(lj.Divider, {}),
              (0, v.jsx)(dE, { fieldLabel: r("Label.ReviewDate"), fieldValue: i(n.beginDate) }),
              o && (0, v.jsx)(dE, { fieldLabel: r("Label.DecisionMethod"), fieldValue: o }),
              (0, v.jsx)(dq, {})
            ]
          });
        },
      ...
      dI = {
        ...
        renderComponent: (t) => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              (0, v.jsx)(dE, { fieldLabel: n("Label.ReviewDate"), fieldValue: r(a) }),
              o && (0, v.jsx)(dE, { fieldLabel: n("Label.DecisionMethod"), fieldValue: o }),
              (0, v.jsx)(dq, {})
            ]
          });
        },
      ...
      dB =
        (((c = dB || {})[(c.Reactivate = 0)] = "Reactivate"),
        (c[(c.Paused = 1)] = "Paused"),
      ...
      dz = () => {
        let t = lD().translate,
          { sendPageEvent: n } = ds(),
          { httpPost: r, apiGatewayUrl: i, onAccountReactivated: a } = lD(),
          { handleAppealsClick: o } = dx(),
          [s, u] = (0, oc.useState)(!1),
          c = (0, ln.useMutation)({
            mutationFn: () => dJ(i, r),
            onMutate: () => {
      ...
      dX = (t) => {
        let { onOpenChange: n, children: r } = t,
          ...
          d = (0, oc.useMemo)(() => (null != l ? l : []).some((t) => t in dh), [l]),
        ...
        return s
          ? r({
              header: (0, v.jsx)(l1, { readOnly: !!i }),
              body: (0, v.jsx)(l2, {}),
              ctas: (0, v.jsx)(l4, {})
            })
          : u || !a
            ? r({ header: (0, v.jsx)(l3, {}), body: (0, v.jsx)(l6, { error: u }) })
            : (0, v.jsx)(lJ, {
                pages: f,
                ...
                children: (0, v.jsx)(da, {
                  children: r({
                    header: (0, v.jsx)(lY, { punishmentData: a }),
                    body: (0, v.jsx)(lQ, { punishmentData: a, commutationEligibility: c }),
                    ctas: (0, v.jsx)(l0, { punishmentData: a, setIsDialogOpen: n })
                  })
                })
              });
      },
      d$ = (t) => {
        let { impressionEvent: n } = t,
          { translate: r, websiteUrl: i, onLogout: a } = lD(),
          o = lU(),
          s = dm(r, o),
          [u, c] = (0, oc.useState)(!1);
        (0, oc.useEffect)(() => {
        ...
        return (0, v.jsx)(c7.Dialog, {
          ...
          children: (0, v.jsxs)(c7.DialogContent, {
            ...
            children: [
              (0, v.jsxs)(c7.DialogBody, {
                className: "gap-large flex flex-col",
                children: [
                  (0, v.jsx)(c7.DialogTitle, {
      ...
      dZ = (t) => {
        ...
        let { open: r, onClose: i } = t,
          ...
          p = lU(),
          { punishmentData: m, isLoading: y, error: g, ixpData: b } = dr(),
        ...
        if (x && (null == (n = m.context) ? void 0 : n.SelfServiceDeactivated))
          return l
            ...
            : (0, v.jsx)(d$, { impressionEvent: "accountReactivationRedirectRendered" });
        let R = x && (null == d ? void 0 : d(m));
        return R
          ? (0, v.jsx)(d$, { impressionEvent: R })
          : (0, v.jsx)(c7.Dialog, {
              open: null != r ? r : a,
              size: "Large",
                  ...
                  children: (0, v.jsx)(dX, {
                    ...
                    children: (t) => {
                      ...
                      return (0, v.jsxs)("div", {
                        ...
                        children: [
                          (0, v.jsx)(c7.DialogTitle, { className: "padding-none", children: n }),
                          (0, v.jsxs)("div", {
      ...
      d0 = function (t) {
        ...
        return (0, v.jsx)(op.QueryClientProvider, {
          ...
          children: (0, v.jsx)(dn, {
            enableIxp: !0,
            children: (0, v.jsx)(dZ, { open: n, onClose: r })
          })
        });
      },
      d1 = t.i(894244),
    ...
    let d4 = function () {
        let { translate: t } = (0, ob.useTranslation)(),
          ...
          c = (0, oc.useCallback)(
            (t) => !!t.verificationCategory && l_.VerificationRedirectRendered,
            []
          ),
      ...
      d3 = () => {
        let t = d4();
        return (0, v.jsx)(lN, { config: t, children: (0, v.jsx)(d0, {}) });
      },
      d6 = (0, ob.withTranslation)(() => {
        let { themeMode: t } = (0, cr.useThemeMode)();
        return (0, v.jsx)(cs.UIThemeProvider, { theme: t, children: (0, v.jsx)(d3, {}) });
      }, [
        c8.TranslationNamespace.NotApproved,
        c8.TranslationNamespace.Moderation,
        c8.TranslationNamespace.AppealsPortal,
        c8.TranslationNamespace.CommonUIControls,
        c8.TranslationNamespace.Error,
        c8.TranslationNamespace.DashboardModeration
      ]),
      d8 = () => {
    ...
    let d9 = (0, cm.default)(() => t.A(14667), {
      ...
      d7 = (t) => {
        let { children: n } = t;
        return (0, v.jsx)(d5.UniversalFeatureRestrictionsProvider, { Surface: d9, children: n });
      };
    var fe = t.i(336964);
    function ft(t) {
    ...
    function fn(t) {
      ...
      if (
        ...
        return null;
      if ((null == o ? void 0 : o.mode) === "standalone" && ft(a))
    ...
    function fa() {
      let { current: t } = (0, oc.useSyncExternalStore)(
        fi.snackbarStore.subscribe,
        fi.snackbarStore.getSnapshot,
        fi.snackbarStore.getSnapshot
      );
      return null === t
        ? null
        : (0, v.jsx)(fr.Snackbar, { ...t.props, onClose: () => fi.snackbarStore.dismiss() }, t.id);
    }
    var fo = t.i(943758);
    ...
    let fu = (t) => {
      ...
      return (0, v.jsx)(fs.Provider, { value: a, children: n });
    };
    var fc = t.i(729904),
      fl = t.i(486736),
      fd = t.i(47033),
    ...
    let fb = {
      ...
      fx = (0, ob.withTranslation)(() => {
        let t = (0, ol.useRouter)(),
          ...
          a = (0, oc.useRef)(!1),
          { captureError: o, error: s, info: u } = (0, fg.useMetricsMonitoring)(),
          [c, l] = (0, oc.useState)(!1),
          [d, f] = (0, oc.useState)(!1),
          [h, p] = (0, oc.useState)([]),
          m = (0, oc.useCallback)(
            async (t) => {
              async function n(t, r) {
                ...
                try {
                  var i;
                  let a =
                    null == (i = (await fm.userAgreementsClient.acceptUserAgreements(t)).results)
                      ? void 0
                      : i.reduce((t, n) => (0 !== n.errorCode ? [...t, n.agreementId] : t), []);
                  a && a.length > 0 && (await n(a, r - 1));
                } catch (a) {
                  let i = (0, fy.getResponseFromError)(a);
                  (null == i ? void 0 : i.status) === c0.StatusCodes.UNAUTHORIZED
        ...
        return (
          (0, oc.useEffect)(() => {
            (null == r ? void 0 : r.id) === void 0 ||
              a.current ||
              !t.isReady ||
              fw.some((n) => t.pathname.startsWith(n)) ||
              (b(), (a.current = !0));
      ...
      { authenticationApi: fP } = { authenticationApi: u5 },
      { discoveryApi: fR } = uT.ApplicationAuthorizationsClient,
      { usersApi: fS } = u9.UsersClient,
      fT =
        ((r = cd.default),
        (t) => {
    ...
    let fq = { locale: cY.defaultLocale, nativeName: cY.defaultNativeName },
      ...
      fj = () => (
        (() => {
          ...
          ((0, cQ.default)(void 0, n),
            (0, oc.useEffect)(() => n(), [n]),
            (0, oc.useEffect)(() => {
              cd.default.trackPageLoad();
            }, []));
        })(),
        (0, od.useReportWebVitals)(fT),
        null
      ),
      fL = (t) => {
        let { children: n } = t,
          { settings: r, isFetched: i } = (0, fl.useSettings)();
      ...
      fD = (t) => {
        ...
        let { Component: r, pageProps: i, cache: a } = t,
          ...
          u = null != (n = r.getPageLayout) ? n : fI,
          c = (0, oc.useMemo)(() => ({ ...fC, ...r.pageMetadata }), [r.pageMetadata]);
        return (
          ...
          (0, v.jsx)(of.ErrorBoundary, {
            children: (0, v.jsx)(ud, {
              ...
              children: (0, v.jsxs)(cK, {
                providers: [
                  (0, v.jsx)(fo.BreadcrumbItemNameProvider, {}),
                  (0, v.jsx)(op.QueryClientProvider, { client: fO }),
                  (0, v.jsx)(cp.CustomDashboardServiceProvider, {}),
                  (0, v.jsx)(cp.UniverseFlaggedCustomDashboardProvider, {}),
                  (0, v.jsx)(fA, { universeId: s }),
                  (0, v.jsx)(c$, { pageLoggerConfig: r.loggerConfig }),
                ...
                children: [
                  (0, v.jsx)(fj, {}),
                  (0, v.jsx)(cn, { provider: fk }),
                  (0, v.jsx)(fa, {}),
                  (0, v.jsx)(fn, {}),
                  (0, v.jsx)(d8, {}),
                  (0, v.jsx)(fx, {}),
                  (0, v.jsx)(cW, {}),
                  (0, v.jsx)(c9, { openGraphMetadata: c }),
...
//# debugId=5a44b4e2-89df-4ec2-f6f2-bdea61083952
//# sourceMappingURL=38wi-2-5-hql5.js.map
