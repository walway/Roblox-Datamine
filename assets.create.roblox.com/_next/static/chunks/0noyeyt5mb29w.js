                ...
                case 1:
                  return (
                    ...
                    [
                      2,
                      new t.JSONApiResponse(r, function (e) {
                        return null == e ? e : { requirements: e.Requirements.map(v) };
                      })
                    ]
                  );
              }
      ...
      function (e) {
        return {
          onFetch: (r, a) => {
            ...
            let d = r.options,
              c =
                null == (l = r.fetchOptions) || null == (o = l.meta) || null == (s = o.fetchMore)
                  ? void 0
                  : s.direction,
                ...
                let a = !1,
                  ...
                  o = async (e, i, n) => {
                    ...
                    let l =
                        ...
                        o),
                      u = await s(l),
                      { maxPages: f } = r.options,
                      d = n ? t.addToStart : t.addToEnd;
                    return { pages: d(e.pages, u, f), pageParams: d(e.pageParams, i, f) };
                  };
                if (c && p.length) {
                  let e = "backward" === c,
                    t = { pages: p, pageParams: h },
                    r = (e ? n : i)(d, t);
                  v = await o(t, r, e);
                } else {
      ...
      n = class extends t.QueryObserver {
        ...
        createResult(e, t) {
          ...
          let { state: a } = e,
            ...
            { isFetching: o, isRefetching: l, isError: u, isRefetchError: f } = s,
            d = null == (r = a.fetchMeta) || null == (n = r.fetchMore) ? void 0 : n.direction,
            c = u && "forward" === d,
            p = o && "forward" === d,
            h = u && "backward" === d,
            v = o && "backward" === d;
