          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "c508e02e-8d2f-05c1-c717-93a5d629ed88");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let m = (0, e.i(706442).makeStyles)()((e, t) => {
      let { isGood: a, hasBackground: s, dimmedLabel: i, useWarningBackgroundWhenNotGood: r } = t,
        ...
        c = e.palette.content.standard,
        l = e.palette.content.standard;
      return (
        i
          ? ((c = e.palette.content.muted), (l = e.palette.content.muted))
          : a
            ? ((c = e.palette.content.alert.active), (l = e.palette.content.alert.active))
            : !a &&
              r &&
              ((c = e.palette.content.alert.important), (l = e.palette.content.alert.important)),
        {
          labelColor: { color: c, backgroundColor: n, lineHeight: "140%" },
          icon: { stroke: l },
      ...
      [
        ...
        (e) => {
          let {
              ...
              dimmedLabel: y = !1,
              hasBackground: x = !1,
              useWarningBackgroundWhenNotGood: b = !1
            } = e,
            I = (0, d.default)(),
            { translate: T } = (0, o.default)((0, s.useTranslation)()),
            {
              ...
              hasBackground: x,
              dimmedLabel: y,
              useWarningBackgroundWhenNotGood: b
            }),
            C = (0, a.useMemo)(() => {
              let e = Math.abs(h) > 10,
                t = e ? 10 : h,
                ...
                i = (null == _ ? void 0 : _.inRoundedComparisonChipContext) ? 0 : v;
              return (0, f.formatNumberWithSpec)(
                t,
                {
                  abbreviate: !1,
                  numberFormatOptions: {
                  ...
                  prefix: a
                    ? { type: l.TranslationKeyOrFormattedTextType.DynamicFormattedText, text: a }
                    : void 0
                },
                { locale: I, translate: T }
              );
            }, [I, v, null == _ ? void 0 : _.inRoundedComparisonChipContext, h, T]),
            R = (0, a.useMemo)(
              () =>
                (0, t.jsx)(c.Label, {
                  labelText: C,
                  variant: x ? "contained" : "text",
                  icon: u
  ...
  (e) => {
    ...
    (e.s(["default", 0, l, "isValidInsight", 0, c], 184757),
  ...
  (e) => {
    ...
    e.s(
      [
        ...
        0,
        (e, t) =>
          t === c.default.QualifiedPTRAndImpressionComparison
  ...
  (e) => {
    ...
    let ed = {
      ...
      experiences: { light: el.default, dark: ec.default },
      ...
      decals: { light: y.default, dark: v.default },
      images: { light: C.default, dark: S.default },
      videos: { light: eo.default, dark: en.default },
      meshes: { light: O.default, dark: G.default },
      animations: { light: $.default, dark: J.default },
      textDocuments: { light: b.default, dark: x.default },
      noUsers: { light: _.default, dark: p.default },
      ...
      apiKeys: { light: c.default, dark: n.default },
      ...
      barGraph: { light: h.default, dark: u.default },
    ...
    let em = "".concat(
        "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/assets",
        "/spot_illustrations"
      ),
      ef = {
        small: {
    ...
    let eg = (0, s.makeStyles)()(() => ({
      ...
      eh = (e) => {
        let { children: s, title: r, description: n, size: c = "large", illustration: l } = e,
          {
            classes: { smallContainer: o, largeContainer: d, smallText: m, largeText: f },
            cx: g
          } = eg();
        return (0, t.jsxs)(i.default, {
          classes: { root: g({ [o]: "small" === c, [d]: "large" === c }) },
          flexDirection: "column",
          alignItems: "center",
          children: [
            (0, t.jsx)(eu, { illustration: l, size: c }),
            (0, t.jsxs)(i.default, {
              classes: { root: g({ [m]: "small" === c, [f]: "large" === c }) },
              flexDirection: "column",
              alignItems: "center",
              children: [
    ...
    ((eh.displayName = "EmptyState"),
      e.s(["EmptyStateIllustration", 0, eu, "default", 0, eh], 493924));
  },
  756568,
  (e) => {
    "use strict";
  ...
  (e) => {
    ...
    var d = e.i(364494),
      ...
      u = e.i(272593),
      h = e.i(227987);
    let p = (0, u.createClientConfiguration)("universe-analytics-insights", "bedev2"),
      _ = new d.UniverseAnalyticsInsightsAPIApi(p),
      v = (e, t, a, s) =>
      ...
      y = (e, t, a, s) =>
        (0, m.isNonEmptyArray)(t)
          ? f.universeAnalyticsInsightsClient.getUniverseAnalyticsInsights({
              universeId: e,
              insightTypes: t,
              limit: a,
      ...
      x = (e, t) =>
        (0, m.isNonEmptyArray)(t)
          ? f.universeAnalyticsInsightsClient.getUniverseAnalyticsMostRecentInsights({
              universeId: e,
              insightTypes: t
            })
          : Promise.resolve([]),
      b = (e, t) =>
        t
          ? f.universeAnalyticsInsightsClient.getUniverseAnalyticsInsightByInsightId({
              universeId: e,
              id: t
            })
          : Promise.resolve(void 0);
    async function I(e) {
      let t = await (0, h.default)(e);
      if (t && 0 === t.code) {
      ...
      [
        ...
        function (e, t) {
          ...
          return (0, a.useQuery)({
            ...
            queryFn: () => T(e, t),
            retry: (e, t) => (t instanceof l || t instanceof o) && e < i,
            retryDelay: r,
        ...
        (e, t, a, n) => {
          let c = (0, s.useQueryClient)(),
            ...
            o = (e) => (e ? (Array.isArray(e) ? e.map(l).filter((e) => void 0 !== e) : l(e)) : e);
          return (0, i.useMutation)({
            mutationFn: () => v(e, t, a, n),
            onMutate: () => {
              c.setQueriesData(
                {
                  predicate: (t) => {
  ...
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/api_key_dark.1k1v6y4zm3j28.svg"
    );
  },
  609794,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/api_key_light.06t4q4202-77s.svg"
    );
  },
  57561,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/audio_dark.16razgllw2ska.svg"
    );
  },
  509747,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/audio_light.3ra073_18pbj-.svg"
    );
  },
  475555,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/avatar_setup_dark.0orjsl7i089hc.svg"
    );
  },
  538302,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/avatar_setup_light.32r86q54d7kuh.svg"
    );
  },
  387707,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/badge_dark.3m45r-3favo3f.svg"
    );
  },
  262135,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/badge_light.3fxfvj8ub7utb.svg"
    );
  },
  240731,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/bar_graph_dark.01vf9sty52re2.svg"
    );
  },
  956923,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/bar_graph_light.1iiixo_d8ur81.svg"
    );
  },
  84362,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/collaborators_dark.30gxkwssilacj.svg"
    );
  },
  214665,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/collaborators_light.3x7fovqhay1x5.svg"
    );
  },
  455506,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/decals_dark.2jpntsljojhzc.svg"
    );
  },
  918290,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/decals_light.16_gp3tnuc5p_.svg"
    );
  },
  716933,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/envelope_dark.2-ouf9shuihi4.svg"
    );
  },
  347319,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/envelope_light.1me9hqye66z7w.svg"
    );
  },
  543657,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/event_calendar_dark.3lx4_kse68by8.svg"
    );
  },
  850412,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/event_calendar_light.1pq-t84d90ty1.svg"
    );
  },
  103329,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/find_people_dark.220q6_cs04hcq.svg"
    );
  },
  692706,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/find_people_light.1gkb3pmwc8s2n.svg"
    );
  },
  405654,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/image_dark.2giew28wx4z86.svg"
    );
  },
  891409,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/image_light.0ouq8tcgpznz7.svg"
    );
  },
  758060,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/leaderboard_dark.301ypg94lbxpv.svg"
    );
  },
  710005,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/leaderboard_light.43sjz_ibwkiq_.svg"
    );
  },
  495550,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/line_chart_dark.0k7qf3mhepo6s.svg"
    );
  },
  320429,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/line_chart_light.049gcvvmai0ax.svg"
    );
  },
  106017,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/localization_dark.1ia7wat2mwyfi.svg"
    );
  },
  821978,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/localization_light.2jss_xvx2fuq0.svg"
    );
  },
  766389,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/lockSecrets_dark.0na6naigcbnkj.svg"
    );
  },
  374717,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/lockSecrets_light.0rzix2i1i13lt.svg"
    );
  },
  756733,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/makeup_look_dark.26-5-yn8598c9.svg"
    );
  },
  251697,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/makeup_look_light.0rc05t5n5al4m.svg"
    );
  },
  411118,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/managed_pricing_dark.2zdkf2-ctboa2.svg"
    );
  },
  839596,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/managed_pricing_light.0sioq_hruq1qp.svg"
    );
  },
  729733,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/meshes_dark.2tlm50ns1pq5o.svg"
    );
  },
  66217,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/meshes_light.36wh96flp2o3r.svg"
    );
  },
  148865,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/models_dark.30suu5lj5-ua5.svg"
    );
  },
  45512,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/models_light.0kiw6k3ejw-rn.svg"
    );
  },
  706478,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/models_plugins_parts_dark.3jp6jislnsqf8.svg"
    );
  },
  166181,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/models_plugins_parts_light.2nj1xhv0bfg_u.svg"
    );
  },
  37474,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/notifications_dark.2l_rf34_xo6o8.svg"
    );
  },
  147189,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/notifications_light.3p-b4rzvwwfmj.svg"
    );
  },
  105897,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/oauth_dark.42jv8--11_1i0.svg"
    );
  },
  123524,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/oauth_light.17vwiebwrn8ox.svg"
    );
  },
  752739,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/rights_manager_dark.0m7ca17sdbgim.svg"
    );
  },
  331105,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/rights_manager_light.1moaenz1cbft0.svg"
    );
  },
  564908,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/run_dark.1sun4tvxh_arh.svg"
    );
  },
  663412,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/run_light.29f-3jyw910_v.svg"
    );
  },
  215887,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/shareLinks_dark.1l5fwuv6cgzmy.svg"
    );
  },
  962803,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/shareLinks_light.116igf-ldibmu.svg"
    );
  },
  914865,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/signin_dark.1k_gzn1-5q0ca.svg"
    );
  },
  818392,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/signin_light.1o1-jng_ct0y2.svg"
    );
  },
  173034,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/token_dark.2qy4jy9ffjhax.svg"
    );
  },
  780078,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/token_light.2xc00j5zp1q8_.svg"
    );
  },
  756885,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/video_dark.2-gdpodjtsjj3.svg"
    );
  },
  260123,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/video_game_dark.0tuxtkttj8gcu.svg"
    );
  },
  507792,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/video_game_light.3l155817mjupj.svg"
    );
  },
  850994,
  (e) => {
    e.q(
      "https://assets.create.roblox.com/cf1fa629ddd4f84843af22111ce64840feca3e91/_next/static/media/video_light.1fum3vlxctp7w.svg"
    );
  },
  270092,
  (e) => {
    ...
    let n = { Small: "XSmall", Medium: "Small", Large: "Medium" },
      ...
      u = { Standard: "bg-shift-300", Utility: "bg-none" },
      h = {
      ...
      p = (e) => {
        let { iconName: t, node: a, size: c } = e;
        return null != t
          ? r.default.createElement(s.Icon, { name: t, size: n[c] })
          : null != a
      ...
      _ = (0, r.forwardRef)((e, s) => {
        let {
          ...
          A = r.default.createElement(
            ...
            r.default.createElement(p, { iconName: b, node: I, size: y }),
            r.default.createElement(
              "span",
              {
                className: (0, i.default)(
            ...
            r.default.createElement(p, { iconName: T, node: E, size: y })
          ),
          N = { textDecoration: "none", ...h };
        if ("a" === k.as) {
          let { as: e, href: t, ...a } = k;
          return r.default.createElement(
            "a",
            {
              ...
              "aria-disabled": v,
              href: v ? void 0 : t,
              className: (0, i.default)(R, u[x], "content-action-utility"),
              style: N
            },
            A
          );
  ...
  (e) => {
    ...
    let n = { Large: "size-1200", Medium: "size-1000", Small: "size-800", XSmall: "size-600" },
      ...
      u = (0, i.forwardRef)((e, u) => {
        ...
        let R = (0, s.default)(
          ...
          A = i.default.createElement(
            ...
            i.default.createElement("span", {
              className: (0, s.default)("icon", _, c[I], y ? g[E][T] : f[E][T])
            })
          );
        if (k) {
          let { as: e, ...t } = C,
          ...
          return i.default.createElement(
            r.Slot,
            { ref: u, ...t, className: R, "aria-label": v, "aria-disabled": y || void 0 },
        ...
        return i.default.createElement(
          "button",
          { ref: u, type: "button", ...q, "aria-label": v, disabled: y, className: R },
          A
        );
      });
    e.s(["IconButton", 0, u]);
    ...
    var p = (0, s.default)({ name: "AlertTitle" })(function (e) {
      ...
      _ = (0, a.forwardRef)(function (e, s) {
        var r = e.classes,
          ...
          l = p(void 0, { props: { classes: (0, i.default)(r, n) } });
        return a.default.createElement(h, (0, t._)({}, c, { classes: l.classes, ref: s }));
      });
...
//# debugId=c508e02e-8d2f-05c1-c717-93a5d629ed88
//# sourceMappingURL=1t-9j1m2pug46.js.map
