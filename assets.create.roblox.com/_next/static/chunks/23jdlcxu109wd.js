  ...
  (t) => {
    ...
    let cG = null,
      ...
      cH = () => {
        ...
        return r ? (0, v.jsx)(cW, { flags: cV, contexts: a }) : null;
      };
    var cK = t.i(911502);
    let cJ = (t) => {
    ...
    let c3 = (t) => {
          ...
          i.current.setConfig({
            ...
            api: {
              retCodeHandler(t, n, r) {
                let i = !(
                    (r.status === c1.StatusCodes.FORBIDDEN && r.headers.has("x-csrf-token")) ||
                    r.status === c1.StatusCodes.OK ||
                    r.status === c1.StatusCodes.ACCEPTED
                  ),
                  a = "unknown";
                try {
                  let n = JSON.parse(t);
      ...
      return (0, v.jsx)(c4.default.Provider, { value: a, children: n });
    };
    var c6 = t.i(37819),
      c8 = t.i(431346),
      c5 = t.i(881670);
    ...
    let lv = lc.$constructor("ZodMiniType", (t, n) => {
        ...
        (ld.$ZodType.init(t, n),
          (t.def = n),
          (t.type = n.type),
          (t.parse = (n, r) => lp.parse(t, n, r, { callee: t.parse })),
          (t.safeParse = (n, r) => lp.safeParse(t, n, r)),
          (t.parseAsync = async (n, r) => lp.parseAsync(t, n, r, { callee: t.parseAsync })),
          (t.safeParseAsync = async (n, r) => lp.safeParseAsync(t, n, r)),
          (t.check = function () {
    ...
    function lw(t, n) {
      return new lb({ type: "array", element: t, ...lf.normalizeParams(n) });
    }
    let lx = lc.$constructor("ZodMiniObject", (t, n) => {
      (ld.$ZodObject.init(t, n), lv.init(t, n), lf.defineLazy(t, "shape", () => n.shape));
    });
    function lP(t, n) {
      return new lx({ type: "object", shape: null != t ? t : {}, ...lf.normalizeParams(n) });
    }
    ...
    function lk(t) {
      return new lq({ type: "optional", innerType: t });
    }
    (t, n) => {
    ...
    var lI = t.i(694257),
      ...
      lD = (t) => {
        ...
        return (0, v.jsx)(lN.Provider, { value: n, children: r });
      },
      l_ = () => {
      ...
      lM =
        (((i = lM || {}).AccountReactivationPageRendered = "accountReactivationPageRendered"),
    ...
    function lB() {
      let { sendAnalyticsEvent: t, platform: n, readOnly: r } = l_();
    ...
    var lJ = (0, oc.createContext)(void 0),
      lz = (t) => {
        ...
        return (0, v.jsx)(lJ.Provider, { value: P, children: u });
      },
      lQ = () => {
      ...
      lX = (t) => {
        let { punishmentData: n, commutationEligibility: r } = t,
          { isFirstPage: i, currentPageConfigs: a, currentPageName: o } = lQ(),
          s = a
            .map((t) => {
      ...
      l0 = (t) => {
        ...
        let { punishmentData: r } = t,
          { isFirstPage: i, totalPages: a } = lQ(),
          { readOnly: o } = l_(),
          s = l_().translate,
          { punishmentTypeDescription: u, verificationCategory: c } = r,
          l = c
            ? s("Heading.Suspended")
            : s(null != (n = lG[u]) ? n : "") || s("Heading.Suspended");
        return i
          ? (0, v.jsx)("div", {
      ...
      l1 = (t) => {
        let { punishmentData: n, setIsDialogOpen: r } = t,
          { CurrentCtaComponent: i, currentPageName: a } = lQ();
        return i
          ? (0, v.jsx)("div", {
        ...
        return (
          ...
          (0, v.jsx)("div", {
            ...
            children: (0, v.jsxs)("div", {
              ...
              children: [
                (0, v.jsx)(ln.Icon, { name: "icon-regular-triangle-exclamation", size: "XLarge" }),
                (0, v.jsx)("span", {
    ...
    var l5 = lP({
      ...
      l9 = new lR({
        ...
        options: [
          lP({
            ...
            text: lk(ly()),
            textKey: lk(ly()),
            textKeyParameters: lk(
              ((s = ly()),
              new lS(
                (u = ly()) && u._zod
                  ? { type: "record", keyType: s, valueType: u, ...lf.normalizeParams(void 0) }
                  : { type: "record", keyType: ly(), valueType: s, ...lf.normalizeParams(u) }
              ))
            )
          }).check(
            lC((t) => void 0 !== t.text || void 0 !== t.textKey, {
          ...
          lP({ type: lE("image"), labelKey: ly(), url: ly(), altLabelKey: lk(ly()) })
        ],
      ...
      de = lP({ ...l5.shape, elements: lk(lw(l9)) }),
      dt = (t) => {
        let n = t.violation;
        if (!n) return !1;
        let { evidence: r } = n;
      ...
      dr = (t) => {
        let { enableIxp: n = !1, children: r } = t,
          i = l_().translate,
          {
            ...
            let { httpGet: t, userModerationApiUrl: n } = l_();
          ...
          { data: d, isLoading: f } = (() => {
            let { httpGet: t, apiGatewayUrl: n } = l_();
            return (0, lt.useQuery)({
      ...
      ds = (t) => {
        let { children: n } = t,
          { currentPage: r, currentPageName: i, unmappedViolationKeys: a } = lQ(),
          o = lB(),
      ...
      dy = (t, n) => (r, i, a, o) => {
        var s;
        let [u, c] = t(r, { startLink: dv, endLink: dm, ...a }).split(dv, 2),
          [l, d] = null != (s = null == c ? void 0 : c.split(dm, 2)) ? s : [];
        return (0, v.jsxs)("p", {
          ...
          let { punishmentData: a } = t,
            ...
            l =
              null == u || null == (i = u.evidence) || null == (r = i.displayMeta)
                ? void 0
                : r.capitalizedKey,
            d = dw(null != (n = null == s ? void 0 : s.translatedReasons) ? n : [], l, c, o);
          return (0, v.jsx)("span", { className: "text-body-medium", children: d });
        },
        configName: "punishment-description"
      },
      dP = () => {
        let { websiteUrl: t, platform: n, onAppealsRedirect: r } = l_(),
          { ixpData: i } = di(),
          a = lB();
        return {
    ...
    var dq = (t) => {
      ...
      dA = {
        ...
        renderComponent: (t) => {
          ...
          let { punishmentData: i } = t,
            ...
            d = null != (n = null == l ? void 0 : l.filter((t) => l7(t))) ? n : [],
            f = [],
            h = [];
          d.forEach((t) => {
            var n;
      ...
      dV =
        (((c = dV || {})[(c.Reactivate = 0)] = "Reactivate"),
        (c[(c.Paused = 1)] = "Paused"),
      ...
      dQ = () => {
        let t = l_().translate,
          { sendPageEvent: n } = du(),
          { httpPost: r, apiGatewayUrl: i, onAccountReactivated: a } = l_(),
      ...
      d$ = (t) => {
        let { onOpenChange: n, children: r } = t,
          ...
          d = (0, oc.useMemo)(() => (null != l ? l : []).some((t) => t in dp), [l]),
        ...
        return s
          ? r({
              header: (0, v.jsx)(l2, { readOnly: !!i }),
              body: (0, v.jsx)(l4, {}),
              ctas: (0, v.jsx)(l3, {})
            })
          : u || !a
            ? r({ header: (0, v.jsx)(l6, {}), body: (0, v.jsx)(l8, { error: u }) })
            : (0, v.jsx)(lz, {
                pages: f,
                ...
                children: (0, v.jsx)(ds, {
                  children: r({
                    header: (0, v.jsx)(l0, { punishmentData: a }),
                    body: (0, v.jsx)(lX, { punishmentData: a, commutationEligibility: c }),
                    ctas: (0, v.jsx)(l1, { punishmentData: a, setIsDialogOpen: n })
                  })
                })
              });
      },
      dZ = (t) => {
        let { impressionEvent: n } = t,
          { translate: r, websiteUrl: i, onLogout: a } = l_(),
          o = lB(),
          s = dy(r, o),
          [u, c] = (0, oc.useState)(!1);
        (0, oc.useEffect)(() => {
        ...
        return (0, v.jsx)(le.Dialog, {
          ...
          children: (0, v.jsxs)(le.DialogContent, {
            ...
            children: [
              (0, v.jsxs)(le.DialogBody, {
                className: "gap-large flex flex-col",
                children: [
                  (0, v.jsx)(le.DialogTitle, {
                  ...
                  children: (0, v.jsx)(d$, {
                    ...
                    children: (t) => {
                      ...
                      return (0, v.jsxs)("div", {
                        ...
                        children: [
                          (0, v.jsx)(le.DialogTitle, { className: "padding-none", children: n }),
                          (0, v.jsxs)("div", {
    ...
    let d3 = function () {
        let { translate: t } = (0, ob.useTranslation)(),
          ...
          c = (0, oc.useCallback)(
            (t) => !!t.verificationCategory && lM.VerificationRedirectRendered,
            []
          ),
      ...
      d6 = () => {
        let t = d3();
        return (0, v.jsx)(lD, { config: t, children: (0, v.jsx)(d1, {}) });
      },
      d8 = (0, ob.withTranslation)(() => {
        let { themeMode: t } = (0, cr.useThemeMode)();
        return (0, v.jsx)(cs.UIThemeProvider, { theme: t, children: (0, v.jsx)(d6, {}) });
      }, [
        c5.TranslationNamespace.NotApproved,
        c5.TranslationNamespace.Moderation,
        c5.TranslationNamespace.AppealsPortal,
        c5.TranslationNamespace.CommonUIControls,
        c5.TranslationNamespace.Error,
        c5.TranslationNamespace.DashboardModeration
      ]),
      d5 = () => {
            ...
            async (t) => {
              async function n(t, r) {
                ...
                try {
                  ...
                  (null == i ? void 0 : i.status) === c1.StatusCodes.UNAUTHORIZED
    ...
    let fk = { locale: c0.defaultLocale, nativeName: c0.defaultNativeName },
      ...
      f_ = (t) => {
        ...
        let { Component: r, pageProps: i, cache: a } = t,
          o = (0, ol.useRouter)(),
          { query: s } = o,
          u = (0, cm.parseExperienceUniverseIdFromRouter)(o),
          c = null != (n = r.getPageLayout) ? n : fj,
          l = (0, oc.useMemo)(() => ({ ...fI, ...r.pageMetadata }), [r.pageMetadata]);
        return (
            ...
            children: (0, v.jsx)(ud, {
              ...
              children: (0, v.jsxs)(cJ, {
                providers: [
                  ...
                  (0, v.jsx)(cZ, { pageLoggerConfig: r.loggerConfig }),
                  ...
                  (0, v.jsx)(fO, {}),
                  (0, v.jsx)(cz.ThemeAwareStudioResourcesProvider, {}),
                  (0, v.jsx)(c3, {}),
                  (0, v.jsx)(cK.default, {}),
                  (0, v.jsx)(fc, {}),
                ...
                children: [
                  (0, v.jsx)(fL, {}),
                  (0, v.jsx)(cn, { provider: fA }),
                  (0, v.jsx)(fo, {}),
                  (0, v.jsx)(fr, {}),
                  (0, v.jsx)(d5, {}),
                  (0, v.jsx)(fP, {}),
                  (0, v.jsx)(cH, {}),
                  (0, v.jsx)(c7, { openGraphMetadata: l }),
                  c((0, v.jsx)(r, { ...i }), { query: s })
                ]
              })
            })
          })
