          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "ea3c53eb-04cb-5070-75f5-13a03d30f215");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    function iU() {
      return ec
        ? el
        : ((ec = 1), (el = iM() && !Symbol.sham && "symbol" == typeof Symbol.iterator));
    }
    function iB() {
      if (ef) return ed;
      ef = 1;
          ...
          var t = iI(),
            ...
            i = function (i) {
              return function (a, o, s) {
                ...
                var d = n(s, c);
                if (i && o != o) {
                  for (; c > d;) if ((u = l[d++]) != u) return !0;
                } else for (; c > d; d++) if ((i || d in l) && l[d] === o) return i || d || 0;
                return !i && -1;
              };
            };
      ...
      return (tq = function (u, l) {
        ...
        if ((c = m ? t : y ? t[v] || a(v, {}) : t[v] && t[v].prototype))
          for (d in l) {
            if (
              ((h = l[d]),
              (f = u.dontCallGetSet ? (p = n(c, d)) && p.value : c[d]),
      ...
      return (tI = t
        ...
        : function (t) {
            ...
            return void 0 === t
              ...
              : null === t
                ? "Null"
                : "string" == typeof (l = s((u = a(t)), i))
                  ? l
                  : o
                    ? r(u)
                    : "Object" === (c = r(u)) && n(u.callee)
                      ? "Arguments"
                      : c;
          });
    }
          ...
          return (
            (aw.f =
              t && !n
                ...
                : function (t, n) {
                    i(t);
                    for (var s, u = a(n), l = o(n), c = l.length, d = 0; c > d;)
                      r.f(t, (s = l[d++]), u[s]);
                    return t;
                  }),
            aw
      ...
      return (
        ...
        (tW =
          ...
          function (t, i) {
            var a;
            return (
              null !== t ? ((f[l] = n(t)), (a = new f()), (f[l] = null), (a[d] = t)) : (a = m()),
              void 0 === i ? a : r.f(a, i)
            );
          })
      );
      ...
      var t = av(),
        ...
        o = (function () {
          ...
          return (n8 = function (s, u, l, c) {
            var d = u + " Iterator";
            return ((s.prototype = n(t, { next: r(+!c, l) })), i(s, d, !1, !0), (a[d] = o), s);
          });
        })(),
        s = aM(),
        u = aV(),
              ...
              return [
                ...
                function (n, r) {
                  ...
                  for (var k = []; null !== (N = y(u, f)) && (P(k, N), q);)
                    "" === d(N[0]) && (u.lastIndex = h(f, c(u.lastIndex), L));
        ...
        if (
          ...
          (C ||
            (((S = y(function (t, n) {
              u(t, R);
              var r = v(new P(), t, S);
              return (c(n) || s(n, r[x], { that: r, AS_ENTRIES: b }), r);
            })).prototype = R),
            (R.constructor = S)),
      ...
      return (rU = {
        getConstructor: function (u, l, c, h) {
          var m = u(function (n, r) {
              (a(n, y),
                p(n, { type: l, index: t(null), first: null, last: null, size: 0 }),
                d || (n.size = 0),
                o(r) || s(r, n[h], { that: n, AS_ENTRIES: c }));
            }),
            y = m.prototype,
            g = v(l),
            b = function (t, n, r) {
    ...
    (iv ||
      ...
      (function () {
        if (!rc) {
          ...
          o(
            ...
            "Array",
            function (n, r) {
              d(this, { type: c, target: t(n), index: 0, kind: r });
            },
            function () {
              var t = f(this),
                n = t.target,
          ...
          if ((n("keys"), n("values"), n("entries"), !u && l && "values" !== h.name))
            try {
      ...
      (function () {
        if (!r1) {
          ...
          (g && (l(I, "code", L("code")), l(I, "message", L("message")), l(I, "name", L("name"))),
          ...
          var t = iH(),
            ...
            T = (function () {
              ...
              if (s)
                ...
                try {
                  (!c && (t = o("worker_threads")) && (c = t.MessageChannel),
                    c &&
                      ((n = new c()),
                      (r = new l(2)),
                      (i = function (t) {
            ...
            el = function (t, n) {
              ...
              switch ((M(n, t, s), P)) {
                ...
                case "Set":
                  ...
                  break;
                case "Error":
                  (g(s, "message", el(t.message, n)),
                    m(t, "cause") && g(s, "cause", el(t.cause, n)),
                    "AggregateError" === o
                      ? (s.errors = el(t.errors, n))
                      : "SuppressedError" === o &&
                        ((s.error = el(t.error, n)), (s.suppressed = el(t.suppressed, n))));
                case "DOMException":
          ...
          n(
            { global: !0, enumerable: !0, sham: !q, forced: ee },
            {
              structuredClone: function (t) {
                var n,
                  r,
                  i = w(arguments.length, 1) > 1 && !c(arguments[1]) ? p(arguments[1]) : void 0,
    ...
    function o1(t, n, r, i, a) {
      ...
      if (u) t.emit("error", u);
        ...
        if (n.ended && !a) {
          ...
          n.endEmitted && a
            ? ((l = Error("stream.unshift() after end event")), t.emit("error", l))
          ...
          return (
            ...
            y.ended
              ...
              : (function (n, r, i, a) {
                ...
                (l = f),
                t.isBuffer(l) && (c = "buffer"),
                (v = y.objectMode ? 1 : l.length),
                (y.length += v),
                (m = y.length < y.highWaterMark) || (y.needDrain = !0),
                y.writing ? y.buffer.push(new r(l, c, d)) : o(this, y, v, l, c, d),
                (g = m)),
            g
          );
        }),
      ...
      (o0.prototype.pipe = function (t, n) {
        ...
        return (
          ...
          t._events && t._events.error
            ? o_(t._events.error)
              ? t._events.error.unshift(c)
              : (t._events.error = [c, t._events.error])
            : t.on("error", c),
          t.once("close", d),
          t.once("finish", f),
          t.emit("pipe", r),
    ...
    ((sd.prototype._transform = function (t, n, r) {
      ...
      for (
        ...
        if ((this._last.push(o), this._last.length > 9 && this._last.shift(), this.raw)) {
          ...
          s &&
            (this.push(["text", s[0]]),
            this.raw === sc.endComment || this.raw === sc.endCdata
          ...
          if ("text" !== this.state || 60 !== o || sp(t[i + 1]))
            if (1 === this.tagState && sp(o)) this.tagState = 2;
              ...
              "open" === this.state && sf(this._last, sc.comment)
                ? (this.buffers.push(t.slice(a, i + 1)),
                  (a = i + 1),
                  (this.state = "text"),
                  (this.raw = sc.endComment),
                  this._pushState("open"))
                : "open" === this.state &&
                  sf(this._last, sc.cdata) &&
                  (this.buffers.push(t.slice(a, i + 1)),
                  (a = i + 1),
                  (this.state = "text"),
                  (this.raw = sc.endCdata),
                  this._pushState("open"));
            else if (
              (this.buffers.push(t.slice(a, i + 1)),
              (a = i + 1),
              ...
              var u = this._getTag();
              ("script" === u && (this.raw = sc.endScript),
                "style" === u && (this.raw = sc.endStyle),
                "title" === u && (this.raw = sc.endTitle),
                this._pushState("open"));
            }
          else
    ...
    function sQ() {
      ...
      function h(a, o) {
        ...
        ((this.highWaterMark = u || 0 === u ? u : s && (l || 0 === l) ? l : c),
        ...
        if (t._writev && i && i.next) {
          ...
          for (; i;) {
            var l = i.chunk,
              ...
              d = i.callback;
            if (
              (v(t, r, !1, r.objectMode ? 1 : l.length, l, c, d),
              (i = i.next),
    ...
    function s8() {
      ...
      function E(t, n) {
        for (
          ...
          !n.ended &&
          n.length < n.highWaterMark &&
          (c("maybeReadMore read 0"), t.read(0), r !== n.length);
        )
          r = n.length;
        n.readingMore = !1;
      }
      ...
      function k(t, n) {
        (n.reading || (c("resume read 0"), t.read(0)),
          (n.resumeScheduled = !1),
          (n.awaitDrain = 0),
          t.emit("resume"),
          A(t),
      ...
      return (
        ...
        (b.prototype.read = function (t) {
          ...
          if (
            ...
            return (
              c("read: emitReadable", n.length, n.ended),
        ...
        (b.prototype.pipe = function (n, a) {
            ...
            (c("ondata"),
              ...
              !1 !== n.write(t) ||
                ...
                (((1 === s.pipesCount && s.pipes === n) ||
                  ...
                  !f &&
                  (c("false write response, pause", o._readableState.awaitDrain),
          ...
          return (
            ...
            n.once("finish", g),
            n.emit("pipe", o),
            s.flowing || (c("pipe resume"), o.resume()),
            n
          );
        }),
    ...
    var ue,
      ...
      ud = function (t) {
        ...
        return ol.default.createElement(
          oA.CacheProvider,
          { value: i },
          ol.default.createElement(oC.T, { value: a }, r)
        );
      },
      uf = t.i(766324),
      uh = t.i(592171),
    ...
    let lt = [
        le.default.Home,
        le.default.RoadMap,
        le.default.AvatarAnalytics,
        le.default.ShareLinkAnalytics,
        le.default.StoreAnalytics,
        le.default.Community,
        le.default.Notifications,
        le.default.Settings,
        le.default.SendrNotificationPreferences,
        le.default.Preferences,
        le.default.Advanced,
        le.default.DataCollectionSettings,
        le.default.MarketplaceOnboarding,
        le.default.FiatPaidAccess,
        le.default.PublicPublish,
        le.default.DevEx,
        le.default.GameTranslation,
        le.default.GameStringTranslation
      ],
      ln = (t) => {
        let { provider: n } = t,
    ...
    let lu = (t) => {
      ...
      return (
        ...
        (0, v.jsx)(ls.UIThemeProvider, { theme: i, children: r })
      );
    };
    var ll = t.i(709337),
      lc = t.i(512229),
    ...
    let lV = [
      ...
      {
        flag: lM.mockManagedPricingSummary,
        metadata: {
      ...
      {
        flag: lM.mockManagedPricingEvents,
        metadata: {
          namespace: "monetization",
      ...
      {
        flag: lM.mockManagedPricingProductWrites,
        metadata: {
          namespace: "monetization",
      ...
      {
        flag: lM.isProductArchiveEnabled,
        metadata: {
          namespace: "monetization",
      ...
      {
        flag: lM.mockShopItemsExternalEligibility,
        metadata: {
          namespace: "monetization",
      ...
      {
        flag: lU.enablePayoutWatermarkContributions,
        metadata: {
          namespace: "payouts",
    ...
    let lG = null,
      ...
      lH = () => {
        ...
        return r ? (0, v.jsx)(lW, { flags: lV, contexts: a }) : null;
      };
    var lK = t.i(911502);
    let lJ = (t) => {
    ...
    let lZ = (t) => {
      let { children: n, unifiedLogger: r, pageLoggerConfig: i } = t,
        a = null != r ? r : ld.default,
        { pathname: o } = (0, oc.useRouter)(),
        s = (0, ol.useMemo)(() => {
          if (o) return "".concat(window.location.origin).concat(o);
        }, [o]);
      return (0, v.jsx)(l$.UnifiedLoggerProvider, {
        unifiedLogger: a,
        pageLoggerConfig: i,
        path: s,
        children: n
    ...
    var lY = t.i(681559),
      l0 = t.i(272749),
      l1 = t.i(252842);
    let l2 = ["https://vitals.vercel-insights.com/v1/vitals"];
    var l4 = t.i(120654);
    let l3 = (t) => {
      let { children: n } = t,
        { user: r } = (0, li.useAuthentication)(),
        i = (0, ol.useRef)(window.aegis);
      (0, ol.useEffect)(() => {
        i.current &&
          i.current.setConfig({
            beforeReport: (t) => !(t.msg && l2.some((n) => t.msg.includes(n))),
            api: {
              retCodeHandler(t, n, r) {
                let i = !(
                    (r.status === l1.StatusCodes.FORBIDDEN && r.headers.has("x-csrf-token")) ||
                    r.status === l1.StatusCodes.OK ||
                    r.status === l1.StatusCodes.ACCEPTED
                  ),
                  a = "unknown";
                try {
                  let n = JSON.parse(t);
      ...
      return (0, v.jsx)(l4.default.Provider, { value: a, children: n });
    };
    var l6 = t.i(37819),
      l8 = t.i(431346),
      l5 = t.i(881670);
    let l9 = "".concat(
        "".concat(
          "https://assets.create.roblox.com/031c9925fe817178884dd69fc13d996f2dcd4b98/assets",
          "/opengraph"
        ),
        "/global_og_image.png"
      ),
      l7 = (0, ob.withTranslation)(
        (t) => {
          let {
              openGraphMetadata: { title: n, description: r, defaultLocale: i }
            } = t,
            { translate: a } = (0, ob.useTranslation)(),
            o = new URL(l9, "https://create.roblox.com").href,
            s = (0, l8.useTheme)();
          return (0, v.jsxs)(l6.HubMeta, {
        ...
        [l5.TranslationNamespace.Features]
      );
    var ce = t.i(459891),
      ct = t.i(157310),
      cn = t.i(688702),
    ...
    let cv = cl.$constructor("ZodMiniType", (t, n) => {
        ...
        (cd.$ZodType.init(t, n),
          (t.def = n),
          (t.type = n.type),
          (t.parse = (n, r) => cp.parse(t, n, r, { callee: t.parse })),
          (t.safeParse = (n, r) => cp.safeParse(t, n, r)),
          (t.parseAsync = async (n, r) => cp.parseAsync(t, n, r, { callee: t.parseAsync })),
          (t.safeParseAsync = async (n, r) => cp.safeParseAsync(t, n, r)),
          (t.check = function () {
          ...
          (t.with = t.check),
          (t.clone = (n, r) => cf.clone(t, n, r)),
          (t.brand = () => t),
          (t.register = (n, r) => (n.add(t, r), t)),
          (t.apply = (n) => n(t)));
      }),
      cm = cl.$constructor("ZodMiniString", (t, n) => {
        (cd.$ZodString.init(t, n), cv.init(t, n));
      });
    function cy(t) {
      return ch._string(cm, t);
    }
    ((t, n) => {
      (cd.$ZodStringFormat.init(t, n), cm.init(t, n));
    },
      (t, n) => {
        (cd.$ZodBigInt.init(t, n), cv.init(t, n));
      });
    let cg = cl.$constructor("ZodMiniUnknown", (t, n) => {
        (cd.$ZodUnknown.init(t, n), cv.init(t, n));
      }),
      cb = cl.$constructor("ZodMiniArray", (t, n) => {
        (cd.$ZodArray.init(t, n), cv.init(t, n));
      });
    function cw(t, n) {
      return new cb({ type: "array", element: t, ...cf.normalizeParams(n) });
    }
    let cx = cl.$constructor("ZodMiniObject", (t, n) => {
      (cd.$ZodObject.init(t, n), cv.init(t, n), cf.defineLazy(t, "shape", () => n.shape));
    });
    function cP(t, n) {
      return new cx({ type: "object", shape: null != t ? t : {}, ...cf.normalizeParams(n) });
    }
    let cR = cl.$constructor("ZodMiniUnion", (t, n) => {
        (cd.$ZodUnion.init(t, n), cv.init(t, n));
      }),
      cS = cl.$constructor("ZodMiniRecord", (t, n) => {
        (cd.$ZodRecord.init(t, n), cv.init(t, n));
      }),
      cT = cl.$constructor("ZodMiniLiteral", (t, n) => {
        (cd.$ZodLiteral.init(t, n), cv.init(t, n));
      });
    function cE(t, n) {
      return new cT({
        type: "literal",
        values: Array.isArray(t) ? t : [t],
        ...cf.normalizeParams(n)
      });
    }
    let cq = cl.$constructor("ZodMiniOptional", (t, n) => {
      (cd.$ZodOptional.init(t, n), cv.init(t, n));
    });
    function ck(t) {
      return new cq({ type: "optional", innerType: t });
    }
    (t, n) => {
      (cd.$ZodPipe.init(t, n), cv.init(t, n));
    };
    let cA = cl.$constructor("ZodMiniCustom", (t, n) => {
      (cd.$ZodCustom.init(t, n), cv.init(t, n));
    });
    function cC(t) {
    ...
    var cI = t.i(694257),
      ...
      cL = t.i(942625),
      cO = t.i(71597),
      cN = (0, ol.createContext)(void 0),
      cD = (t) => {
        let { config: n, children: r } = t;
        return (0, v.jsx)(cN.Provider, { value: n, children: r });
      },
      c_ = () => {
        let t = (0, ol.useContext)(cN);
        if (!t) throw Error("useNotApprovedUIConfig must be used within a NotApprovedUIProvider");
        return t;
      },
      cM =
        (((i = cM || {}).AccountReactivationPageRendered = "accountReactivationPageRendered"),
        ...
        i),
      cU = (((a = cU || {}).NotApprovedPage = "NotApprovedPageV2"), a);
    function cB() {
      let { sendAnalyticsEvent: t, platform: n, readOnly: r } = c_();
      return (0, ol.useCallback)(
        (i, a) => {
          (null != r && r) ||
            t({
    ...
    var cV = "UserSafety.NotApprovedPage.UserID",
      cF =
        (((o = cF || {}).Warn = "Warn"),
        (o.Delete = "Delete"),
        (o.Hour1 = "Ban 1 Hour"),
    ...
    var cJ = (0, ol.createContext)(void 0),
      cz = (t) => {
        ...
        let {
          ...
          [l, c] = (0, ol.useState)(0),
          [d, f] = (0, ol.useState)(!1),
          h = null != (n = null == (r = i[l]) ? void 0 : r.pageName) ? n : "unknown",
          p = i.length,
          m = 0 === l,
          y = l === p - 1,
          g = (0, ol.useMemo)(() => {
        ...
        return (0, v.jsx)(cJ.Provider, { value: P, children: u });
      },
      cQ = () => {
      ...
      cX = (t) => {
        let { punishmentData: n, commutationEligibility: r } = t,
          { isFirstPage: i, currentPageConfigs: a, currentPageName: o } = cQ(),
          s = a
            .map((t) => {
      ...
      c$ = () => {
        ...
        return (0, v.jsxs)(ci.Popover, {
          children: [
            (0, v.jsx)(ci.PopoverTrigger, {
              asChild: !0,
              children: (0, v.jsx)(cs.IconButton, {
            ...
            (0, v.jsx)(ci.PopoverContent, {
              side: "bottom",
              align: "end",
              ariaLabel: t("Label.MenuContent"),
              children: (0, v.jsx)(ca.Menu, {
                size: "Medium",
                children: (0, v.jsx)(ca.MenuItem, {
                  value: "one",
      ...
      cY = () => {
        let t = c_().translate,
          { goToPreviousPage: n } = cQ();
        return (0, v.jsx)(cs.IconButton, {
          size: "Medium",
          variant: "Utility",
      ...
      c0 = (t) => {
        ...
        let { punishmentData: r } = t,
          { isFirstPage: i, totalPages: a } = cQ(),
          { readOnly: o } = c_(),
          s = c_().translate,
          { punishmentTypeDescription: u, verificationCategory: l } = r,
          c = l
            ? s("Heading.Suspended")
            : s(null != (n = cG[u]) ? n : "") || s("Heading.Suspended");
        return i
          ? (0, v.jsx)("div", {
                  ...
                  (0, v.jsxs)("div", {
                    ...
                    children: [
                      (0, v.jsx)(cn.Icon, {
                        ...
                        size: "Large",
                        className:
                          "Warn" !== u || l ? "content-system-alert" : "content-system-warning"
                      }),
                      (0, v.jsx)("span", { className: "text-heading-small", children: c })
                    ]
                  }),
                  !o && (0, v.jsx)(c$, {})
                ]
          ...
          : (0, v.jsx)("div", {
              ...
              children: (0, v.jsxs)("div", {
                ...
                children: [(0, v.jsx)(cY, {}), a > 2 && (0, v.jsx)(cZ, {})]
              })
            });
      },
      c1 = (t) => {
        let { punishmentData: n, setIsDialogOpen: r } = t,
          { CurrentCtaComponent: i, currentPageName: a } = cQ();
        return i
          ? (0, v.jsx)("div", {
        ...
        return (
          ...
          (0, v.jsx)("div", {
            ...
            children: (0, v.jsxs)("div", {
              ...
              children: [
                (0, v.jsx)(cn.Icon, { name: "icon-regular-triangle-exclamation", size: "XLarge" }),
                (0, v.jsx)("span", {
    ...
    var c5 = cP({
      ...
      c9 = new cR({
        ...
        options: [
          cP({
            ...
            text: ck(cy()),
            textKey: ck(cy()),
            textKeyParameters: ck(
              ((s = cy()),
              new cS(
                (u = cy()) && u._zod
                  ? { type: "record", keyType: s, valueType: u, ...cf.normalizeParams(void 0) }
                  : { type: "record", keyType: cy(), valueType: s, ...cf.normalizeParams(u) }
              ))
            )
          }).check(
            cC((t) => void 0 !== t.text || void 0 !== t.textKey, {
          ...
          cP({ type: cE("image"), labelKey: cy(), url: cy(), altLabelKey: ck(cy()) })
        ],
        ...cf.normalizeParams(void 0)
      }),
      c7 = (t) => {
        let n = c9.safeParse(t);
        return !!n.success || (console.warn("Failed to parse platform element: ", n.error), !1);
      },
      de = cP({ ...c5.shape, elements: ck(cw(c9)) }),
      dt = (t) => {
        let n = t.violation;
        if (!n) return !1;
        let { evidence: r } = n;
        if (
          ...
          return !1;
        let i = null == (a = r.elements) ? void 0 : a.filter((t) => c7(t));
      ...
      dr = (t) => {
        let { enableIxp: n = !1, children: r } = t,
          i = c_().translate,
          {
            ...
            let { httpGet: t, userModerationApiUrl: n } = c_();
          ...
          })(),
          {
            ...
            let { enabled: n } = t,
              { ixp: r } = c_();
            return (0, ct.useQuery)({
              queryKey: ["ixp/".concat(cV)],
              queryFn: async () => {
                if (!r) return {};
                try {
                  return await r.fetchLayer(cV);
                } catch (t) {
                  return {};
                }
              },
          ...
          { data: d, isLoading: f } = (() => {
            let { httpGet: t, apiGatewayUrl: n } = c_();
            return (0, ct.useQuery)({
          ...
          p = (0, ol.useMemo)(() => {
            let t = new Set(),
              n = new Set();
            if ((null == h ? void 0 : h.violation) && dt(h))
        ...
        return (0, v.jsx)(dn.Provider, { value: y, children: r });
      },
      di = () => {
        let t = (0, ol.useContext)(dn);
        if (!t)
          throw Error(
      ...
      ds = (t) => {
        let { children: n } = t,
          { currentPage: r, currentPageName: i, unmappedViolationKeys: a } = cQ(),
          o = cB(),
          s = (0, ol.useRef)(Date.now()),
          u = (0, ol.useRef)(r),
          l = (0, ol.useRef)(i),
          c = (0, ol.useRef)(!0),
        ...
        let f = (0, ol.useCallback)(
          ...
          h = (0, ol.useMemo)(() => ({ sendPageEvent: f }), [f]);
        return (0, v.jsx)(da.Provider, { value: h, children: n });
      },
      du = () => {
      ...
      dp = {
        ...
        "Label.AbuseType.SexualContent": dl,
        ...
        "Label.Sublabel.RomanceOrSex": dl
      },
      dv = "{startLink}",
      dm = "{endLink}",
      dy = (t, n) => (r, i, a, o) => {
        var s;
        let [u, l] = t(r, { startLink: dv, endLink: dm, ...a }).split(dv, 2),
          [c, d] = null != (s = null == l ? void 0 : l.split(dm, 2)) ? s : [];
        return (0, v.jsxs)("p", {
      ...
      dg = {
        getIsVisible: (t) => [cH, "VPC"].includes(t.verificationCategory),
        renderComponent: (t) => {
      ...
      dx = {
        ...
        renderComponent: (t) => {
          ...
          let { punishmentData: a } = t,
            o = c_().translate,
            { violationReasons: s } = di(),
            { violation: u, punishmentTypeDescription: l } = a,
            c =
              null == u || null == (i = u.evidence) || null == (r = i.displayMeta)
                ? void 0
                : r.capitalizedKey,
            d = dw(null != (n = null == s ? void 0 : s.translatedReasons) ? n : [], c, l, o);
          return (0, v.jsx)("span", { className: "text-body-medium", children: d });
        },
        configName: "punishment-description"
      },
      dP = () => {
        let { websiteUrl: t, platform: n, onAppealsRedirect: r } = c_(),
          { ixpData: i } = di(),
          a = cB();
        return {
        ...
        return (0, v.jsxs)("div", {
          ...
          children: [
            ...
            (0, v.jsx)("div", {
              ...
              children: (0, v.jsx)(co.ProgressCircle, {
    ...
    var dq = (t) => {
      ...
      dA = {
        ...
        renderComponent: (t) => {
          ...
          let { punishmentData: i } = t,
            ...
            u = dE(),
            l = cB(),
            c = null == a || null == (r = a.evidence) ? void 0 : r.elements,
            d = null != (n = null == c ? void 0 : c.filter((t) => c7(t))) ? n : [],
            f = [],
            h = [];
          d.forEach((t) => {
            var n;
            "image" === t.type
              ? f.push((0, v.jsx)(dS, { url: t.url, altLabelKey: t.labelKey }, t.url))
              : h.push(
                  (0, v.jsx)(
                    dq,
                    {
                      ...
                      fieldValue: t.textKey
                        ? ((t, n, r, i) => {
                          ...
                          })(s, t.textKey, t.textKeyParameters, l)
                        : null != (n = t.text)
                          ? n
                          : ""
                    },
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              ...
              (0, v.jsxs)("div", {
                ...
                children: [
                  h,
                  (0, v.jsx)(dq, { fieldLabel: s("Label.ReviewDate"), fieldValue: u(i.beginDate) }),
                  o && (0, v.jsx)(dq, { fieldLabel: s("Label.DecisionMethod"), fieldValue: o }),
                  (0, v.jsx)(dk, {})
                ]
              })
            ]
      ...
      dI = {
        getIsVisible: (t) => {
          var n, r;
          return (
            !dt(t) && (null != (n = null == (r = t.badUtterances) ? void 0 : r.length) ? n : 0) > 0
          );
        },
        renderComponent: (t) => {
          let { punishmentData: n } = t,
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              (0, v.jsx)(dC, { badUtterances: null != a ? a : [] }),
              (0, v.jsx)(cL.Divider, {}),
              (0, v.jsx)(dq, { fieldLabel: r("Label.ReviewDate"), fieldValue: i(n.beginDate) }),
              o && (0, v.jsx)(dq, { fieldLabel: r("Label.DecisionMethod"), fieldValue: o }),
              (0, v.jsx)(dk, {})
            ]
          });
        },
      ...
      dj = {
        ...
        renderComponent: (t) => {
          ...
          return (0, v.jsxs)("div", {
            ...
            children: [
              (0, v.jsx)(dq, { fieldLabel: n("Label.ReviewDate"), fieldValue: r(a) }),
              o && (0, v.jsx)(dq, { fieldLabel: n("Label.DecisionMethod"), fieldValue: o }),
              (0, v.jsx)(dk, {})
            ]
          });
        },
      ...
      dV =
        (((l = dV || {})[(l.Reactivate = 0)] = "Reactivate"),
        (l[(l.Paused = 1)] = "Paused"),
        (l[(l.VerifyEmail = 2)] = "VerifyEmail"),
        (l[(l.VerifyVPC = 3)] = "VerifyVPC"),
        l),
      dF = (t) => {
        let { onClose: n } = t,
          r = c_().translate;
      ...
      dQ = () => {
        let t = c_().translate,
          { sendPageEvent: n } = du(),
          { httpPost: r, apiGatewayUrl: i, onAccountReactivated: a } = c_(),
          { handleAppealsClick: o } = dP(),
          [s, u] = (0, ol.useState)(!1),
          l = (0, cr.useMutation)({
            mutationFn: () => dz(i, r),
            onMutate: () => {
      ...
      d$ = (t) => {
        let { onOpenChange: n, children: r } = t,
          ...
          c = null == o ? void 0 : o.untranslatedReasons,
          d = (0, ol.useMemo)(() => (null != c ? c : []).some((t) => t in dp), [c]),
          { pages: f, unmappedViolationKeys: h } = (0, ol.useMemo)(
            () =>
              a
                ? ((t, n, r, i) => {
                    var a;
                    ...
                    if (
                      (l.push({
                        pageName: "intro",
                        pageItems: [dx, dD, dL],
                        CtaComponent: c ? dJ : dU
                      }),
                      c)
                    )
                      return { pages: l, unmappedViolationKeys: [] };
                    d &&
                      !i &&
                      l.push({
                    ...
                    return (
                      ...
                      { pages: l, unmappedViolationKeys: h }
                    );
                  })(a, null != c ? c : [], l, i)
        ...
        return s
          ? r({
              header: (0, v.jsx)(c2, { readOnly: !!i }),
              body: (0, v.jsx)(c4, {}),
              ctas: (0, v.jsx)(c3, {})
            })
          : u || !a
            ? r({ header: (0, v.jsx)(c6, {}), body: (0, v.jsx)(c8, { error: u }) })
            : (0, v.jsx)(cz, {
                pages: f,
                ...
                children: (0, v.jsx)(ds, {
                  children: r({
                    header: (0, v.jsx)(c0, { punishmentData: a }),
                    body: (0, v.jsx)(cX, { punishmentData: a, commutationEligibility: l }),
                    ctas: (0, v.jsx)(c1, { punishmentData: a, setIsDialogOpen: n })
                  })
                })
              });
      },
      dZ = (t) => {
        let { impressionEvent: n } = t,
          { translate: r, websiteUrl: i, onLogout: a } = c_(),
          o = cB(),
          s = dy(r, o),
          [u, l] = (0, ol.useState)(!1);
        (0, ol.useEffect)(() => {
        ...
        return (0, v.jsx)(ce.Dialog, {
          open: !0,
          isModal: !0,
          size: "Medium",
          hasCloseAffordance: !1,
          children: (0, v.jsxs)(ce.DialogContent, {
            className: "[&_p]:margin-none [&_h2]:margin-none",
            children: [
              (0, v.jsxs)(ce.DialogBody, {
                className: "gap-large flex flex-col",
                children: [
                  (0, v.jsx)(ce.DialogTitle, {
      ...
      dY = (t) => {
        ...
        let { open: r, onClose: i } = t,
          ...
          p = cB(),
          { punishmentData: m, isLoading: y, error: g, ixpData: b } = di(),
        ...
        if (x && (null == (n = m.context) ? void 0 : n.SelfServiceDeactivated))
          return c
            ? (0, v.jsx)(ol.Fragment, { children: c() })
            : (0, v.jsx)(dZ, { impressionEvent: "accountReactivationRedirectRendered" });
        let R = x && (null == d ? void 0 : d(m));
        return R
          ? (0, v.jsx)(dZ, { impressionEvent: R })
          : (0, v.jsx)(ce.Dialog, {
              open: null != r ? r : a,
              size: "Large",
              ...
              onOpenChange: h
                ...
                : void 0,
              children: (0, v.jsx)(ce.DialogContent, {
                className: "width-full [&_p]:margin-none [&_h2]:margin-none",
                onOpenAutoFocus: (t) => {
                  t.preventDefault();
                },
                children: (0, v.jsx)(ce.DialogBody, {
                  ...
                  children: (0, v.jsx)(d$, {
                    ...
                    children: (t) => {
                      ...
                      return (0, v.jsxs)("div", {
                        ...
                        children: [
                          (0, v.jsx)(ce.DialogTitle, { className: "padding-none", children: n }),
                          (0, v.jsxs)("div", {
      ...
      d1 = function (t) {
        ...
        return (0, v.jsx)(op.QueryClientProvider, {
          ...
          children: (0, v.jsx)(dr, {
            enableIxp: !0,
            children: (0, v.jsx)(dY, { open: n, onClose: r })
          })
        });
      },
      d2 = t.i(894244),
    ...
    let d3 = function () {
        let { translate: t } = (0, ob.useTranslation)(),
          ...
          l = (0, ol.useCallback)(
            (t) => !!t.verificationCategory && cM.VerificationRedirectRendered,
            []
          ),
          c = (0, ol.useCallback)(async () => {
      ...
      d6 = () => {
        let t = d3();
        return (0, v.jsx)(cD, { config: t, children: (0, v.jsx)(d1, {}) });
      },
      d8 = (0, ob.withTranslation)(() => {
        let { themeMode: t } = (0, lr.useThemeMode)();
        return (0, v.jsx)(ls.UIThemeProvider, { theme: t, children: (0, v.jsx)(d6, {}) });
      }, [
        l5.TranslationNamespace.NotApproved,
        l5.TranslationNamespace.Moderation,
        l5.TranslationNamespace.AppealsPortal,
        l5.TranslationNamespace.CommonUIControls,
        l5.TranslationNamespace.Error,
        l5.TranslationNamespace.DashboardModeration
      ]),
      d5 = () => {
        let { status: t } = (0, li.useAuthentication)();
        return "moderated" === t ? (0, v.jsx)(d8, {}) : null;
      };
    var d9 = t.i(955490);
    let d7 = (0, ly.default)(() => t.A(14667), {
        loadableGenerated: { modules: [573249] },
        ssr: !1
      }),
      fe = (t) => {
        let { children: n } = t;
        return (0, v.jsx)(d9.UniversalFeatureRestrictionsProvider, { Surface: d7, children: n });
      };
    var ft = t.i(336964);
    function fn(t) {
    ...
    function fr(t) {
      ...
      if (
        ...
        return null;
      if ((null == o ? void 0 : o.mode) === "standalone" && fn(a))
        return (0, ol.createElement)(a.Component, {
          ...a.props,
          open: s,
          onOpenChange: (t) => {
            t || i.close();
      ...
      let u = null != o ? o : ft.DEFAULT_RESOLVED_CONTENT_OPTIONS,
        l = fn(a) ? (0, ol.createElement)(a.Component, a.props) : a;
      return (0, v.jsx)(ce.Dialog, {
        open: s,
        onOpenChange: (t) => {
          t || i.close();
    ...
    var fi = t.i(538365),
      fa = t.i(209534);
    function fo() {
      let { current: t } = (0, ol.useSyncExternalStore)(
        fa.snackbarStore.subscribe,
        fa.snackbarStore.getSnapshot,
        fa.snackbarStore.getSnapshot
      );
      return null === t
        ? null
        : (0, v.jsx)(fi.Snackbar, { ...t.props, onClose: () => fa.snackbarStore.dismiss() }, t.id);
    }
    var fs = t.i(943758);
    let fu = (0, ol.createContext)({
    ...
    let fl = (t) => {
      ...
      return (0, v.jsx)(fu.Provider, { value: a, children: n });
    };
    var fc = t.i(729904),
      fd = t.i(486736),
      ff = t.i(47033),
    ...
    let fw = {
      ...
      fP = (0, ob.withTranslation)(() => {
        let t = (0, oc.useRouter)(),
          ...
          { user: r, logout: i } = (0, li.useAuthentication)(),
          a = (0, ol.useRef)(!1),
          { captureError: o, error: s, info: u } = (0, fb.useMetricsMonitoring)(),
          [l, c] = (0, ol.useState)(!1),
          [d, f] = (0, ol.useState)(!1),
          [h, p] = (0, ol.useState)([]),
          m = (0, ol.useCallback)(
        ...
        return (
          (0, ol.useEffect)(() => {
            (null == r ? void 0 : r.id) === void 0 ||
              a.current ||
              !t.isReady ||
              fx.some((n) => t.pathname.startsWith(n)) ||
              (b(), (a.current = !0));
      ...
      }, [l5.TranslationNamespace.AgreementsUpdate]),
      { authenticationApi: fR } = { authenticationApi: u5 },
      { discoveryApi: fS } = uT.ApplicationAuthorizationsClient,
      { usersApi: fT } = u9.UsersClient,
      fE =
        ((r = ld.default),
        (t) => {
              ...
              ...(uR ||
                (uR = {
                  ...
                  pageLoad:
                    ...
                    (h =
                      null == (d = performance) ||
                      null == (c = d.getEntriesByType) ||
                      null == (l = c.call(d, "navigation")[0])
                        ? void 0
                        : l.transferSize)
                      ? "unknown"
                      : 0 === h
      ...
      fq =
        (ul &&
          ((f =
            null !=
            (c = document.querySelector('meta[name="'.concat("emotion-insertion-point-mui", '"]')))
              ? c
              : void 0),
          (h =
            null !=
    ...
    let fk = { locale: l0.defaultLocale, nativeName: l0.defaultNativeName },
      fA = new lY.TranslationResourceProvider(fk, l0.fallbackLocale),
      fC = (t) => {
        ...
        return (
          !(function (t) {
            let n = (0, lp.useCustomDashboardService)(),
              ...
              { ready: i, value: a } = (0, lf.useFlag)(lh.isCustomDashboardsEnabled, {
                universeId: t
              });
            (0, ol.useEffect)(() => {
              if (i && a)
      ...
      fI = {
        defaultLocale: l0.defaultLocale,
        title: l0.defaultMetadataJson["OpenGraph.Title"],
        description: l0.defaultMetadataJson["OpenGraph.Description"]
      },
      fj = (t) => t,
      fL = () => (
        (() => {
          let { trackerClient: t } = (0, ll.useEventTrackerProvider)(),
            n = (0, ol.useCallback)(() => {
              let n = (0, lQ.loadPageEventModel)();
              t.sendEvent(n);
            }, [t]);
          ((0, lX.default)(void 0, n),
            (0, ol.useEffect)(() => n(), [n]),
            (0, ol.useEffect)(() => {
              ld.default.trackPageLoad();
            }, []));
        })(),
        (0, od.useReportWebVitals)(fE),
        null
      ),
      fO = (t) => {
        let { children: n } = t,
          { settings: r, isFetched: i } = (0, fd.useSettings)();
      ...
      f_ = (t) => {
        ...
        let { Component: r, pageProps: i, cache: a } = t,
          o = (0, oc.useRouter)(),
          { query: s } = o,
          u = (0, lm.parseExperienceUniverseIdFromRouter)(o),
          l = null != (n = r.getPageLayout) ? n : fj,
          c = (0, ol.useMemo)(() => ({ ...fI, ...r.pageMetadata }), [r.pageMetadata]);
        return (
          (0, oy.useMaintenanceObserver)("https://create.roblox.com"),
          (0, ol.useEffect)(() => {
            uc();
          }, []),
          lc.default.setUnifiedLoggerClient(ld.default),
          (0, v.jsx)(of.ErrorBoundary, {
            children: (0, v.jsx)(ud, {
              cache: null != a ? a : fq,
              children: (0, v.jsxs)(lJ, {
                providers: [
                  (0, v.jsx)(fs.BreadcrumbItemNameProvider, {}),
                  (0, v.jsx)(op.QueryClientProvider, { client: fN }),
                  (0, v.jsx)(lp.CustomDashboardServiceProvider, {}),
                  (0, v.jsx)(lp.UniverseFlaggedCustomDashboardProvider, {}),
                  (0, v.jsx)(fC, { universeId: u }),
                  (0, v.jsx)(lZ, { pageLoggerConfig: r.loggerConfig }),
                  (0, v.jsx)(ll.EventTrackerProvider, { trackerClient: lc.default }),
                  ...
                  (0, v.jsx)(lF.GroupsProvider, {}),
                  (0, v.jsx)(la, {}),
                  (0, v.jsx)(lu, {
                    themeElement: "u" > typeof document ? document.documentElement : void 0
                  }),
                  (0, v.jsx)(ob.LocalizationProvider, { provider: fA }),
                  (0, v.jsx)(uf.SnackbarProvider, {}),
                  (0, v.jsx)(uh.DialogProvider, {}),
                  (0, v.jsx)(lo.default, {}),
                  (0, v.jsx)(ow.ThumbnailsProvider, { baseUrl: lc.eventStreamBaseUrl }),
                  (0, v.jsx)(fd.SettingsProvider, {}),
                  (0, v.jsx)(fO, {}),
                  (0, v.jsx)(lz.ThemeAwareStudioResourcesProvider, {}),
                  (0, v.jsx)(l3, {}),
                  (0, v.jsx)(lK.default, {}),
                  (0, v.jsx)(fl, {}),
                ...
                children: [
                  (0, v.jsx)(fL, {}),
                  (0, v.jsx)(ln, { provider: fA }),
                  (0, v.jsx)(fo, {}),
                  (0, v.jsx)(fr, {}),
                  (0, v.jsx)(d5, {}),
                  (0, v.jsx)(fP, {}),
                  (0, v.jsx)(lH, {}),
                  (0, v.jsx)(l7, { openGraphMetadata: c }),
                  l((0, v.jsx)(r, { ...i }), { query: s })
                ]
              })
            })
          })
...
//# debugId=ea3c53eb-04cb-5070-75f5-13a03d30f215
//# sourceMappingURL=0j93j5yas7e15.js.map
