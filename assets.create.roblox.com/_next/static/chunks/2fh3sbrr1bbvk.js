          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "001e82d5-9cf5-7bd3-684d-14a8563ca34d");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var t = e.i(721281);
    let r = {
      generic: { name: "AceDagExecutionError", messagePrefix: "ACE DAG execution failed" },
      "computed-metric": {
        name: "ComputedMetricDagExecutionError",
        messagePrefix: "Computed metric execution failed"
      },
      "variant-fanout": {
        name: "VariantFanoutDagExecutionError",
        messagePrefix: "Metric variant fanout execution failed"
      },
      rank: { name: "RankDagExecutionError", messagePrefix: "Rank/TopN DAG execution failed" }
    };
    class n extends Error {
      constructor(e, n = "generic") {
        (super("".concat(r[n].messagePrefix, ": ").concat(e.message)),
          ...
          (this.rawContext = e.rawContext));
      }
    }
    e.s(["default", 0, n, "isAceDagExecutionError", 0, (e) => e instanceof n]);
  },
  480398,
  (e) => {
    "use strict";
      ...
      [
        ...
        function (e) {
          ...
          let V = (0, d.default)(E),
            ...
            _ = (0, u.isMetricVariantFanout)(b) ? (0, u.getMetricFanoutDimensionInfo)(b) : void 0;
          if (_ && !U.has(_.dimension))
            throw new c.RAQIV2ValidationError(
          ...
          let q = new Set(N.map((e) => e.dimension)),
            ...
            B = O.filter(a.isDurationBucketDimension),
            L = O.filter((e) => !(0, a.isDurationBucketDimension)(e)),
            G = B.length > 0 ? B.map(y) : void 0,
            W =
              null == (p = e.filter)
                ? void 0
                : p.filter((e) => {
  ...
  (e) => {
    ...
    var t,
      ...
      v = e.i(532075),
      R = e.i(463263);
    let T = (e) => Date.UTC(e.getUTCFullYear(), e.getUTCMonth(), e.getUTCDate()),
      A = (e, t) =>
        "allRanges" === t || Math.abs(T(e.endTime) - T(e.startTime)) / R.DAY_MS + 1 < 180;
    e.s(["default", 0, A], 356141);
    var D = e.i(656047),
      w = e.i(884227);
    let I = (e) => {
        var t, r, n;
      ...
      S = (e) => {
        if ("string" != typeof e || 0 === e.trim().length) return;
        let t = Number(e);
        return Number.isFinite(t) && t >= 0 ? e : void 0;
      },
      E = (e) =>
        "string" == typeof e && e.length > 0 ? e : "number" == typeof e ? String(e) : void 0,
      C = { maxAttempts: 6, initialPollingInterval: 300, maxAccumulativeDelayToStartBackoff: 1200 },
      M = async function (e, t, r) {
        let n =
          arguments.length > 3 && void 0 !== arguments[3]
            ? arguments[3]
            : "ACE DAG execution did not produce any query results";
        return (0, D.pollAnalyticsOperation)(
          async () => {
            var r, n, i, a, o, s;
            let l, u, c;
            return (
      ...
      V = async function (e, t) {
        let { executionErrorSource: r = "generic", adaptResult: n = I } =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        try {
          return await M(e, t, (e) => {
            let t = ((e) => {
              var t, r, n, i;
              let a =
                null == (i = e.result) || null == (n = i.errors)
                  ? void 0
                  : n.find((e) => {
                      var t;
              ...
              let o = a.context
                  ? Object.fromEntries(
                      Object.entries(a.context).filter((e) => "string" == typeof e[1])
                    )
                  : void 0,
                s = ((e) => {
                  if (!e) return;
                  let t = { actual: S(e.actual), max: S(e.max) },
                    r = e.limit_kind;
                  if (void 0 !== r)
                    switch (r) {
                      case "nodes":
              ...
              return {
                message:
                  null != (t = null != (r = E(a.message)) ? r : E(a.code))
                    ? t
                    : "ACE DAG execution failed",
                code: a.code,
                severity: E(a.severity),
                nodeId: E(a.nodeId),
                suggestion: E(a.suggestion),
                operationId: E(e.operationId),
                context: s ? { complexity: s } : void 0,
                rawContext: o
              };
            })(e);
            if (t) throw new w.default(t, r);
            return n(e);
          });
        } catch (e) {
          if (e instanceof D.RAQIQueryError)
            throw new w.default(
              {
                message: e.message,
                code: void 0,
    ...
    let Q = "query_rank_selection",
      ...
      q = (e, t) => {
        ...
        return [
          ...e.filter((e) => !r.has(e)).map(P.dimensionToRankBreakdownSpec),
          ...t.map(P.topNConfigToRankBreakdownSpec)
        ];
      },
      x = (e) => e.filter((e) => !e.excludeOtherSeries).map((e) => e.dimension),
      B = (e, t) => ({ id: e, type: r.NodeType.Output, outputConfig: { input: t, alias: e } }),
      L = (e) => {
        let t,
          n,
          {
          ...
          f = m
            ? {
                metric: s,
                breakdownSpecs: l.map(P.dimensionToRankBreakdownSpec),
                filters: p,
                dynamicFilterBindings:
                  ((n = a.AnalyticsQueryGatewayAPIFilterOperation.Contains),
                  u.map((e) => ({ input: Q, dimension: e.dimension, operation: n })))
              }
            : y,
          h = [
            ...(m ? [{ id: Q, type: r.NodeType.Query, queryConfig: y }] : []),
            { id: F, type: r.NodeType.Query, queryConfig: f },
            B(g.MAIN_OUTPUT_NODE_ID, F)
          ],
          v = x(u);
        if (m && v.length > 0) {
          let e = new Set(v),
            ...
            n = {
              metric: s,
              breakdownSpecs: t.length > 0 ? t.map(P.dimensionToRankBreakdownSpec) : void 0,
              filters: p,
          ...
          h.push({ id: N, type: r.NodeType.Query, queryConfig: n }, B(_, N));
        }
        let R = l.filter(c.isDurationBucketDimension),
          T = l.filter((e) => !(0, c.isDurationBucketDimension)(e));
        if (d && T.length > 0) {
          let e = R.length > 0 ? R.map(P.dimensionToRankBreakdownSpec) : void 0;
          h.push(
            {
              id: O,
      ...
      G = async (e) => {
        ...
        if (void 0 === l)
          return V(
            r,
            L({ request: n, metric: i, apiBreakdown: a, topNConfigs: o, fetchTotalSeries: s }),
            { executionErrorSource: "rank" }
          );
        let { comparisonStartDate: u, comparisonEndDate: c } = (0, h.default)(
            n.timeSpec,
            l.granularity,
            l.relativeOffset,
            l.customStartDate
                  ...
                  let m = { response: { values: d } },
                    p =
                      null == (o = c.find((e) => e.nodeId === _)) || null == (a = o.timeSeries)
                        ...
                        : a.values;
                  if (p) {
                    let e = (0, b.processUngroupedOtherResponse)({ values: p }, t);
        ...
        return {
          response: d.response ? U(d.response, n.timeSpec.startTime, n.timeSpec.endTime) : null,
          comparisonResponse: d.response ? U(d.response, u, c) : void 0,
          totalSeriesResponse: d.totalSeriesResponse
            ? U(d.totalSeriesResponse, n.timeSpec.startTime, n.timeSpec.endTime)
            : void 0,
          totalSeriesComparisonResponse: d.totalSeriesResponse
            ? U(d.totalSeriesResponse, u, c)
            : void 0
        };
      },
      W = async (e) => {
              ...
              return void 0 === r || (0, k.isPinnedRankTopNConfig)(n)
                ...
                : {
                    ...
                    orderTimeRangeDays: Math.max(
                      1,
                      Math.ceil((t.endTime.getTime() - t.startTime.getTime()) / R.DAY_MS)
                    )
                  };
            })(e, r.timeSpec, s)
          );
    ...
    var j = e.i(405005),
      Y = e.i(405680),
      H = e.i(772147),
      K = (((t = {}).Separate = "Separate"), (t.Combined = "Combined"), t);
    let z = async (e) => e.catch(() => null),
      J = (e) => {
        let { timeSpec: t, ...r } = e;
      ...
      Z = (e, t, r) => {
        let i = e.startTime,
          a = e.endTime,
          o = y.PRESET_DATE_RANGE_DURATION_MS[e.rangeType];
        return (
          r &&
          ...
          {
            ...e,
            startTime: (0, Y.snapToLatestStartTime)(i, t),
            endTime: (0, Y.snapToLatestEndTime)(a, t)
          }
        );
      },
      X = async (e, t) => e.platformGatewayRAQIClient.query(t),
      $ = async (e, t) => e.platformGatewayRAQIClient.getDimensionValues(t),
      ee = async (e, t) => z(e.platformGatewayRAQIClient.getMetricMetadata(t)),
      et = (e, t) => {
        let { resource: r, ...n } = e;
      ...
      er = async (e, t, r, n, i) => {
        var a, o;
        let { comparisonStartDate: s, comparisonEndDate: l } = (0, h.default)(e.timeSpec, r, n, i),
          u = J(e),
          c = { ...u, startTime: s, endTime: l },
          d = await Promise.all([X(t, u), z(X(t, c))]);
        return {
      ...
      en = async (e, t, r, n, i) => {
        let { comparisonStartDate: a, comparisonEndDate: o } = (0, h.default)(e.timeSpec, r, n, i),
          s = { ...J(e), startTime: a, endTime: e.timeSpec.endTime },
          l = await X(t, s);
        return l
          ? { result: U(l, e.timeSpec.startTime, e.timeSpec.endTime), comparisonResult: U(l, a, o) }
          : { result: null };
      },
      ei = async (e, t, r) => {
        if (void 0 === r) {
          var i;
          return { result: null != (i = await X(t, J(e))) ? i : null };
        }
        switch (r.mode) {
          case "Separate":
            return er(e, t, r.granularity, r.relativeOffset, r.customStartDate);
          case "Combined":
            if (r.granularity === n.RAQIV2MetricGranularity.None)
              return er(e, t, r.granularity, r.relativeOffset, r.customStartDate);
            return en(e, t, r.granularity, r.relativeOffset, r.customStartDate);
          default: {
            let e = r.mode;
      ...
      ea = (e) => {
        ...
        for (let { dimension: n, config: i } of e) {
          ...
          for (let t of i.supportedDimensionValues) e.set((0, j.getStableVariantKey)(n, t), t);
          t.set(n, e);
        }
        return t;
      },
      ...
      eu = (e) => (0, s.isValidArrayEnumValue)(el, e),
      ec = {
      ...
      ed = (e) => (0, u.default)((0, v.getUIMetric)(e)).valueType,
      em = (e) => {
        var t, r;
        if (!e) return;
        let n =
      ...
      ep = (e, t, r, a, o) => {
        if (!(null == e ? void 0 : e.values) || !eu(a)) return e;
        let s = ((e, t, r) => {
          let n = ec[r],
            i = [],
            a = t.getTime();
      ...
      eg = (e, t, r, n, i, a, o) => {
        ...
        let v = g,
          R = f;
        if (i) {
          let { comparisonStartDate: t, comparisonEndDate: r } = (0, h.default)(
            e.timeSpec,
            i.granularity,
            i.relativeOffset,
            i.customStartDate
          );
          ((v = t), (R = new Date(Math.min(f.getTime(), r.getTime()))));
        }
        return {
          response: ep(r.result, g, f, a, o),
          comparisonResponse:
            null != (s = ep(null != (l = r.comparisonResult) ? l : null, v, R, a, o)) ? s : void 0,
          totalSeriesResponse:
            null != (u = ep(null != (c = null == n ? void 0 : n.result) ? c : null, g, f, a, o))
              ? u
              : void 0,
          totalSeriesComparisonResponse:
            null !=
            (d = ep(null != (m = null == n ? void 0 : n.comparisonResult) ? m : null, v, R, a, o))
              ? d
              : void 0
        };
      },
      ey = async (e, t, r, n, i) => {
        let [a, ...o] = await Promise.all([
          ...
          ...t.map((t) => {
            let { apiMetric: i } = t;
            return ei(et(e, i), r, n.fetchComparison);
          })
        ]);
        return {
      ...
      ef = async (e, t, r, n, i, a, o, s) => {
        ...
        let v = [...(null != (l = null == e ? void 0 : e.filter) ? l : []), ...a],
          ...
          [w, I, S] = await Promise.all([
            i,
            ei(et({ ...e, filter: v }, t), r, n.fetchComparison),
            T
              ? ei(et({ ...e, breakdown: D.length ? D : void 0, filter: R }, t), r)
          ...
          E = T
            ? ((e, t) => {
                ...
                let r = t.map((e) => {
                  ...
                  n = (0, b.processUngroupedOtherResponse)(e.result, r),
                  i = (0, b.processUngroupedOtherResponse)(e.comparisonResult, r);
        ...
        let l,
          ...
          p =
            ...
            a.fetchTotalSeries && (u.length || n.length)
              ? z(ei(et({ ...e, breakdown: l.length ? l : void 0 }, m), i, a.fetchComparison))
              : void 0);
        if (Array.isArray(d)) return ey(e, d, i, a, p);
        if (o.length || s.length) return ef(e, d, i, a, p, o, s, r);
        let [g, y] = await Promise.all([
          ei(et({ ...e, breakdown: r }, d), i, a.fetchComparison),
          p
        ]);
        if (y) {
          ...
          return {
            mainResponse: g,
            totalResponse: { comparisonResult: e ? eh(e) : e, result: t ? eh(t) : t }
          };
        }
      ...
      eA = async (e, t, r) => {
        let i = e.map(async (e) => {
            ...
            if (!(null == l ? void 0 : l.metric)) {
              let e = eT(await X(t, J({ ...r, breakdown: [o] })), o);
              return { ...e, values: e.values.sort(eR).slice(0, c) };
            }
            ...
            return eT(await X(t, J(et(g, l.metric))), o);
          }),
      ...
      eD = async (e, t, r) => {
        ...
        let { comparisonStartDate: o, comparisonEndDate: s } = (0, h.default)(
          t,
          r.granularity,
          r.relativeOffset,
          r.customStartDate
        ...
        switch (r.mode) {
          case "Separate": {
            let r = { ...t, startTime: o, endTime: s },
              [n, a] = await Promise.all([e(t), z(e(r))]);
            return {
              ...n,
          ...
          case "Combined": {
            if (r.granularity === n.RAQIV2MetricGranularity.None) {
              let r = { ...t, startTime: o, endTime: s },
                [n, i] = await Promise.all([e(t), z(e(r))]);
              return {
                ...n,
            ...
            return {
              response: i.response ? U(i.response, t.startTime, t.endTime) : null,
              comparisonResponse: i.response ? U(i.response, o, s) : void 0,
              totalSeriesResponse: i.totalSeriesResponse
                ? U(i.totalSeriesResponse, t.startTime, t.endTime)
                : void 0,
              totalSeriesComparisonResponse: i.totalSeriesResponse
                ? U(i.totalSeriesResponse, o, s)
                : void 0
            };
          }
          default: {
      ...
      ew = async (e) => {
        let {
          ...
          { metricVariant: u, breakdown: c } = (0, j.splitMetricVariantFromBreakdown)(
            t.metricVariant,
            t.breakdown
          ),
          d = async (e) => {
            ...
            return V(a, r, {
              executionErrorSource: (0, l.isIdentityFormulaComputedMetric)(n)
                ? void 0
                : "computed-metric"
            });
          },
          m = await eD(d, r, s),
          p = (0, j.isMetricVariantFanout)(u) ? (0, j.getMetricFanoutDimensionInfo)(u) : void 0;
        return p ? eo(m, ea([p])) : m;
      },
      eI = async (e) => {
        let {
          ...
          await eD(
            (e) =>
              V(
                ...
                { executionErrorSource: "variant-fanout" }
              ),
            t.timeSpec,
            u
          ),
      ...
      eS = async function (e, t) {
        ...
        let g,
          ...
          N = Q && A(P, F) ? Q : void 0,
          O = N === Q ? S : { ...S, fetchComparison: N },
          { fillMissingDatapoints: _ } = O,
          q = null != (i = P.snapGranularity) ? i : U,
          x = Z(P, q),
          B =
        ...
        let { metric: L } = B,
          G = (0, m.getUIMetricFromAtomicMetricLike)(L),
          Y = ((e, t) => {
            var r;
          ...
          { metricVariant: K, breakdown: z } = (0, j.splitMetricVariantFromBreakdown)(M, C),
          J = (0, j.isMetricVariantFanout)(K) ? (0, j.getMetricFanoutDimensionInfo)(K) : void 0,
          X = n.RAQIV2MetricToSupportedDimensions[G];
        if (J && X && !X.includes(J.dimension))
          throw new H.RAQIV2ValidationError(
            H.RAQIV2ValidationErrorType.UnsupportedBreakdown,
            "Metric "
              .concat(G, " does not support breakdown dimension ")
              .concat(J.dimension, ". Supported dimensions: ")
              .concat(X.join(", ")),
            G,
            J.dimension
          );
        let {
            apiBreakdown: $,
            topNPseudoBreakdown: et,
            otherSeriesBreakdown: er
          } = ((y = []),
          (h = []),
          (v = []),
          (R = []),
          ...
          {
            apiFilters: ei,
            metricFanoutPseudoFilters: ea,
            otherSeriesFilters: eo,
            otherSeriesNotContainsFilters: el
          } = ((T = []),
          (D = []),
          (w = []),
          (I = []),
          null == Y ||
            Y.forEach((e) => {
              ...
              if ((0, s.isValidEnumValue)(n.RAQIV2UIPseudoDimension, t)) {
                ...
                switch (i) {
                  case n.RAQIV2UIPseudoDimensionType.MetricFanout:
                    D.push({ dimension: t, config: e, values: r });
                    break;
                  case n.RAQIV2UIPseudoDimensionType.TopNBreakdown: {
          ...
          }),
          {
            ...
            if (!i.length) {
              let t = (0, f.getAPIMetricFromUIMetric)(e, {
                percentile: null,
            ...
            if (u.length) {
              ...
              let r = (0, f.getAPIMetricFromUIMetric)(e, es(a.dimension, t));
              if (l) {
                let e = new Set();
                return (
                  e.add(r),
            ...
            if (l) {
              let t = new Set(),
                r = o.supportedDimensionValues.map((t) => ({
                  apiMetric: (0, f.getAPIMetricFromUIMetric)(e, es(a.dimension, t)),
                  fanoutBreakdownDimension: a.dimension,
                  fanoutBreakdownValue: t
                })),
                n = (0, f.getAPIMetricFromUIMetric)(e, es(a.dimension, o.totalSeries));
              return (
                t.add(n),
                r.forEach((e) => {
                  let { apiMetric: r } = e;
          ...
          ey = U === n.RAQIV2MetricGranularity.None && $.some(c.isDurationBucketDimension),
          ef = _ && eu(U),
          eh = ef || ey ? ee(t, { metrics: ep }) : Promise.resolve(null);
        if (ey) {
          let e = await eh;
          x = Z(P, n.RAQIV2MetricGranularity.OneDay, em(e));
        }
        let eR = {
            resource: k,
            limit: b,
            granularity: U,
            filter: ei.length ? ei : void 0,
            timeSpec: x
          },
          eT = await W({
            clients: t,
            ...
            comparison: N,
            legacyOnlyFeatures: {
              fillsMissingDatapoints: ef,
              hasMetricFanoutBreakdown: en.length > 0,
              hasMetricFanoutFilters: ea.length > 0,
              hasOtherSeriesFilters: eo.length > 0,
              hasOtherSeriesNotContainsFilters: el.length > 0
            }
          });
        ...
        let {
          ...
          mainFilters: eS,
          otherFilters: eE
        } = await eA(et, t, { ...eR, metric: ed });
        if (eS.some((e) => 0 === e.values.length)) return { response: { values: [] } };
        let eC = [...$, ...eD];
        if (
          ((eR.breakdown = eC || void 0),
          ...
          let e = ei.concat(eS, eo),
            [r, n] = await Promise.all([
              eI({
                snappedRequestBase: eR,
                metric: G,
                apiBreakdown: eC,
                apiFilters: e,
                metricFanoutPseudoBreakdown: en,
                clients: t,
                comparison: N
              }),
              eh
        ...
        let [{ mainResponse: eM, totalResponse: eV }, eP] = await Promise.all([
          ev(
            eR,
            { apiMetrics: ec, metricForTotalSeries: ed, allAPIMetrics: ep },
            eC,
            en,
            t,
            O,
        ...
        return ef
          ? eg(eR, eP, eM, eV, N, U, ep)
          : {
              response: eM.result,
              comparisonResponse: eM.comparisonResult,
              totalSeriesResponse: null != (o = null == eV ? void 0 : eV.result) ? o : void 0,
              totalSeriesComparisonResponse: null == eV ? void 0 : eV.comparisonResult
            };
      };
    e.s(
      [
...
//# debugId=001e82d5-9cf5-7bd3-684d-14a8563ca34d
//# sourceMappingURL=034lm51ujlu0q.js.map
