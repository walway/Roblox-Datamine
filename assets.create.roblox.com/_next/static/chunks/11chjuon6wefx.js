          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "2bc54272-3094-c8d7-6393-e258f58cb703");
  } catch (e) {}
})();
      ...
      [
        ...
        (e) => {
          ...
          return (0, t.useMemo)(() => {
            let e = {
              ready: g.ready,
              translate: (0, c.translationFn)(g),
              translateHTML: (0, c.translateHTMLFn)(g),
                ...
                return (e, s, c, d, h) => {
                  ...
                  return ((e, n, o) => {
                    ...
                    let { stringArgs: u, htmlArgs: c } =
                      ...
                      d = r(e, u),
                      h = d.split(i).filter((e) => !!e);
                    if (1 === h.length) return d;
                    let g = [...h];
                  ...
                  })(g.preferLoadedTranslations && !n ? e : u(e, g), d, h);
                };
              })(e)
            };
          }, [g]);
    ...
    e.s([
      ...
      (e) => {
        ...
        return ((0, n.useEffect)(() => {
          ("unauthenticated" === b && v(),
            "logged-out" === b && r.default.push(c.creatorHub.getUrl()));
        }, [v, b]),
    ...
    let u = (0, e.i(272593).createClientConfiguration)("creator-home-api", "bedev2"),
      ...
      d = function () {
        ...
        return (0, i.useQuery)({
          ...
          queryFn: () => {
            let e;
            return ((e = { surface: o.GroupListSurface.CreatorHub }), c.groupsListGroups(e));
          }
        });
      },
  ...
  (e) => {
    ...
    e.s([
      ...
      function (e) {
        ...
        var E = (0, n.useMemo)(
          function () {
            return { ref: d, enqueue: f, close: w };
          },
          [w, f]
        );
        return n.default.createElement(
          ...
          n.default.createElement(
            r.S,
            (0, t._)({}, (null == (i = m[0]) ? void 0 : i.props) || {}, c, {
    ...
    class y {
      ...
      async call(e, t) {
        ...
        let a = (n) =>
          ...
          i = c.uuidService.generateRandomUuid();
        return r <= 0
          ? a(i)
          : Promise.race([
              new Promise((t, a) => {
        ...
        return (
          ...
          (0, h.useEffect)(() => {
            if (o) {
              ...
              let t = d(x.changeTheme, f),
                n = d(x.changeVolume, w);
              return () => {
                (c(x.changeTheme, t), c(x.changeVolume, n));
              };
            }
            return () => {};
          }, [f, w, o, b, c, d]),
          ...
          s = ((e) => {
            ...
            return function (e) {
              let { children: o } = e,
                s = (0, h.useMemo)(() => E(), []),
                u = r(),
                [c, d] = (0, b.useSessionStorage)("mock_web_view", null),
                g = (0, h.useRef)(null),
                v = !s && (!0 === c || i),
                m = s || v,
                w = (0, h.useMemo)(
    ...
    e.s([
      ...
      (e) => {
        ...
        let { children: s, unifiedLogger: l, pageLoggerConfig: u, path: c } = e,
          d = null != (o = null == u ? void 0 : u.tags) ? o : r,
          h = null == u ? void 0 : u.rosId,
          g = (0, t.useMemo)(() => ({ tags: d, rosId: h, path: c }), [d, h, c]),
          b = (0, t.useRef)(g),
          v = (0, t.useRef)(g);
        ((0, t.useLayoutEffect)(() => {
          ((v.current = g),
...
//# debugId=2bc54272-3094-c8d7-6393-e258f58cb703
//# sourceMappingURL=2i4cd2dck25ke.js.map
