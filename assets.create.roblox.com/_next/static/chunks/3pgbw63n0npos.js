...
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function b(e) {
      var t;
      return null == (t = e) ? t : { tier: y(t.tier), isRequired: t.isRequired };
    }
    function f(e) {
      var t;
      return null == (t = e)
    ...
    function C(e, t) {
      return null == e ? e : { universeId: e.universeId, records: e.records.map(w) };
    }
    function g(e, n) {
      return null == e
        ? e
        : {
            ...
            paidAt: (0, t.exists)(e, "paidAt")
              ? null === e.paidAt
                ? null
                : new Date(e.paidAt)
              : void 0,
            refundAvailableAt: (0, t.exists)(e, "refundAvailableAt")
              ? null === e.refundAvailableAt
                ? null
                : new Date(e.refundAvailableAt)
              : void 0,
                  ...
                  return (
                    ...
                    [
                      ...
                      new t.JSONApiResponse(l, function (e) {
                        return null == e
                          ? e
                          : { selectStatus: e.selectStatus, reasons: e.reasons.map(c) };
                      })
                    ]
                  );
              }
              ...
              switch (o.label) {
                case 0:
                  if (null === e.universeId || void 0 === e.universeId)
                    throw new t.RequiredError(
                      "universeId",
                      "Required parameter requestParameters.universeId was null or undefined when calling coreContentGetUniverseAudienceReach."
                    );
                  return (
                    (i = {}),
                    (r = {}),
                    ...
                    [
                      ...
                      this.request(
                        {
                          path: "/v2/universe/{universeId}/audience-reach".replace(
                            "{".concat("universeId", "}"),
                            encodeURIComponent(String(e.universeId))
                          ),
                      ...
                      new t.JSONApiResponse(l, function (e) {
                        ...
                        return null == e
                          ...
                          : {
                              ...
                              highlyEngagedPlayers:
                                null == (r = e.highlyEngagedPlayers)
                                  ? r
                                  : {
                                      status: r.status,
                                      engagedPlayersCount: r.engagedPlayersCount,
                                      updatedAt: (0, t.exists)(r, "updatedAt")
                                        ? null === r.updatedAt
                                          ? null
                                      ...
                                      graceDeadline: (0, t.exists)(r, "graceDeadline")
                                        ? null === r.graceDeadline
                                          ? null
                                          : new Date(r.graceDeadline)
                                        : void 0,
                ...
                case 1:
                  return (
                    ...
                    [
                      2,
                      new t.JSONApiResponse(l, function (e) {
                        return null == e ? e : { creatorTier: y(e.creatorTier) };
                      })
                    ]
                  );
              }
    ...
    ((function (e) {
      ...
      e.s([
        ...
        "HighlyEngagedPlayersStatusEnum",
        0,
        {
          Eligible: "Eligible",
        ...
        "ThresholdBarColorEnum",
        0,
        { Muted: "Muted", Green: "Green", Yellow: "Yellow", Blue: "Blue" },
        "UniverseAudienceReachEnum",
        0,
        {
          AllAges: "AllAges",
          Ages5Plus: "Ages5Plus",
