          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "b8351a96-63df-cb73-4a48-b8e12f1e7330");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
      ...
      [
        ...
        (e) => {
          ...
          return (0, t.useMemo)(() => {
            let e = {
              ready: m.ready,
              translate: (0, d.translationFn)(m),
              translateHTML: (0, d.translateHTMLFn)(m),
              translateWithNamespace: m.translateWithNamespace,
              translateWithNamespaceHTML: m.translateWithNamespaceHTML
            };
            return {
              ...e,
              ...
              tPendingHtmlTranslation: ((e) => {
                ...
                return (e, o, d, u, f) => {
                  let m = n();
                  if (!m.isAllowed) return l(d, u, f);
                  if (m.preferLoadedTranslations && a) {
                    let e = l(d, u, f);
                    if ("" !== e) return e;
                  }
                  return ((e, a, l) => {
                    ...
                    let { stringArgs: c, htmlArgs: d } =
                      ...
                      u = s(e, c),
                      f = u.split(r).filter((e) => !!e);
                    if (1 === f.length) return u;
                    let m = [...f];
                    if (0 !== Object.keys(d).length) {
                      let e = f.reduce((e, t, a) => {
                        let s = i.exec(t);
                        if (s) {
                          let t = s[1];
                    ...
                    if (!Array.isArray(a) || 0 === a.length)
                      return (0, t.createElement)(t.Fragment, null, ...m);
                    let g = a.reduce((e, t) => {
                      ...
                      h = [],
                      v = [];
                    for (let e = m.shift(); void 0 !== e; e = m.shift())
                  ...
                  })(m.preferLoadedTranslations && !a ? e : c(e, m), u, f);
                };
              })(e)
            };
          }, [m]);
    ...
    let em = (0, s.makeStyles)()(() => ({
      ...
      ep = (e) => {
        let { children: s, title: r, description: l, size: o = "large", illustration: n } = e,
          {
            classes: { smallContainer: c, largeContainer: d, smallText: u, largeText: f },
            cx: m
          } = em();
        return (0, t.jsxs)(i.default, {
          classes: { root: m({ [c]: "small" === o, [d]: "large" === o }) },
  ...
  (e) => {
    ...
    let i = {
      ...
      f = { Small: "padding-y-xsmall", XSmall: "padding-y-none" },
      m = { Small: "XSmall", XSmall: "XSmall" },
      ...
      p = s.default.forwardRef((e, p) => {
        ...
        let q = x && s.default.createElement(t.Icon, { name: x, size: m[k], className: l[b] });
        return s.default.createElement(
          ...
          v &&
            s.default.createElement(
              "span",
              {
                className: (0, a.default)("text-no-wrap text-truncate-split", u[k], f[k], M, r[b])
              },
              v
            ),
          "Trailing" === _ && q
          ...
          a.default.createElement(
            ...
            (0, t._)({}, (null == (r = h[0]) ? void 0 : r.props) || {}, d, {
              ...
              onClose: function (e, t) {
                var a, s, i;
                ((null == (a = h[0]) ? void 0 : a.shouldClose(t)) && g(!1),
...
//# debugId=b8351a96-63df-cb73-4a48-b8e12f1e7330
//# sourceMappingURL=3r8w__1z24f0u.js.map
