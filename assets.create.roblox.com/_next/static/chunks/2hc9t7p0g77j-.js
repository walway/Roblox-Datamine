          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "5bcd7e4f-fa37-1b8a-1e18-1f4bb3091a15");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let i = /{(.+?)}/,
      r = /({.+?})/g,
      c = /^[a-zA-Z0-9-]+\.(?:capture-loopback\.)?chromatic\.com$/,
      l = /(?:^|\.)robloxlabs\.com$/,
      o = () => {
        let e,
          t = c.test(window.location.hostname),
          a = window.location.hostname.includes("localhost"),
          s = "string" == typeof (e = window.location.hostname) && l.test(e);
        return {
          isSSR: !1,
          isAllowed: t || a || s,
          isDangerous: t || s,
          ...
          return (0, t.useMemo)(() => {
            ...
            return {
              ...
              tPendingTranslation: ((e) => {
                ...
                return (e, i, r, c) => {
                  let l = o();
                  if (!l.isAllowed) return a(r, c);
                  if (l.preferLoadedTranslations && t) {
                    let e = a(r, c);
                    if (e.length > 0) return e;
                  }
                  return s(l.preferLoadedTranslations && !t ? e : n(e, l), c);
                };
              })(e),
              tPendingHtmlTranslation: ((e) => {
                let { ready: a, translateHTML: c } = e;
                return (e, l, u, d, m) => {
                  let g = o();
                  if (!g.isAllowed) return c(u, d, m);
                    ...
                    let { stringArgs: n, htmlArgs: u } =
                        ...
                        void 0 === c ||
                          Object.entries(c).forEach((e) => {
                            let [t, a] = e;
                            "string" == typeof a ? (l[t] = a) : (o[t] = a);
                          }),
                        { stringArgs: l, htmlArgs: o }),
                      d = s(e, n),
  ...
  (e) => {
          ...
          return (
            null == e ||
              e.forEach((e) => {
                ...
                c &&
                  (e.dimension === t.RAQIV2UIPseudoDimension.AggregationType &&
                  (0, a.isValidEnumValue)(t.RAQIV2AggregationType, c)
                    ? (i = c)
                    : e.dimension === t.RAQIV2UIPseudoDimension.PercentileType &&
                      (0, a.isValidEnumValue)(t.RAQIV2PercentileType, c) &&
                      (r = c));
              }),
    ...
    let r = new Set([
      ...
      c = (e) => Object.hasOwn(t.RAQIV2BenchmarkDatasetKeyToVariant, e) && r.has(e),
      l = Object.entries(t.RAQIV2BenchmarkDatasetKeyToVariant).reduce((e, t) => {
        let [a, i] = t;
        return (c(a) && (0, s.isNumericUIMetric)(i.metric) && (e[a] = i.metric), e);
      }, {}),
    ...
    let n = (e) => "string" == typeof e && e.trim().length > 0,
      ...
      m = (e, t) => {
        if (!(0, o.isComputedMetric)(e)) {
          ...
          let { localizedName: a } = (0, l.default)((0, o.getUIMetricFromAtomicMetricLike)(e));
          return t ? t.translate(a) : d(a.key);
        }
        return (0, c.isPureL7SmoothingComputedMetric)(e)
      ...
      f = (e, t) => {
        ...
        let { localizedName: s } = (0, l.default)((0, o.getUIMetricFromAtomicMetricLike)(e));
        return t.translate(s);
      },
      b = (e) =>
        (0, o.isComputedMetric)(e)
          ? !(0, c.isPureL7SmoothingComputedMetric)(e) || b(e.sources[0].metric)
          : (0, l.default)((0, o.getUIMetricFromAtomicMetricLike)(e)).isPositiveGood,
      p = (e) => {
        var t;
        if ((0, o.isComputedMetric)(e))
          return !!(0, c.isPureL7SmoothingComputedMetric)(e) && p(e.sources[0].metric);
        let { defaultTotalSummaryTypes: a } = (0, l.default)(
    ...
    e.s([
      ...
      (e) =>
        (0, o.isComputedMetric)(e)
          ...
          : (0, o.isCustomEventsAtomicMetricLike)(e)
            ? d(e.customEventName)
            : (0, l.default)((0, o.getUIMetricFromAtomicMetricLike)(e)).localizedName,
      ...
      (e) => {
        if ((0, o.isComputedMetric)(e)) {
          ...
          return (0, c.getPrecomputedL7MetricFromBase)(t);
        }
    ...
    let eg = (0, s.makeStyles)()(() => ({
      ...
      eb = (e) => {
        ...
        return (0, t.jsxs)(i.default, {
          classes: { root: g({ [n]: "small" === l, [u]: "large" === l }) },
          flexDirection: "column",
          alignItems: "center",
          children: [
            (0, t.jsx)(ef, { illustration: o, size: l }),
            (0, t.jsxs)(i.default, {
              classes: { root: g({ [d]: "small" === l, [m]: "large" === l }) },
              flexDirection: "column",
              alignItems: "center",
              children: [
            ...
            function (t) {
              ...
              (e.forEach((e) => {
                ...
                null == a
                  ? delete l[e]
                  : Array.isArray(a)
                    ? (l[e] = a.map((e) => e.toString()))
                    : (l[e] = a.toString());
              }),
                Array.from(new Set([...Object.keys(c), ...Object.keys(l)])).every((e) =>
                  ((e, t) => {
                  ...
                  (r.skipHistory
                    ? i.replace({ pathname: i.pathname, query: l })
                    : i.push({ pathname: i.pathname, query: l }, void 0, s)));
            },
            [i, e, s]
          )
        ];
  ...
  (e) => {
    ...
    let i = {
      ...
      b = s.default.forwardRef((e, b) => {
        ...
        let q = x && s.default.createElement(t.Icon, { name: x, size: g[k], className: c[v] });
  ...
  (e) => {
    ...
    var p = (0, s.default)({ name: "AlertTitle" })(function (e) {
      ...
      h = (0, a.forwardRef)(function (e, s) {
        ...
        return a.default.createElement(b, (0, t._)({}, l, { classes: o.classes, ref: s }));
      });
          ...
          a.default.createElement(
            ...
            (0, t._)({}, (null == (r = p[0]) ? void 0 : r.props) || {}, u, {
              TransitionProps: (0, t._)(
                (0, t._)(
                  {},
                  (null == (l = null == (c = p[0]) ? void 0 : c.props)
                    ? void 0
                    : l.TransitionProps) || {}
                ),
                {
...
//# debugId=5bcd7e4f-fa37-1b8a-1e18-1f4bb3091a15
//# sourceMappingURL=2ijg2-90ddjbm.js.map
