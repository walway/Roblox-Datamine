          ...
          : "undefined" != typeof global
            ...
            : "undefined" != typeof window
              ...
              : "undefined" != typeof self
                ...
                : {},
      n = new e.Error().stack;
    n && ((e._debugIds || (e._debugIds = {}))[n] = "69b60f46-1768-619c-3f58-ddcf8ac2e000");
  } catch (e) {}
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let L = (e) => {
      let {
        ...
        { mutate: D, isPending: j } = (0, E.useUpdateFolderMutation)(S.default, {
          onSuccess: () => {
    ...
    let D = (e) => {
      let { open: o, onClose: i, creation: a, groupId: s } = e,
        ...
        { enqueue: j, close: U } = (0, T.useSnackbar)(),
        F = (0, l.useQueryClient)(),
        [q, O] = (0, n.useState)(""),
        [N, M] = (0, n.useState)(""),
        [G, _] = (0, n.useState)(!1),
        { data: B, isLoading: K, isError: V } = (0, E.useGetFolders)(S.default, s, o),
        z = (0, n.useCallback)(
          (e) => {
            j({
              message: e,
        ...
        { mutate: J, isPending: W } = (0, E.useAddItemToFolderMutation)(S.default, {
          onSuccess: () => {
            (z(D("Message.AddItemToFolderSuccess")), H());
          },
          onError: async (e) => {
            var t;
            let n = await (0, w.default)(e);
            switch (null != (t = null == n ? void 0 : n.code) ? t : -1) {
              case 3:
                z(D("Error.ItemIdInvalid"));
                break;
              case 9:
                z(D("Error.ItemNotOwned"));
                break;
              case 6:
                z(D("Message.ItemNotFound"));
                break;
              default:
                z(D("Error.AddItemToFolderFailure"));
            }
          }
        }),
        Q = (0, n.useCallback)(() => {
        ...
        Z = (0, n.useMemo)(() => {
          var e;
          return (null != (e = null == B ? void 0 : B.folders) ? e : []).filter(
            (e) => !!e.folderId && !!e.name
          );
        }, [B]),
        $ = (0, n.useMemo)(() => {
        ...
        Y = (0, n.useMemo)(
          () =>
            K
              ? (0, t.jsx)(p.CircularProgress, { "aria-label": D("Placeholder.SearchFolders") })
              : V
                ? (0, t.jsx)(C.Typography, { children: D("Error.LoadFoldersFailure") })
                : 0 === Z.length
                  ? (0, t.jsx)(P.default, {
                      size: "small",
                      illustration: "avatarItem",
                      title: D("Heading.NoFolders"),
                      description: D("Label.NoFoldersDescription")
                    })
                  : (0, t.jsxs)(t.Fragment, {
                      children: [
                        (0, t.jsx)(k.TextField, {
                          ...
                          InputProps: {
                            ...
                            placeholder: D("Placeholder.SearchFolders")
                          }
                        }),
                        (0, t.jsx)("div", {
                          className:
                          ...
                          children:
                            0 === $.length
                              ? (0, t.jsx)(C.Typography, { children: D("Label.NoMatchingFolders") })
                              : (0, t.jsx)(I.List, {
                                  children: $.map((e, r) => {
                                    let o = e.folderId === N;
                                    return (0, t.jsxs)(
      ...
      return (0, t.jsxs)(t.Fragment, {
        children: [
          (0, t.jsxs)(v.Dialog, {
            ...
            fullWidth: !0,
            children: [
              (0, t.jsx)(f.DialogTitle, { children: D("Label.AddItemToFolder") }),
              (0, t.jsx)(m.DialogContent, {
              ...
              (0, t.jsxs)(h.DialogActions, {
                children: [
                  ...
                  (0, t.jsx)(d.Button, {
                    ...
                    loading: W,
                    onClick: Q,
                    children: D("Action.AddItemToFolder")
                  })
                ]
              })
            ]
          }),
          G && (0, t.jsx)(L, { open: !0, onClose: () => _(!1), onFolderCreated: X, groupId: s })
        ]
      });
    };
    e.s(
        ...
        (e) => {
          let { itemType: o, creation: i, removeItem: a, handleClose: l, isDisabled: u } = e,
            ...
            g = (0, n.useCallback)(async () => {
              ...
              switch ((d(!0), o)) {
                case A.Item.Game:
                  r = q.default.setUniverseConfiguration(
                ...
                default:
                  r = i.isArchived
                    ? q.default.restoreAsset(null != (t = i.assetId) ? t : 0)
                    : q.default.archiveAsset(null != (n = i.assetId) ? n : 0);
              }
              try {
                (await r,
                  a(),
  ...
  (e) => {
    ...
    let B = (e) => {
          ...
          y = (0, n.useCallback)(async () => {
            ...
            try {
              if (l) {
                ...
                (await q.default.updateCollectibleInformation(l, e, !1, 0, !1, 1, 0, !1),
                  m(u("Message.TakeOffSaleSuccess")),
                  i({ ...r, status: O.ItemStatus.OffSale, price: null }));
        ...
        return s === O.ItemStatus.OnSale || s === O.ItemStatus.Free
          ? (0, t.jsx)(_.default, {
              onClick: y,
              disabled: d,
      ...
      [
        ...
        (e) => {
          ...
          let {
            ...
            el = (0, r.useRouter)(),
            eu = (0, n.useMemo)(
              () => !!Q && void 0 !== q.universeProductConfigEnabled,
              [Q, q.universeProductConfigEnabled]
            ),
            { data: ec, isError: ed } = (0, b.useGetActivationEligibilityForUniverse)(
              F === m.Item.Game ? q.universeId : void 0
            ),
            ep = !!ed || (null != (u = null == ec ? void 0 : ec.isEligible) && u),
            ev = (0, n.useMemo)(
              () => F === m.Item.Game && !q.isArchived && (!!q.isActive || ep),
              [F, q.isArchived, q.isActive, ep]
            ),
            ...
            }, [F, q.bundleId, q.lookId, q.assetId]),
            ey = (0, n.useCallback)(
              (e) => {
                en({
            ...
            eS = ek || eC || eT,
            ew = F === m.Item.Game && !q.isArchived,
            eA =
              (F === m.Item.CatalogAsset || F === m.Item.Bundle) &&
              !eu &&
              !q.isIEC &&
              (null == ea ? void 0 : ea.id) === q.userId;
          return (0, t.jsxs)(l.Menu, {
            ...
            children: [
                    ...
                    (0, t.jsxs)(V, {
                      ...
                      children: [
                        ...
                        eC &&
                          (0, t.jsx)(_.default, {
                            onClick: (e) => {
                              ex(e, String(q.universeId), et("Label.UniverseID"));
                            },
                            disabled: !W,
                        ...
                        eT &&
                          (0, t.jsx)(_.default, {
                            ...
                            onClick: (e) => {
                              ex(e, "rbxassetid://".concat(q.assetId), et("Label.AssetURI"));
                            },
                  ...
                  onClick: (e) => {
                    ...
                    switch (F) {
                      case m.Item.DeveloperProduct:
                        ...
                        break;
                      case m.Item.Bundle:
                        ((n = "Label.BundleID"), (t = q.bundleId));
                        break;
                      case m.Item.ExperienceSubscription:
                        ((n = "Label.ProductID"), (t = q.subscriptionProductId));
                        break;
                      case m.Item.AvatarCreationToken:
                        ((n = "Label.TokenID"), (t = q.assetId));
                        break;
                      case m.Item.Look:
                        ((n = "Label.LookID"), (t = q.lookId));
                        break;
                      default:
                        t = q.assetId;
                    }
              ...
              (F === m.Item.CatalogAsset || F === m.Item.Bundle) &&
                !q.isIEC &&
                !eu &&
                (0, t.jsx)(E.default, { creation: q, handleClose: z, removeItem: O, itemType: F }),
              F === m.Item.CatalogAsset &&
                eu &&
                (0, t.jsx)(_.default, {
                  className: q.universeProductConfigEnabled ? eo : "",
                  value: +!q.universeProductConfigEnabled,
                  itemKey: q.universeProductConfigEnabled
                    ? "Label.DisableSale"
                    : "Label.EnableSale",
                  onClick: (e) => {
                    (null == Q || Q(!!e.target.value), z());
                  },
                  children: q.universeProductConfigEnabled
              ...
              F === m.Item.Game && [
                ...
                (0, t.jsx)(
                  _.default,
                  {
                    ...
                    onClick: () =>
                      el.push(
                        "/dashboard/creations/experiences/".concat(q.universeId, "/localization")
                      ),
                    disabled: !W,
                ...
                (0, t.jsx)(
                  _.default,
                  {
                    ...
                    onClick: () =>
                      el.push(
                        "/dashboard/creations/experiences/".concat(q.universeId, "/badges/create")
                      ),
                    disabled: !W,
              ...
              ev && [
                (0, t.jsx)(
                  L.default,
                  { creation: q, updateItemPrivacy: N, handleClose: z, isDisabled: !W },
              ...
              F === m.Item.ExperienceSubscription && [
                (0, t.jsx)(
                  g.default,
                  { creation: q, handleClose: z, updateItem: M },
                  "Action.Activate"
                ),
                (0, t.jsx)(
                  k.default,
                ...
                (0, t.jsx)(C.default, { creation: q, removeItem: O }, "Action.Delete")
              ],
              ew &&
                (0, t.jsx)(_.default, {
                  onClick: () => {
                    (el.push(
                      "/dashboard/creations/experiences/".concat(q.universeId, "/server-management")
                    ),
                      z());
                  },
              ...
              (F === m.Item.Places || F === m.Item.CreatedPlaces) &&
                ...
                (0, t.jsx)(
                  j.default,
                  { creation: q, removeItem: O, handleClose: z, isDisabled: !W },
                  "Action.RemovePlaces"
                ),
              F === m.Item.Places &&
                (0, t.jsx)(
                  A.default,
                  { creation: q, handleClose: z, isDisabled: !W },
                  "Action.MigrateToLatestUpdate"
                ),
              X &&
                F !== m.Item.AvatarCreationToken &&
                !q.isIEC &&
                (0, t.jsx)(B, { creation: q, updateItem: M, handleClose: z }, "Action.ToggleSale"),
              Z &&
                (0, t.jsx)(w.default, {
              ...
              es &&
                !eu &&
                void 0 === q.containingFolderId &&
                (F === m.Item.CatalogAsset || F === m.Item.Bundle) &&
                (0, t.jsx)(x.default, { creation: q, handleClose: z }, "Action.AddToFolder"),
              void 0 !== q.containingFolderId &&
                (0, t.jsx)(
                  D.default,
                  { creation: q, handleClose: z, removeItem: O },
                  "Action.RemoveItemFromFolder"
                ),
              F === m.Item.Look &&
                (0, t.jsx)(P.default, {
                  lookId: null != (d = null == (U = q.lookId) ? void 0 : U.toString()) ? d : "",
                  lookType: q.lookType
                })
            ]
          });
  ...
  (e) => {
    ...
    let p = function (e) {
      ...
      return (0, t.jsxs)("div", {
        children: [
          (0, t.jsx)(i.Dialog, {
            open: k,
            children: (0, t.jsx)(a.DialogTemplate, {
              onConfirm: () => C(!1),
              onCancel: () => C(!1),
              title: y("Message.DeleteUnsuccessful"),
              content: "".concat(y("Message.DeleteErrorMsgPrefix"), " ").concat(y(x)),
          ...
          (0, t.jsx)(i.Dialog, {
            ...
            children: (0, t.jsx)(a.DialogTemplate, {
              ...
              onConfirm: S,
              onCancel: () => h(!1),
              title: y("Heading.DeleteLook"),
              content: y("Message.DeleteLookDescription"),
              confirmText: y("Action.Delete"),
              cancelText: y("Action.Cancel")
            })
          })
        ]
    ...
    e.s(
      [
        ...
        0,
        function (e) {
          let { creation: i, handleClose: s, removeItem: u, itemType: c } = e,
            [d, p] = (0, n.useState)(!1),
            { open: I, close: b, configure: x } = (0, h.useDialog)(),
            { translate: g } = (0, r.useTranslation)(),
            { enqueue: k, close: C } = (0, m.useSnackbar)(),
            T = (0, o.useRouter)(),
            S = (0, n.useMemo)(() => {
              var e, t;
              ...
              try {
                ...
                let n = +(c === y.Item.CatalogAsset
                  ...
                  : null != (t = i.bundleId)
                    ? t
                    : 0);
                if (c === y.Item.CatalogAsset && i.isLimited2) {
                  (w(g("Message.UnableToArchiveLimitedItem")), b());
                  return;
                }
                (await f.default.delistItem(c === y.Item.Bundle, n),
                  u(),
            ...
            }, [c, i.assetId, i.bundleId, i.isLimited2, u, w, g, b, s]),
            R = (0, n.useMemo)(
              () =>
                (0, t.jsx)(a.DialogTemplate, {
                  onConfirm: A,
                  onCancel: b,
    ...
    e.s(
      [
        ...
        0,
        (e) => {
          let { creation: o, updateItemPrivacy: i, handleClose: s, isDisabled: l } = e,
            [u, c] = (0, n.useState)(!1),
            { open: d, close: p, configure: f } = (0, h.useDialog)(),
            { translate: y } = (0, r.useTranslation)(),
            { enqueue: g, close: k } = (0, m.useSnackbar)(),
            C = (0, n.useCallback)(
              (e) => {
                g({
                  message: e,
            ...
            S = (0, n.useCallback)(async () => {
              ...
              c(!0);
              let n = o.isActive
                ? b.default.deactivateGame(null != (e = o.universeId) ? e : 0)
                : b.default.activateGame(null != (t = o.universeId) ? t : 0);
              try {
          ...
          return (0, t.jsx)(v.default, {
            ...
            itemKey: R,
            disabled: u || l,
            children: (0, t.jsx)(I.Typography, { children: y(R) })
          });
        }
      ],
      358041
      ...
      [
        ...
        (e) => {
          let { creation: o, handleClose: i, removeItem: a } = e,
            ...
            { enqueue: l, close: u } = (0, m.useSnackbar)(),
            c = (0, n.useCallback)(
              (e) =>
                e === y.Item.CatalogAsset
                  ? k.RobloxItemConfigurationApiModelsFolderFolderItemItemTypeEnum.Asset
                  : e === y.Item.Bundle
                    ? k.RobloxItemConfigurationApiModelsFolderFolderItemItemTypeEnum.Bundle
                    : k.RobloxItemConfigurationApiModelsFolderFolderItemItemTypeEnum.Unknown,
              []
            ),
            d = (0, n.useCallback)(
              (e) => {
            ...
            { mutate: p, isPending: h } = (0, g.useMutation)({
              mutationFn: async (e) => {
                let { itemId: t, itemType: n, containingFolderId: r } = e,
                  o = c(n);
                return f.default.removeItemFromFolder(t.toString(), o, r.toString());
              },
              onSuccess: () => {
            ...
            I = (0, n.useCallback)(() => {
              let { assetId: e, bundleId: t, containingFolderId: n, itemType: r } = o,
                i = r === y.Item.CatalogAsset ? (null != e ? e : 0) : null != t ? t : 0;
    ...
    e.s(
      [
        ...
        0,
        (e) => {
          let { creation: o, removeItem: i, handleClose: s, isDisabled: l } = e,
            [u, c] = (0, n.useState)(!1),
            { open: d, close: p, configure: f } = (0, h.useDialog)(),
            { enqueue: y, close: b } = (0, m.useSnackbar)(),
            { translate: x } = (0, r.useTranslation)(),
            { gameDetails: g } = (0, w.useCurrentGame)(),
            k = (0, n.useCallback)(
              (e, n) => {
                n
                  ? y({
                  ...
                  : y({
                      children: (0, t.jsx)(C.Alert, { severity: "error", children: e }),
                      autoHide: !0,
                      onClose: b
                    });
              },
            ...
            R = (0, n.useCallback)(async () => {
              ...
              try {
                if (void 0 === o.universeId || void 0 === o.placeId || void 0 === o.name)
                  throw new T.default(A.default.UnknownError, x("Response.UnknownError"));
                let e = { universeId: o.universeId, placeId: o.placeId };
                (await S.default.removePlaceFromUniverse(e),
                  i(),
                  k(x("Message.RemovedSuccess", { placeName: o.name }), !0));
              } catch (t) {
                let e = x("Response.UnknownError");
                if (t instanceof T.default && Object.values(A.default).includes(t.code)) {
                  let n = t.code,
                    r = A.default[n];
                  e = x("Error.".concat(r));
                }
            ...
            }, [p, i, o.name, o.placeId, o.universeId, s, k, x]),
            P = (0, n.useMemo)(() => {
              var e, n;
              return (0, t.jsx)(a.DialogTemplate, {
                color: "destructive",
                onConfirm: R,
                onCancel: p,
            ...
            }, [R, p, x, o.name, null == g ? void 0 : g.name, u]),
            E = (0, n.useCallback)(() => {
              (f(P), d());
            }, [f, d, P]);
          return (
            ...
            (0, t.jsx)(v.default, {
              ...
              disabled: l,
              children: (0, t.jsx)(I.Typography, { children: x("Action.RemovePlaces") })
            })
          );
        }
      ],
    ...
    e.s([
      ...
      (e) => {
        ...
        let y,
          ...
          { translateWithNamespace: D } = (0, a.useTranslation)(),
          {
            params: { enableAudiencesReplacement: j }
          ...
          if (q)
            if (T === p.CONTENT_UNRATED || E)
              ((B = "unplayable"),
                ...
                (H = "Alert"),
                (z = D(h.TranslationNamespace.Creations, "Label.Unplayable")),
                (I = D(h.TranslationNamespace.Creations, "Tooltip.PubliclyUnavailable")));
            else if (L)
              ((B = "limitedDiscovery"),
                (V = "icon-filled-triangle-exclamation"),
                (H = "Warning"),
                (z = D(h.TranslationNamespace.Creations, "Label.NeedsAttention")));
              ...
              ((B = "limited"),
                ...
                (z = D(h.TranslationNamespace.Creations, "Label.Limited")));
              ...
              let e;
              ((B = "public"), (V = "icon-filled-globe-detailed"));
              let t = w ? (null != P ? P : 0) : Math.max(16, null != P ? P : 0);
              (t >= 16 ? (e = "16") : t >= 9 && (e = "9"),
                (z = e
                  ? D(h.TranslationNamespace.Creations, "Label.PublicAgeGated", { minAge: e })
                  : D(h.TranslationNamespace.Creations, "Label.PublicAllAges")));
            }
          else
            ((B = "private"),
              (V = "icon-filled-lock-closed"),
              (z = D(h.TranslationNamespace.Creations, "Label.Private")));
        else {
          let e = q && T === p.CONTENT_UNRATED,
            t = q && w;
          ((_ = "Label.Private"),
            (B = "private"),
            (K = ""),
              ...
              (e
                ...
                : (O
                    ? C === r.SearchCreatorType.Group
                      ? ((_ = "Label.Community"), (B = "community"))
                      : ((_ = "Label.PublicFriendsUserTitle"), (B = "friends"))
                    : ((_ = "Label.Public"), (B = "public")),
                  (V = "icon-filled-globe-detailed"),
                  t
                    ? ((B = "select"),
                      (K = " (".concat(D(h.TranslationNamespace.Creations, "Label.Select"), ")")),
                      A &&
                        ((B = "selectAtRisk"),
                        (V = "icon-filled-triangle-exclamation"),
                        (H = "Warning")))
                    : S &&
                      ((B = "beta"),
                      (K = " (".concat(D(h.TranslationNamespace.Creations, "Label.Beta"), ")"))))),
            (z = "".concat(D(h.TranslationNamespace.Creations, _)).concat(K)),
            e
              ? ((y = D(h.TranslationNamespace.Creations, "Title.UnratedPublicExperience")),
                (I = D(h.TranslationNamespace.Creations, "Label.UnratedPublicExperience")))
              : t &&
                ((y = D(
                  h.TranslationNamespace.Creations,
        ...
        ((0, n.useEffect)(() => {
          J.current ||
            ...
            d.default.logImpressionEvent({
              ...
              parameters: { badgeType: B, ...(b && { universeId: b.toString() }) }
            }));
        }, [B, b, M]),
          (0, n.useEffect)(() => {
            if (M || !I) return;
  ...
  (e) => {
    ...
    let U = function (e) {
        let {
          ...
          { isSubmitting: _, errors: B, isValid: K, isValidating: V } = F,
          z = O("name"),
          [H, J] = (0, n.useState)(!1),
          W = (0, n.useCallback)(
            async (e) => {
      ...
      F = (0, i.withTranslation)(
        function (e) {
          let { creation: m, handleClose: f, updateItem: y } = e,
            ...
            }, [x, C, P, j, m.name, m.universeId, S, g, A, L, f]),
            q = (0, n.useCallback)(() => {
              D()
                .catch(() => {
                  L(x("Error.UnknownSubscriptionError"), !1);
        ...
        let { creation: r, removeItem: o } = e,
          ...
          N = (0, n.useCallback)(async () => {
            try {
              ...
              i
                ? (o(), q(m("Message.SubscriptionDeleted"), i))
                : q(m("Message.SubscriptionDeletionError"), !1);
            } catch (n) {
              let e = (0, R.getResponseFromError)(n),
                { errorKey: t } = await (0, O.default)(e);
              q(m(t) || t, !1);
            }
            g();
          }, [r.universeId, r.subscriptionProductId, g, o, q, m]),
          M = (0, n.useMemo)(() => {
            var e, n;
            return (0, t.jsxs)(t.Fragment, {
              children: [
          ...
          }, [g, F, L, S, r.name, r.subscriptionProductId, N, U.confirmedId, D, m]),
          G = (0, n.useCallback)(() => {
            (C(M), y());
          }, [C, M, y]);
        return (
...
//# debugId=69b60f46-1768-619c-3f58-ddcf8ac2e000
//# sourceMappingURL=1nzkq9eamlj1i.js.map
