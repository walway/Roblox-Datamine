...
!(function (e, r) {
  ...
  function n() {
    ...
    return function () {
      ...
      if (r)
        for (var o = 1; o <= 9; o++) {
          var s = e["$" + o];
          (s ? ((s = s.replace(n, "\\$&")), (a = a.replace(s, "(" + s + ")"))) : (a = "()" + a),
  ...
  function f(e) {
    ...
    ((e = Ze.call(t, "-")),
      (r = e.match(lr)) &&
        r.length > 1 &&
        (r.sort(), (e = e.replace(RegExp("(?:" + lr.source + ")+", "i"), Ze.call(r, "")))),
  ...
  function C(e, r) {
    switch (e.charAt(0)) {
      ...
      case "c":
        return (
          (r.weekday = ["numeric", void 0, "short", "long", "narrow", "short"][e.length - 1]),
          "{weekday}"
        );
      case "a":
      case "b":
  ...
  function Z(e) {
    ...
    for (i in r)
      r.hasOwnProperty(i) &&
        ((o = r[i]), (s = G(i, o)), s && (a.push(s), I(s) ? g.push(s) : A(s) && u.push(s)));
  ...
  function B(e, r) {
    if (xr[e] && xr[e][r]) {
      var t;
      return (
        (t = { originalPattern: xr[e][r], _: ge({}, e, r), extendedPattern: "{" + e + "}" }),
        ge(t, e, r),
        ge(t, "pattern12", "{" + e + "}"),
        ge(t, "pattern", "{" + e + "}"),
        t
  ...
  function ne(e, r) {
    ...
    var t = void 0,
      n = [r],
      a = r.split("-");
    for (a.length > 2 && 4 === a[1].length && Ge.call(n, a[0] + "-" + a[2]); (t = Be.call(n));)
    ...
    Ie(mr, "__applyLocaleSensitivePrototypes", {
      ...
      value: function () {
        ...
        for (var e in zr.Date)
          Me.call(zr.Date, e) &&
            Ie(Date.prototype, e, { writable: !0, configurable: !0, value: zr.Date[e] });
      }
    }),
...
IntlPolyfill.__addLocaleData({
  ...
  date: {
    ...
    formats: {
      ...
      timeFormats: { hmmsszzzz: "H:mm:ss (zzzz)", hmsz: "H:mm:ss z", hms: "H:mm:ss", hm: "H:mm" }
    },
    calendars: {
      buddhist: {
        months: {
  ...
  number: {
    ...
    currencies: { CAD: "CA$", ESP: "₧", EUR: "€", THB: "฿", USD: "$", VND: "₫", XPF: "CFPF" }
  }
...
IntlPolyfill.__addLocaleData({
  ...
  date: {
    ...
    formats: {
      ...
      timeFormats: { hmmsszzzz: "HH:mm:ss zzzz", hmsz: "HH:mm:ss z", hms: "HH:mm:ss", hm: "HH:mm" }
    },
    calendars: {
      buddhist: {
        months: {
  ...
  date: {
    ...
    calendars: {
      ...
      roc: {
        ...
        eras: { narrow: ["民國前", "民國"], short: ["民國前", "民國"], long: ["民國前", "民國"] },
        dayPeriods: { am: "上午", pm: "下午" }
      }
    }
  },
