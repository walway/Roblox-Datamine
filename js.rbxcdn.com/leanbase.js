  ...
  !(function (t) {
    ...
    var t,
      ...
      T = function () {
        ...
        if (!n.bindEvents) {
          if (
            (I.call(this), i.contentTouchScroll && R.call(this), D.call(this), i.mouseWheel.enable)
          ) {
            var r;
            t();
          }
      ...
      F = function (t, o, n, i, r) {
        function l(e) {
          ...
          return (
            ...
            V(t, v.toString(), { dir: f.dir[0], scrollEasing: x, dur: a, onComplete: _ }),
            e
              ? void (f.dir = !1)
              : (clearTimeout(f.step),
...
Roblox.CookieUpgrader.upgrade = function (name, options) {
  ...
  try {
    ...
    document.cookie =
      name + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/; domain=" + window.location.host;
...
Roblox.CookieUpgrader.getExpirationFromCookieValue = function getExpirationFromCookieValue(
  propertyName,
  originalCookieValue
) {
...
Roblox.ThumbnailMetrics = (function () {
  ...
  function logFinalThumbnailTime(duration, thumbnailType) {
    ...
    $.ajax({
      ...
      crossDomain: true,
      xhrFields: { withCredentials: true },
      data: { duration: duration, loadState: loadStates.complete, thumbnailType: thumbnailType }
    });
  }
...
Roblox.FixedUI = (function () {
  ...
  var my = { isMobile: isMobile, isHeaderFixed: isHeaderFixed, getWindowWidth: getWindowWidth };
  return my;
  ...
  $.modal.impl = {
    ...
    init: function (data, options) {
      ...
      if (typeof data === "object") {
        ...
        if (data.parent().parent().size() > 0) {
          data.before(
            $("<span></span>").attr("id", "simplemodal-placeholder").css({ display: "none" })
          );
    ...
    create: function (data) {
      ...
      s.d.container = $("<div></div>")
        ...
        .css(
          $.extend({ position: s.o.fixed ? "fixed" : "absolute" }, s.o.containerCss, {
            display: "none",
            zIndex: s.o.zIndex + 2
          })
        )
    ...
    setContainerDimensions: function () {
      ...
      var ch = s.d.origHeight
          ...
          : browser.opera
            ...
            : s.getVal(
                badIE ? s.d.container[0].currentStyle["height"] : s.d.container.css("height"),
                "h"
              ),
        cw = s.d.origWidth
          ? s.d.origWidth
          : browser.opera
            ? s.d.container.width()
            : s.getVal(
                badIE ? s.d.container[0].currentStyle["width"] : s.d.container.css("width"),
                "w"
              ),
...
$(function () {
  ...
  var GoogleAnalyticsEvents_FireEvent =
    (window.GoogleAnalyticsEvents && GoogleAnalyticsEvents.FireEvent) || function () {};
  ...
  function gotThumbnailData(data, options) {
    if (
      data.Final ||
      (data.data != null && data.data[0].state != null && data.data[0].state === "Completed")
    ) {
    ...
    return this.each(function () {
      ...
      imgWithSrc.one("load", function () {
        ...
        Roblox.ThumbnailMetrics &&
          Roblox.ThumbnailMetrics.logFinalThumbnailTime(imgLoadTime, "2dThumbnailOnLoad");
      });
      setTimeout(function () {
...
Roblox.AsyncGoogleOnScript = (function () {
  function googleGoalFire(age, gender) {
    GoogleAnalyticsEvents &&
      GoogleAnalyticsEvents.FireEvent(["Signup", "Signup - Roblox", age, gender]);
  }
