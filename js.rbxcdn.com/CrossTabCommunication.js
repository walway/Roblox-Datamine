!(function () {
  ...
  var u = function (e, t) {
    ...
    q = function () {
      (O("Declaring myself as the master ".concat(x)),
        (x = P),
        (h = !0),
        v(p.masterId, x),
        localStorage.removeItem(p.electionInProgress),
        k(!0),
        l()(window)
          .unbind("unload.".concat(y))
          .bind("unload.".concat(y), function () {
    ...
    E = function () {
      ...
      ((x = ""),
        e
          ? (O("Election already in progress"),
            window.setTimeout(function () {
              (0 === x.length ? q() : x !== P && k(!1), j());
            }, A))
          : (O("Election not in progress"),
            localStorage.setItem(p.electionInProgress, L()),
            0 === x.length ? q() : x !== P && k(!1),
            j()));
    },
    _ = function () {
      (O("Checking if Master still active"),
        !(!0 === h || Date.now() - w <= 2500) &&
          ((I = ""),
          v(p.masterIdRequest, "q"),
          window.setTimeout(function () {
            if (0 === I.length) {
    ...
    K = function () {
      (O("Binding to events"),
        g(p.masterIdRequest, y, function (e) {
          !0 === h &&
            "q" === e &&
            (O("Query Received - Confirming Still Master"),
            v(p.masterIdResponse, P),
            localStorage.setItem(p.masterLastResponseTime, L()));
        }),
        ...
        g(p.masterIdResponse, y, function (e) {
          e
            ? (O("Master Responded to Query"), (w = Date.now()), (I = e), Q())
            : O("Master Responded to Query - no message");
        }));
    },
    N = function () {
      var e = localStorage.getItem(p.electionInProgress),
        t = parseInt(e, 10);
      (e && Date.now() - t > 500 && localStorage.removeItem(p.electionInProgress),
    ...
    U = function () {
      ...
      ((w = t && 0 !== t.length ? parseInt(t, 10) : 0),
        e ? (e === P ? (h = !0) : w > 0 && Date.now() - w > 2e4 ? E() : _()) : E(),
        window.setTimeout(function () {
          N();
        }, 500),
        Q());
  ...
  var B = function () {
    ...
    $ = o,
    z = a;
  (u(["Roblox", "core-scripts", "util", "crossTabCommunication"], i),
    u(["Roblox", "CrossTabCommunication"], {
      PubSub: {
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("CrossTabCommunication");
