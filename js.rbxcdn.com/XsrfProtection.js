!(function () {
  ...
  var i = function (e, t) {
    ...
    m = function (e) {
      var t;
      return null === (t = null == e ? void 0 : e.split("?")[0]) || void 0 === t
        ? void 0
        : t.toLowerCase().endsWith(".aspx");
    },
    v = function (e) {
  ...
  function _(e) {
    ...
    if ("true" !== t.dataset.ajax) {
      if (!(
        b(t.getAttribute("method"), t.getAttribute("action")) &&
        x() &&
        0 === a()(t).children("input[name='".concat(A, "']")).length
      )) {
        t._submit();
        return;
      }
  ...
  (i(["Roblox", "core-scripts", "auth", "xsrfToken"], n),
    i(["Roblox", "XsrfToken"], n),
    i(["Roblox", "XsrfTokenFormInjector"], {
      initialize: function () {
        (window.addEventListener("submit", _, !0),
          (HTMLFormElement.prototype._submit = HTMLFormElement.prototype.submit),
          (HTMLFormElement.prototype.submit = _));
      }
    }),
    {
      initialize: function () {
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("XsrfProtection");
