!(function () {
  ...
  var i = function () {
      var e,
        n = null !== (e = window.location.hostname) && void 0 !== e ? e : "";
    ...
    l = function (e) {
      document.cookie = ""
        .concat(u, "=")
        .concat(encodeURIComponent(e), "; path=/; domain=.")
        .concat(i(), ";");
      var n = c();
      return "" === e && (null == n || "" === n)
        ? "You have reset back to master build"
        : n === e
          ? "Nice, you have set ".concat(e, " in cookie successfully!")
          : "Oh no, you have not set ".concat(
              e,
              " in cookie, could you try again ? or contact #web-frontend slack channel"
            );
    },
    d = function () {
      var e = new Map(),
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("ConfigureWebApps");
