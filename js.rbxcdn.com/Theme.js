(!(function () {
        ...
        : "undefined" != typeof global
          ...
          : "undefined" != typeof globalThis
            ...
            : "undefined" != typeof self
              ? self
              : {};
    e.SENTRY_RELEASE = { id: "51ef11c4dee9c5d7a7d8e261b03ec87a9b5a1f7f" };
    var t = new e.Error().stack;
    t &&
      ((e._sentryDebugIds = e._sentryDebugIds || {}),
      (e._sentryDebugIds[t] = "de1713b9-0c40-49fa-870e-569d17f4a96b"),
      (e._sentryDebugIdIdentifier = "sentry-dbid-de1713b9-0c40-49fa-870e-569d17f4a96b"));
  } catch (e) {}
})(),
  (function () {
    "use strict";
      ...
      var t,
        ...
        r =
          ...
          (t = document.cookie.split("; ").find(function (e) {
            ...
            ? void 0
            : t.split("=")[1];
      return null == r ? null : { name: e, value: decodeURIComponent(r) };
    };
    function i(e, t) {
      (null == t || t > e.length) && (t = e.length);
      for (var n = 0, r = Array(t); n < t; n++) r[n] = e[n];
    ...
    var c = ["light", "dark", "system"],
      ...
      p = function () {
        try {
          ...
          return (
            console.error("Failed to get mode data: ".concat(l(e, Error) ? e : String(e))),
            null
          );
        }
      },
      ...
      I = function (e) {
        ...
        if (void 0 !== r) {
          ...
          try {
            localStorage.setItem("theme", JSON.stringify({ version: 0, data: a }));
          } catch (e) {
            console.error(
              "Could not set mode. Local storage is likely full: ".concat(
                l(e, Error) ? e : String(e)
              )
            );
          }
        }
    ...
    try {
      var L,
        j,
        M =
          (null == (L = document.querySelector('meta[name="age-badge-control"]'))
            ? void 0
            : L.dataset.ageBadgeControl) === "Kids"
            ? "dark"
            : void 0;
      !(function (e) {
  ...
  window.Roblox &&
    ...
    window.Roblox.BundleDetector.bundleDetected("Theme"));
