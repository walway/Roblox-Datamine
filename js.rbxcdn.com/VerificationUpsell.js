          ...
          (a = function () {
            return (function () {
              var e = {
                  ...
                  651: function (e, t, n) {
                    ...
                    var h = function () {
                      ...
                      w = {
                        ...
                        "%JSON%":
                          "object" == ("undefined" == typeof JSON ? "undefined" : s(JSON))
                            ? JSON
                            : r,
                        "%Map%": "undefined" == typeof Map ? r : Map,
                        "%MapIteratorPrototype%":
                          "undefined" != typeof Map && g && b ? b(new Map()[Symbol.iterator]()) : r,
                        "%Math%": Math,
                        "%Number%": Number,
                        "%Object%": Object,
                        ...
                        "%SetIteratorPrototype%":
                          "undefined" != typeof Set && g && b ? b(new Set()[Symbol.iterator]()) : r,
                        "%SharedArrayBuffer%":
                      ...
                      for (var f = 1, p = !0; f < n.length; f += 1) {
                        ...
                        if (
                          ...
                          if (y && f + 1 >= n.length) {
                            var g = y(a, d);
                            a =
                              (p = !!g) && "get" in g && !("originalValue" in g.get) ? g.get : a[d];
                          } else ((p = k(a, d)), (a = a[d]));
                          p && !s && (w[i] = a);
                        }
                      }
                  ...
                  937: function (e, t, n) {
                    ...
                    e.exports = function e(t, r, o, c) {
                      ...
                      if ((void 0 === o && (o = 0), o >= R && R > 0 && "object" == s(t)))
                      ...
                      function J(t, n, r) {
                        if ((n && (c = O.call(c)).push(n), r)) {
                          var i = { depth: l.depth };
                          return (
                            K(l, "quoteStyle") && (i.quoteStyle = l.quoteStyle),
                            e(t, i, o + 1, c)
                          );
                        }
                        return e(t, l, o + 1, c);
                      ...
                      if (
                        ...
                        for (
                          var oe = "<" + w.call(String(t.nodeName)),
                            ie = t.attributes || [],
                            ae = 0;
                          ae < ie.length;
                          ae++
                        )
                          oe += " " + ie[ae].name + "=" + F(B(ie[ae].value), "double", l);
                        return (
                          (oe += ">"),
                          t.childNodes && t.childNodes.length && (oe += "..."),
                          oe + "</" + w.call(String(t.nodeName)) + ">"
                        );
                      }
                      if (q(t)) {
                      ...
                      if (
                        ...
                        var ce = ee(t, J);
                        return "cause" in Error.prototype || !("cause" in t) || N.call(t, "cause")
                          ? 0 === ce.length
                            ? "[" + String(t) + "]"
                            : "{ [" + String(t) + "] " + A.call(ce, ", ") + " }"
                          : "{ [" +
                              String(t) +
                              "] " +
                              A.call(E.call("[cause]: " + J(t.cause), ce), ", ") +
                              " }";
                      }
                      if ("object" == s(t) && m) {
                        if (L && "function" == typeof t[L] && D) return D(t, { depth: R - o });
                    ...
                    function G(e, t) {
                      ...
                      return F(
                        x.call(x.call(e, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, J),
                        "single",
                        t
                      );
                    }
                    ...
                    function ee(e, t) {
                      ...
                      if ("function" == typeof R)
                        for (var l = 0; l < a.length; l++)
                          N.call(e, a[l]) && r.push("[" + t(a[l]) + "]: " + t(e[a[l]], e));
                      return r;
                    }
                  },
                  647: function (e) {
                    ...
                    var r = n(402),
                      ...
                      m = function e(t, n, i, a, c, u, p, d, m, g, v, b, x, S, w, P, E, A) {
                        ...
                        if (
                          ...
                          return m
                            ? [
                                w(P ? n : m(n, y.encoder, E, "key", S)) +
                                  "=" +
                                  w(m(k, y.encoder, E, "value", S))
                              ]
                            : [w(n) + "=" + w(String(k))];
                        var T,
                          N = [];
                        ...
                        if ("comma" === i && l(k))
                          (P && m && (k = o.maybeMap(k, m)),
                            (T = [{ value: k.length > 0 ? k.join(",") || null : void 0 }]));
                        else if (l(g)) T = g;
                        else {
                          var M = Object.keys(k);
                          T = v ? M.sort(v) : M;
                      ...
                      var n,
                        ...
                        u = (function (e) {
                          ...
                          var r,
                            ...
                            s = y.filter;
                          if (
                            (("function" == typeof e.filter || l(e.filter)) && (s = e.filter),
                            (r =
                              e.arrayFormat in c
                                ? e.arrayFormat
                                : "indices" in e
                    ...
                    e.exports = {
                      ...
                      compact: function (e) {
                        for (
                          ...
                          for (
                            var o = t[r], a = o.obj[o.prop], c = Object.keys(a), l = 0;
                            l < c.length;
                            ++l
                          ) {
                            var u = c[l],
                      ...
                      encode: function (e, t, n, o, i) {
                        ...
                        for (var u = "", f = 0; f < c.length; f += l) {
                          for (
                            var p = c.length >= l ? c.slice(f, f + l) : c, d = [], y = 0;
                            y < p.length;
                            ++y
                          ) {
                                ...
                                : h < 2048
                                  ...
                                  : h < 55296 || h >= 57344
                                    ? (d[d.length] =
                                        ...
                                        a[128 | (63 & h)])
                                    : ((y += 1),
                                      (h = 65536 + (((1023 & h) << 10) | (1023 & p.charCodeAt(y)))),
                                      (d[d.length] =
                                        a[240 | (h >> 18)] +
                                        a[128 | ((h >> 12) & 63)] +
                                        a[128 | ((h >> 6) & 63)] +
                  ...
                  255: function (e, t, n) {
                    ...
                    e.exports = function (e, t) {
                      ...
                      return (
                        (r || l || !n) && (i ? o(e, "length", t, !0, !0) : o(e, "length", t)),
                        e
                      );
                    };
                  },
                    ...
                    e.exports = function () {
                      var e,
                        ...
                        r = {
                          ...
                          set: function (r, o) {
                            c && r && ("object" == s(r) || "function" == typeof r)
                              ? (e || (e = new c()), f(e, r, o))
                              : l
                                ? (t || (t = new l()), y(t, r, o))
                                : (n || (n = { key: {}, next: null }),
              ...
              ((n.n = function (e) {
                ...
                (n.g = (function () {
                  if ("object" == ("undefined" == typeof globalThis ? "undefined" : s(globalThis)))
                    return globalThis;
                  try {
              ...
              return (
                (function () {
                  ...
                  function x(e, t, n, r) {
                    ...
                    return (
                      (e.style.maxHeight = g(d)),
                      (e.style.maxWidth = g(y)),
                      ...
                      e.setAttribute("sandbox", v.concat(O).join(" ")),
                      (e.frameBorder = "0"),
                      (e.src = _ + "/widget" + D),
                      (e.onload = function () {}),
                      e
                            ...
                            case e.Fail:
                              null == i ||
                                i({
                                  ...
                                  fields:
                                    null !== (d = n.data.metadata.fields) && void 0 !== d
                                      ? d
                      ...
                      function e(e) {
                        ...
                        ((this._isLoading = !0),
                          ...
                          (this.onLoad = function () {
                            ...
                            ((p._isLoading = !1),
                              p.render(),
                              null === (t = (e = p.options).onLoad) || void 0 === t || t.call(e));
                          }),
                          ...
                          (this.onComplete = function (e) {
                            ...
                            ((p._isOpen = !1),
                              p.render(),
                              null === (n = (t = p.options).onComplete) ||
                                void 0 === n ||
                                n.call(t, { inquiryId: r, status: o, fields: i }));
                          }),
                          ...
                          (this.unsubscribeFromEvents = P(this.containerId, {
                            ...
                            templateId:
                              null !== (l = this.options.templateId) && void 0 !== l ? l : null,
                            templateVersionId:
    ...
    (function () {
      ...
      var h = function () {
        ...
        b =
          ...
          "object" === ("undefined" == typeof document ? "undefined" : v(document)) &&
          9 === document.nodeType;
      function x(e, t) {
      ...
      var T = /([[\].#*$><+~=|^:(),"'`\s])/g,
        ...
        D = (function (e) {
          function t(t, n, r) {
            ...
            return (
              i
                ? (o.selectorText = i)
                : !1 !== a && ((o.id = c(P(P(o)), s)), (o.selectorText = "." + M(o.id))),
              o
            );
          }
          w(t, e);
        ...
        K = (function () {
          function e(e, t, n) {
            ...
            var o = n.scoped,
              i = n.sheet,
              a = n.generateId;
            for (var s in ((this.id = !1 === o ? this.name : M(a(this, i))),
            (this.rules = new ue(u({}, n, { parent: this }))),
            t))
              this.rules.add(s, t[s], u({}, n, { parent: this }));
            this.rules.process();
          }
          return (
            ...
            (e.prototype.toString = function (e) {
              ...
              if (Array.isArray(this.style)) {
                for (var n = "", r = 0; r < this.style.length; r++)
                  ((n += I(this.at, this.style[r])), this.style[r + 1] && (n += t));
                return n;
              }
        ...
        ie = { "@charset": !0, "@import": !0, "@namespace": !0 },
        ae = {
          onCreateRule: function (e, t, n) {
          ...
          return (
            (t.add = function (e, t, n) {
              ...
              (e in this.raw && (p = e + "-d" + this.counter++),
                (this.raw[p] = t),
                p in this.classes && (f.selector = "." + M(this.classes[p])));
              var d = O(p, t, f);
              if (!d) return null;
              this.register(d);
            ...
            (t.replace = function (e, t, n) {
              ...
              r && this.remove(r);
              var i = n;
              return (-1 !== o && (i = u({}, n, { index: o })), this.add(e, t, i));
            }),
            (t.get = function (e) {
              return this.map[e];
            }),
            ...
            (t.register = function (e) {
              ((this.map[e.key] = e),
                e instanceof D
                  ...
                  : e instanceof K && this.keyframes && (this.keyframes[e.name] = e.id));
            }),
            (t.unregister = function (e) {
              (delete this.map[e.key],
                e instanceof D
                  ? (delete this.map[e.selector], delete this.classes[e.key])
                  : e instanceof K && delete this.keyframes[e.name]);
            }),
            (t.update = function () {
              var e, t, n;
              if (
      ...
      var Oe = be(function () {
        ...
        Re = (function () {
          function e(e) {
            ((this.getPropertyValue = xe),
              (this.setProperty = Se),
              (this.removeProperty = we),
              (this.setSelector = Pe),
            ...
            (t.insertRule = function (e, t, n) {
              if ((void 0 === n && (n = this.element.sheet), e.rules)) {
                ...
                if ("conditional" === e.type || "keyframes" === e.type) {
                  var i = Ce(n, t);
                  if (!1 === (o = ke(n, r.toString({ children: !1 }), i))) return !1;
        ...
        Ie = (function () {
          function e(e) {
            ...
            for (var t = 0; t < se.length; t++) this.plugins.use(se[t], { queue: "internal" });
            this.setup(e);
          }
          var t = e.prototype;
          return (
            ...
            (t.createRule = function (e, t, n) {
              ...
              var r = u({}, n, { name: e, jss: this, Renderer: this.options.Renderer });
      ...
      var Ve = Date.now(),
        ...
        Ye = /\s*,\s*/g;
      function Ze(e, t) {
        for (var n = e.split(Ye), r = "", o = 0; o < n.length; o++)
              ...
              "style" === e.type &&
                ...
                ((function (e, t) {
                  var n = e.options,
                    ...
                    o = r ? r[$e] : null;
                  if (o) {
                    for (var i in o) t.addRule(i, o[i], u({}, n, { selector: Ze(i, e.selector) }));
                    delete r[$e];
                  }
                })(e, t),
                (function (e, t) {
                  ...
                  for (var o in r)
                    if ("@" === o[0] && o.substr(0, 7) === $e) {
                      ...
                      (t.addRule(i, r[o], u({}, n, { selector: i })), delete r[o]);
                    }
                })(e, t));
            }
          };
      ...
      var nt = function () {
          ...
          function n(e, t, n) {
            ...
            r = void 0 === r ? 1 : r + 1;
            var o = u({}, e.options, { nestingLevel: r, index: t.indexOf(e) + 1 });
              ...
              for (var f in r) {
                ...
                if (p || d) {
                  if (((a = n(c, l, a)), p)) {
                    ...
                    var h = c.key + "-" + f;
                    "replaceRule" in l
                      ? l.replaceRule(h, r[f], u({}, a, { selector: y }))
                      : l.addRule(h, r[f], u({}, a, { selector: y }));
                  } else d && l.addRule(f, {}, a).addRule(c.key, r[f], { selector: c.selector });
                  delete r[f];
                }
              }
              return r;
        ...
        return (
          e.fallbacks &&
            (Array.isArray(e.fallbacks)
              ? (t.fallbacks = e.fallbacks.map(ct))
              : (t.fallbacks = ct(e.fallbacks))),
          t
        );
      }
      var lt = function () {
      ...
      function ht(e, t, n) {
        if (null == t) return t;
        if (Array.isArray(t)) for (var r = 0; r < t.length; r++) t[r] = ht(e, t[r], n);
        else if ("object" == typeof t)
          if ("fallbacks" === e) for (var o in t) t[o] = ht(o, t[o], n);
          else for (var i in t) t[i] = ht(e + "-" + i, t[i], n);
      ...
      if (b) {
        ...
        ("Webkit" === xt && "msHyphens" in Ot && ((xt = "ms"), (St = At.ms), (Pt = "edge")),
          "Webkit" === xt && "-apple-trailing-word" in Ot && (wt = "apple"));
      }
      var Ct = xt,
        Rt = St,
        jt = wt,
      ...
      var Ft,
        ...
        Ht = {
          ...
          supportedProperty: function (e) {
            return (
              "writing-mode" === e &&
              ("Webkit" === Ct || ("ms" === Ct && "edge" !== It) ? Rt + e : e)
            );
          }
        },
        Kt = {
          ...
          supportedProperty: function (e) {
            return (
              "user-select" === e && ("Moz" === Ct || "ms" === Ct || "apple" === jt ? Rt + e : e)
            );
          }
        },
        $t = {
          supportedProperty: function (e, t) {
            return (
              !!/^break-/.test(e) &&
              ("Webkit" === Ct
                ? "WebkitColumn" + Lt(e) in t && Rt + "column-" + e
                : "Moz" === Ct && "page" + Lt(e) in t && "page-" + e)
            );
          }
        },
        zt = {
        ...
        rn = {
          supportedProperty: function (e, t, n) {
            ...
            if (tn.indexOf(e) > -1) {
              ...
              if (!r) return !1;
              for (var i = 0; i < o.length; i++) if (!(Ct + Lt(o[0]) in t)) return !1;
              return o.map(nn);
            }
            return !1;
          }
      ...
      function gn(e, t) {
        ...
        if (yn[e]) n = n.replace(hn, mn);
          ...
          "" === pn.style[e] &&
          ("-ms-flex" === (n = Rt + n) && (pn.style[e] = "-ms-flexbox"),
          (pn.style[e] = n),
          "" === pn.style[e])
        )
          return ((dn[r] = !1), !1);
        ...
        return (
          On(e) &&
            ...
            Object.keys(t).forEach(function (o) {
              "__proto__" !== o &&
                (On(t[o]) && o in e ? (r[o] = kn(e[o], t[o], n)) : (r[o] = t[o]));
            }),
          r
        );
      }
      ...
      function Rn(e, t) {
        ...
        if (!o.disableGeneration) {
          ...
          if (0 === s.refs) {
            ...
            var p = i.create(r, a);
            (f ||
              ((f = o.jss.createStyleSheet(p, u({ link: !1 }, c))).attach(),
              o.sheetsCache && Ue.set(o.sheetsCache, i, r, f)),
              l && l.add(f),
              (s.staticSheet = f),
              (s.dynamicStyles = Me(p)));
          }
          if (s.dynamicStyles) {
            var d = o.jss.createStyleSheet(s.dynamicStyles, u({ link: !0 }, c));
            (d.update(t),
              d.attach(),
              (n.dynamicSheet = d),
              (n.classes = _e({ baseClasses: s.staticSheet.classes, newClasses: d.classes })),
              l && l.add(d));
      ...
      function jn(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          f = n || o || "makeStyles";
        l.options = { index: (En += 1), name: n, meta: f, classNamePrefix: f };
        return function () {
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            t = Fe() || s,
          ...
          (!(function (e, t) {
            ...
            function () {
              var r = { name: n, state: {}, stylesCreator: l, stylesOptions: o, theme: t };
              return (
                Rn(r, e),
                (f.current = !1),
                (a.current = r),
          ...
          return function (n) {
            ...
            var l = s,
              f = jn(
                e,
                u(
                  { defaultTheme: o, Component: n, name: s || n.displayName, classNamePrefix: l },
                  c
                )
              ),
                  ...
                  ("string" == typeof s || a) &&
                    ...
                    s &&
                      (y = (function (e) {
                        ...
                        return r;
                      })({ theme: i, name: s, props: l })),
                    a && !y.theme && (y.theme = i)),
                  r().createElement(n, u({ ref: c || t, classes: d }, y))
                );
              });
            return (g()(d, n), d);
          };
            ...
            gutters: function () {
              ...
              return (
                ...
                u(
                  ...
                  n,
                  Nn({}, e.up("sm"), u({ paddingLeft: t(3), paddingRight: t(3) }, n[e.up("sm")]))
                )
              );
            },
            toolbar:
              ((r = { minHeight: 56 }),
              Nn(r, "".concat(e.up("xs"), " and (orientation: landscape)"), { minHeight: 48 }),
      ...
      function Jn(e, t) {
        if (((e = Kn(e)), (t = Hn(t)), -1 !== e.type.indexOf("hsl")))
      ...
      var Yn = {
          ...
          background: { paper: Dn.white, default: Un[50] },
          action: {
      ...
      function Qn(e, t, n, r) {
        ...
        e[t] ||
          (e.hasOwnProperty(n)
            ...
            : "light" === t
              ? (e.light = Jn(e.main, o))
              : "dark" === t && (e.dark = Gn(e.main, i)));
      }
      function Xn(e) {
        var t = e.primary,
          n = void 0 === t ? { light: Ln[300], main: Ln[500], dark: Ln[700] } : t,
          r = e.secondary,
          o = void 0 === r ? { light: Fn.A200, main: Fn.A400, dark: Fn.A700 } : r,
          i = e.error,
          a = void 0 === i ? { light: Bn[300], main: Bn[500], dark: Bn[700] } : i,
          s = e.warning,
          c = void 0 === s ? { light: qn[300], main: qn[500], dark: qn[700] } : s,
          l = e.info,
          f = void 0 === l ? { light: Vn[300], main: Vn[500], dark: Vn[700] } : l,
          d = e.success,
          y = void 0 === d ? { light: Wn[300], main: Wn[500], dark: Wn[700] } : d,
          h = e.type,
          m = void 0 === h ? "light" : h,
        ...
        var P = function (e) {
            ...
            if ((!(e = u({}, e)).main && e[t] && (e.main = e[t]), !e.main))
              throw new Error(_n(4, t));
      ...
      function or(e, t) {
        ...
        var w = a / 14,
          ...
          E = function (e, t, n, r, i) {
            return u(
              { fontFamily: o, fontWeight: e, fontSize: P(t), lineHeight: n },
              o === rr ? { letterSpacing: "".concat(er(r / t), "em") } : {},
              i,
              b
            );
          },
          A = {
            ...
            subtitle2: E(y, 14, 1.57, 0.1),
            body1: E(f, 16, 1.5, 0.15),
            body2: E(f, 14, 1.43, 0.15),
            button: E(y, 14, 1.75, 0.4, nr),
      ...
      var ar = [
          "none",
          ir(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0),
          ir(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0),
          ir(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0),
          ir(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0),
          ir(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0),
          ir(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0),
          ir(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1),
          ir(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2),
          ir(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2),
          ir(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3),
          ir(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3),
          ir(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4),
          ir(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4),
          ir(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4),
          ir(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5),
          ir(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5),
          ir(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5),
          ir(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6),
          ir(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6),
          ir(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7),
          ir(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7),
          ir(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7),
          ir(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8),
          ir(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)
        ],
        sr = { borderRadius: 4 };
      function cr(e, t) {
        return (
      ...
      var lr = { xs: 0, sm: 600, md: 960, lg: 1280, xl: 1920 },
        ur = {
          keys: ["xs", "sm", "md", "lg", "xl"],
          up: function (e) {
      ...
      var fr = function (e, t) {
        return t ? kn(e, t, { clone: !1 }) : e;
      };
      var pr = { m: "margin", p: "padding" },
        dr = {
          t: "Top",
          r: "Right",
          b: "Bottom",
          ...
          create: function () {
            ...
            return (Array.isArray(e) ? e : [e])
              .map(function (e) {
                return ""
                  .concat(e, " ")
                  .concat("string" == typeof r ? r : wr(r), " ")
                  .concat(i, " ")
                  .concat("string" == typeof s ? s : wr(s));
              })
              .join(",");
          },
      ...
      function Ar() {
        for (
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            c = e.typography,
            l = void 0 === c ? {} : c,
            f = p(e, ["breakpoints", "mixins", "palette", "spacing", "typography"]),
            d = Xn(a),
            y = (function (e) {
              var t = e.values,
              ...
              function l(e, t) {
                ...
                return r === Tn.length - 1
                  ...
                  : "@media (min-width:"
                      ...
                      "(max-width:"
                        .concat(
                          (-1 !== r && "number" == typeof n[Tn[r + 1]] ? n[Tn[r + 1]] : t) - a / 100
                        )
                        .concat(o, ")");
              }
              return u(
      ...
      var Or = Ar();
      var kr = function (e, t) {
        return In(e, u({ defaultTheme: Or }, t));
      };
      function Cr(e) {
      ...
      var Rr = 44,
        jr = t.forwardRef(function (e, n) {
          ...
          if ("determinate" === x || "static" === x) {
            ...
            ((w.strokeDasharray = A.toFixed(3)),
              (E["aria-valuenow"] = Math.round(v)),
              (w.strokeDashoffset = "".concat((((100 - v) / 100) * A).toFixed(3), "px")),
            ...
            u(
              {
                className: h(
                  r.root,
                  o,
                  "inherit" !== a && r["color".concat(Cr(a))],
                  { determinate: r.determinate, indeterminate: r.indeterminate, static: r.static }[
                    x
                  ]
                ),
                style: u({ width: f, height: f }, P, d),
                ref: n,
                role: "progressbar"
              },
              E,
      ...
      var qr = { isOpen: !0 },
        ...
        Wr = function (e, t) {
          return t.type === _r.CLOSE_AGE_ESTIMATION_PROMPT_MODAL
            ? Fr(Fr({}, e), {}, { isOpen: !1 })
            : qr;
        },
        Hr = function (e) {
          ...
          return r().createElement(
            Vr.Provider,
            { value: { ageEstimationPromptModalState: i, dispatch: a } },
            n
          );
        };
      ...
      Hr.propTypes = { children: c().node.isRequired };
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (n = {
                          ...
                          url: "".concat(
                            $r,
                            "/age-verification-service/v1/persona-id-verification/start-verification"
                          )
                        }),
                        (r = { generateLink: !0, ageEstimation: !0 }),
                        (t.prev = 2),
                        (t.next = 5),
                        e.httpService.post(n, r)
                      );
                    case 5:
                    ...
                    case 10:
                      throw (
                        (t.prev = 10),
                        (t.t0 = t.catch(2)),
                        new Error("Error to start ID verification: ".concat(t.t0 || "unknown"))
                      );
                    case 13:
                    case "end":
                      return t.stop();
      ...
      function Zr(e) {
        ...
        return (
                ...
                if (null != e && e.sessionIdentifier)
                  var t = new (Mr().Client)({
                    ...
                    onComplete: function (e) {
                      ...
                      n({ type: _r.CLOSE_AGE_ESTIMATION_PROMPT_MODAL });
                    },
                    onCancel: function (e) {
                    ...
                    onError: function (e) {
                      (console.error(e), n({ type: _r.CLOSE_AGE_ESTIMATION_PROMPT_MODAL }));
                    }
                  });
                else a(!1);
              })
          ...
          r().createElement(
            ...
            r().createElement(Ir, { class: "spinner" })
          )
        );
      }
      Zr.propTypes = { translate: c().func.isRequired };
      var Qr = Zr,
        Xr = "verificationUpsell-container",
        eo = { common: ["Feature.AccountSettings"], feature: "Feature.VerificationUpsell" };
      function to(e) {
        var t = e.translate;
        return r().createElement(Hr, null, r().createElement(Qr, { translate: t }));
      }
      to.propTypes = { translate: c().func.isRequired };
      ...
      var Do = "Action.SendConfirmationEmail",
        ...
        oi = function (e, t) {
          switch (t.type) {
            case po:
              return Mo(Mo({}, e), {}, { userEmailInput: "" });
            case fo:
              return Mo(
                Mo({}, e),
                {},
                { origin: t.origin, skipCallback: t.skipCallback, closeCallback: t.closeCallback }
              );
            case ro:
              return Mo(
                Mo({}, e),
                {},
                { isEmailVerified: t.isEmailVerified, userEmail: t.userEmail }
              );
            case io:
              return Mo(Mo({}, e), {}, { pageName: t.pageName });
            case so:
              return Mo(Mo({}, e), {}, { errorMsg: t.errorMsg });
            case uo:
              return Mo(Mo({}, e), {}, { isEmailUpdating: t.isEmailUpdating });
            case co:
              return Mo(Mo({}, e), {}, { isEmailSent: !0 });
            case yo:
              return Mo(Mo({}, e), {}, { isEmailAdded: !0 });
            case lo:
              return Mo(Mo({}, e), {}, { isEmailSent: !1 });
            case ao:
              return e.pageName === mo
                ? Mo(Mo({}, e), {}, { userEmailInput: t.value, errorMsg: "" })
                : e;
            case oo:
              if (e.pageName === mo) {
                var n,
                  r = i.CurrentUser && !i.CurrentUser.isUnder13;
                n = r ? Qo : Xo;
                var o,
                  a,
                  s = Do,
        ...
        ii = function (e) {
          var n = e.children,
            ...
            i = o[0],
            a = o[1];
          return r().createElement(ri.Provider, { value: { emailUpsellState: i, dispatch: a } }, n);
        };
      function ai() {
        return (0, t.useContext)(ri);
      }
      ii.propTypes = { children: c().node.isRequired };
      ...
      function li(e) {
        var t = e.show,
          ...
          w = f.isEmailUpdating,
          P =
            null === si.authenticatedUser || void 0 === si.authenticatedUser
              ? void 0
              : si.authenticatedUser.isUnder13;
        return r().createElement(
          Tr.Modal,
          {
            show: t,
          ...
          r().createElement(
            ...
            r().createElement(
              ...
              r().createElement(Tr.Modal.Title, { id: "verification-upsell-modal-title" }, u(d))
            ),
            p === go
              ? r().createElement(
                  "button",
                  { type: "button", className: "close close-button", onClick: s },
                  r().createElement("span", { className: "icon-back" })
                )
              : r().createElement(
                  "button",
                  { type: "button", className: "close close-button", onClick: n },
                  r().createElement("span", { className: "icon-close" })
                )
          ),
          r().createElement(
            Tr.Modal.Body,
            null,
            r().createElement("div", { className: "email-verification-upsell-image" }),
            r().createElement(
              "p",
            ...
            p === mo &&
              ...
              r().createElement(
                ...
                r().createElement("a", { href: Eo, target: "_blank", rel: "noreferrer" }, u(Oo))
              )
          ),
          r().createElement(
            Tr.Modal.Footer,
            ...
            r().createElement(
              ...
              m &&
                r().createElement(
                  "button",
                  { type: "button", className: "change-email-button", onClick: i },
                  u(m)
                )
            )
          )
      ...
      var ui = li,
        ...
        mi = function () {
          return { retryable: !0, withCredentials: !0, url: "".concat(pi, "/v1/email") };
        },
        gi = {
          header: "alt_title",
          body: "alt_body",
        ...
        vi = function (e) {
          var t,
            n = null == e || null === (t = e.data) || void 0 === t ? void 0 : t.errors;
      ...
      var wi = function () {
          var t = { retryable: !0, withCredentials: !0, url: "".concat(pi, "/v1/email/verify") };
          return e.httpService.post(t).then(
            function () {
              return !0;
            },
            function (e) {
                  ...
                  switch ((t.prev = t.next)) {
                    ...
                    case 2:
                      return (
                        ...
                        t.abrupt(
                          "return",
                          e.httpService.get(o).then(
                            function (e) {
                              var t = e.data;
                              if (
                                null == t ||
                                !t.emailAddress ||
                                (n.requireVerification && !t.verified)
                              ) {
                                var o = new CustomEvent("OpenVerificationModal", {
                                  detail: {
                                    ...
                                    experimentParameters:
                                      null == n ? void 0 : n.experimentParameters,
                    ...
                    case 0:
                      return (
                        (n = {
                          ...
                          url: "".concat(
                            yi,
                            "/product-experimentation-platform/v1/projects/1/layers/Website.Logout.ContactMethodModal/values"
                          )
                        }),
                        (r = { parameters: Object.values(gi).join(",") }),
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 2:
                        if (
                          ((o = e.sent),
                          null !== (n = o.data) && void 0 !== n && n.IsEmailUpsellAtLogoutEnabled)
                        ) {
                          e.next = 5;
                          break;
                        }
                        ...
                        return (
                          ...
                          e.abrupt(
                            ...
                            Pi({
                              origin: a,
                              experimentParameters:
                                null === (r = i) || void 0 === r ? void 0 : r.data,
                              skipCallback: t
                            })
                          )
                        );
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 10:
                        ...
                        try {
                          fi.eventStreamService.sendEventWithTarget(
                            "authClientError",
                            "logoutUpsell",
                      ...
                      case 13:
                        ((i = new CustomEvent("OpenVerificationModal", {
                          detail: {
                            ...
                            experimentParameters:
                              null === (n = o) || void 0 === n ? void 0 : n.data,
                            settingsUiPolicy: r
                          }
                        })),
        ...
        Ci = function (e) {
          return Pi({ origin: xo, closeCallback: e });
        },
        Ri = function (e) {
          var t = e.indexOf("@"),
            n = e.substring(0, 1);
      ...
      var Zi = function (e, t) {
            ...
            e.type,
            e.context,
            Ji(Ji({}, e.params), {}, { origin: t.origin, section: t.section })
          );
        },
        Qi = function (e, t) {
          var n = Ji({}, e);
          return ((n.params = Ji(Ji({}, n.params), {}, { errorCode: t })), n);
        },
        ...
        ta = {
          ...
          dismissModal: {
            ...
            type: Xi.modalAction,
            context: ea,
            params: { aType: "dismissed" }
          },
          touchEmail: {
            name: "touchEmail",
            type: Xi.formInteraction,
            context: ea,
            params: { aType: "focus", field: "email" }
          },
          showError: {
            name: "showError",
            type: Xi.formInteraction,
            context: ea,
            params: { aType: "shown", field: "errorMessage" }
          },
          clickContinue: {
            name: "clickContinue",
            type: Xi.formInteraction,
          ...
          clickSendConfirmationEmail: {
            ...
            type: Xi.formInteraction,
            context: ea,
            params: { aType: "click", btn: "sendConfirmation" }
          },
          clickResendConfirmationEmail: {
            name: "clickResendConfirmationEmail",
            type: Xi.formInteraction,
            context: ea,
            params: { aType: "click", btn: "resendConfirmation" }
          },
          clickChangeEmail: {
            name: "clickChangeEmail",
            type: Xi.formInteraction,
            context: ea,
            params: { aType: "click", btn: "changeEmail" }
          },
          skipLogoutAnyway: {
            name: "skipLogoutAnyway",
            type: Xi.formInteraction,
            context: ea,
            params: { aType: "click", btn: "skipLogoutAnyway" }
          },
          skipPrepurchaseVerification: {
            name: "skipPrepurchaseVerification",
            type: Xi.formInteraction,
            context: ea,
            params: { aType: "click", btn: "skipPrepurchaseVerification" }
          }
        };
      function na(e, t) {
        return (
      ...
      function sa(n) {
        ...
        function f() {
          ...
          switch (l.pageName) {
            case ho:
              (Zi(ta.clickResendConfirmationEmail, { origin: l.origin, section: o }),
                wi().then(function (e) {
                  if (!0 !== e) {
                    u({ type: so, errorMsg: oa });
                    var t = Qi(ta.showError, e);
                    Zi(t, { origin: l.origin, section: o });
                  } else
                    (u({ type: co }),
                      setTimeout(function () {
                        u({ type: lo });
            ...
            case mo:
              if (
                (Zi(ta.clickContinue, { origin: l.origin, section: o }),
                (r = l.userEmailInput),
                /\S+@\S+\.\S+/.test(r))
              )
                (Zi(ta.clickSendConfirmationEmail, { origin: l.origin, section: o }),
                  u({ type: uo, isEmailUpdating: !0 }),
                  ((t = { emailAddress: l.userEmailInput }),
                  (n = mi()),
                  e.httpService.post(n, t).then(
                    function () {
                      return !0;
                    },
                    function (e) {
                    ...
                    if (!0 !== e) {
                      var t = (function (e) {
                        ...
                        n = Qi(ta.showError, e);
                      (Zi(n, { origin: l.origin, section: o }),
                        u({ type: so, errorMsg: t }),
                        u({ type: uo, isEmailUpdating: !1 }));
                    } else
                      (u({ type: ro, isEmailVerified: !1, userEmail: Ri(l.userEmailInput) }),
                        u({ type: po }),
                        u({ type: io, pageName: ho }),
                        u({ type: oo }),
                        u({ type: uo, isEmailUpdating: !1 }),
                        u({ type: yo }));
                  }),
                ...
                (Zi(i, { origin: l.origin, section: o }), u({ type: so, errorMsg: ia }));
              }
          }
        }
        return (
          (0, t.useEffect)(
            function () {
              l.pageName && Zi(ta.showModal, { origin: l.origin, section: qi(l.pageName) });
            },
            [l.pageName]
          ),
          (0, t.useEffect)(function () {
            window.addEventListener(
              ...
              function (e) {
                ...
                (u({ type: io, pageName: r }),
                  u({
                    type: oo,
                    experimentParameters:
                      null === (t = e.detail) || void 0 === t ? void 0 : t.experimentParameters,
                    settingsUiPolicy:
                      null === (n = e.detail) || void 0 === n ? void 0 : n.settingsUiPolicy
                  }));
              },
              !1
            );
          ...
          r().createElement(
            ...
            r().createElement(ui, {
              ...
              onHide: function () {
                return (
                  Zi(ta.dismissModal, { origin: l.origin, section: qi(l.pageName) }),
                  u({ type: po }),
                  l.closeCallback && l.closeCallback(l.isEmailAdded),
                  void s(!1)
                );
              },
              ...
              onSecondaryAction: function () {
                return (function () {
                  ...
                  switch (l.pageName) {
                    case ho:
                      (Zi(ta.clickChangeEmail, { origin: l.origin, section: e }),
                        u({ type: io, pageName: mo }),
                        u({ type: oo }));
                      break;
                    case mo:
                      (l.skipCallback &&
                        (Zi(
                          l.origin === vo ? ta.skipLogoutAnyway : ta.skipPrepurchaseVerification,
                          { origin: l.origin, section: e }
                        ),
                        l.skipCallback()),
                        u({ type: po }),
                        s(!1));
              ...
              onInputFocus: function () {
                Zi(ta.touchEmail, { origin: l.origin, section: qi(l.pageName) });
              },
              onInputChange: function (e) {
                return (function (e) {
                  u({ type: ao, pageName: mo, value: e });
                })(e);
              },
              onKeyDown: function (e) {
                return (function (e) {
              ...
              onBackAction: function () {
                return (u({ type: io, pageName: mo }), void u({ type: oo }));
              },
              translate: o
            })
          )
      ...
      sa.propTypes = { translate: c().func.isRequired };
      var ca = sa;
      function la(e) {
        var t = e.translate;
        return r().createElement(ii, null, r().createElement(ca, { translate: t }));
      }
      la.propTypes = { translate: c().func.isRequired };
      ...
      var va = { isOpen: !0, origin: "", section: "" },
        ba = (0, t.createContext)(va),
        xa = function (e, t) {
          switch (t.type) {
            case fa:
              return ma(ma({}, e), {}, { isOpen: !1 });
            case pa:
              return ma(ma({}, e), {}, { origin: t.origin, section: t.section });
            default:
              return va;
          }
        },
        Sa = function (e) {
          ...
          return r().createElement(
            ba.Provider,
            { value: { contactMethodPromptModalState: i, dispatch: a } },
            n
          );
        };
      Sa.propTypes = { children: c().node.isRequired };
      var wa = "Action.Done",
        Pa = "Action.Continue",
      ...
      function ds(e) {
        var t = e.translate,
          ...
          h = function (e) {
            e ||
              null === i.UpsellService ||
              void 0 === i.UpsellService ||
              i.UpsellService.renderContactMethodPromptModal({
                origin: o.origin,
                section: o.section
              });
          };
        return r().createElement(
          ...
          r().createElement(
            ...
            r().createElement(
              "div",
              { className: "verification-upsell-title-container" },
              r().createElement(Tr.Modal.Title, { id: "verification-upsell-modal-title" }, t(a))
            )
          ),
          r().createElement(
            Tr.Modal.Body,
            ...
            r().createElement(
              ...
              r().createElement(
                ...
                r().createElement("div", { className: "font-header-2" }, t(s))
              ),
              r().createElement("div", { className: "text-description" }, t(c))
            ),
            r().createElement("span", { className: "icon-spot-success-xl verification-grid-icon" }),
            r().createElement(
              "div",
              null,
              r().createElement(
                "div",
                { className: "verification-upsell-title-container page-title" },
                r().createElement("div", { className: "font-header-2" }, t(l))
              ),
              r().createElement("div", { className: "text-description" }, t(u))
            )
          ),
          r().createElement(
            Tr.Modal.Footer,
            ...
            r().createElement(
              "button",
              {
                ...
                onClick: function () {
                  (n(),
                    Zi(fs.contactMethodPromptPhoneClicked, {
                      origin: o.origin,
                      section: o.section
                    }),
                    null === i.UpsellService ||
                      void 0 === i.UpsellService ||
                      i.UpsellService.renderPhoneUpsell({ onClose: h }));
                }
              },
              t(f)
            ),
            r().createElement(
              "button",
              {
                ...
                onClick: function () {
                  (n(),
                    Zi(fs.contactMethodPromptEmailClicked, {
                      origin: o.origin,
                      section: o.section
                    }),
                    null === i.UpsellService ||
                      void 0 === i.UpsellService ||
                      i.UpsellService.renderEmailUpsell(h));
                }
              },
              t(y)
            ),
      ...
      ds.propTypes = { translate: c().func.isRequired, onHide: c().func.isRequired };
      var ys = ds;
      function hs(e) {
        var n = e.translate,
          o = e.origin,
          ...
          c = a.dispatch,
          l = function () {
            (Zi(fs.contactMethodPromptDismissed, { origin: s.origin, section: s.section }),
              c({ type: fa }));
          };
        return (
          (0, t.useEffect)(function () {
            c({ type: pa, origin: o, section: i });
          }, []),
          (0, t.useEffect)(
            function () {
              s.origin &&
                s.section &&
                Zi(fs.contactMethodPromptShown, { origin: s.origin, section: s.section });
            },
            [s.origin, s.section]
          ),
          r().createElement(
            ...
            r().createElement(ys, { translate: n, onHide: l })
          )
        );
      }
      hs.propTypes = {
      ...
      function gs(e) {
        ...
        return r().createElement(
          Sa,
          null,
          r().createElement(ms, { translate: t, origin: n, section: o })
        );
      }
      gs.propTypes = {
        translate: c().func.isRequired,
      ...
      var vs = (0, l.withTranslations)(gs, eo),
        ...
        Xs = {
          ...
          addPhonePrefixPressed: {
            ...
            context: Qs,
            params: { aType: "focus", field: "countryPrefix" }
          },
          addPhonePhoneNumberPressed: {
            name: "addPhonePhoneNumberPressed",
            type: Zs.formInteraction,
            context: Qs,
            params: { aType: "focus", field: "phoneNumber" }
          },
          ...
          verifyPhoneChangePhoneNumberPressed: {
            ...
            type: Zs.formInteraction,
            context: Qs,
            params: { btn: "changePhoneNumber" }
          },
          verifyPhoneCodeFieldPressed: {
            name: "verifyPhoneCodeFieldPressed",
            type: Zs.formInteraction,
            context: Qs,
            params: { aType: "focus", field: "verificationCode" }
          },
      ...
      var ic = {
        ...
        sc = function (e, t) {
          ...
          switch (t.type) {
            case Ss:
              return rc(rc({}, e), {}, { phone: t.phone, errorMessage: "" });
            case ws:
              return rc(
                rc({}, e),
                {},
                { phonePrefixPickerIndex: t.phonePrefixPickerIndex, errorMessage: "" }
              );
            case xs:
              return rc(rc({}, e), {}, { errorMessage: t.errorMessage });
            case Ps:
              return rc(rc({}, e), {}, { errorMessage: "", pageName: t.pageName });
            case Es:
              return rc(rc({}, e), {}, { isPhoneVerified: t.isPhoneVerified });
            case ks:
              return rc(
                rc({}, e),
                {},
                {
                  shouldPrefillAffirmativeDiscoverabilityConsent:
                    null !==
                      (n = null == t ? void 0 : t.shouldPrefillAffirmativeDiscoverabilityConsent) &&
                    void 0 !== n &&
                    n
                }
              );
            case As:
              return rc(rc({}, e), {}, { phonePrefixOptionsList: t.phonePrefixOptionsList });
            case Os:
              return rc(rc({}, e), {}, { origin: t.origin });
            case bs:
              return rc(rc({}, ic), {}, { isOpen: !1, errorMessage: "" });
            default:
              return ic;
          }
        },
        cc = function (e) {
          var n = e.children,
            ...
            i = o[0],
            a = o[1];
          return r().createElement(ac.Provider, { value: { phoneUpsellState: i, dispatch: a } }, n);
        };
      function lc() {
        return (0, t.useContext)(ac);
      }
      cc.propTypes = { children: c().node.isRequired };
      var uc = Cs,
        fc = function (t) {
          return e.httpService.get(t).then(
            function (e) {
              var t,
                n,
                r = e.data,
        ...
        dc = function (t) {
          var n = t.phone,
            r = t.prefix,
            o = t.countryCode,
            i = { retryable: !0, withCredentials: !0, url: "".concat(hi, "/v1/phone") },
            a = { countryCode: o, prefix: r, phone: n };
          return e.httpService.post(i, a);
        },
        yc = function () {
          var t = { code: arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "" },
            n = { retryable: !0, withCredentials: !0, url: "".concat(hi, "/v1/phone/verify") };
          return e.httpService.post(n, t);
        },
        hc = function (t) {
          var n = { retryable: !0, withCredentials: !0, url: "".concat(hi, "/v1/phone/resend") },
            r = t;
          return (
            r || (r = {}),
            e.httpService.post(n, r).then(
              function (e) {
                e.data;
                return !0;
              },
        ...
        mc = function () {
          var t = { retryable: !0, withCredentials: !0, url: "".concat(hi, "/v1/phone/delete") };
      ...
      Mc.propTypes = { translate: c().func.isRequired };
      var _c = Mc;
      ...
      function Uc(e) {
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return ((e.next = 4), pc());
                      case 4:
                        ((t = e.sent), c({ type: As, phonePrefixOptionsList: t }));
                      case 6:
                      case "end":
                        return e.stop();
                    }
        ...
        var v =
          null !== (n = null == d || null === (o = d[p]) || void 0 === o ? void 0 : o.prefix) &&
          void 0 !== n
            ? n
            : "";
        return r().createElement(
          ...
          r().createElement(
            ...
            r().createElement(
              "div",
              { id: "upsell-phonenumber", className: "phone-input-row" },
              r().createElement(
                "span",
                { className: "phone-prefix-wrapper" },
                r().createElement("div", { className: "phone-prefix-selected text" }, l(v)),
                r().createElement(
                  "select",
                  {
                    ...
                    onChange: function (e) {
                      return (function (e) {
                        ...
                        c({ type: ws, phonePrefixPickerIndex: t });
                      })(e);
                    },
                    onFocus: function () {
                      Zi(Xs.addPhonePrefixPressed, { origin: h, section: g });
                    },
                    value: p
                  },
                  d.map(function (e, t) {
                    return r().createElement(
                      "option",
                      { className: "prefix-option", value: t },
              ...
              r().createElement("input", {
                ...
                onChange: function (e) {
                  return c({ type: Ss, phone: e.target.value });
                },
                onFocus: function () {
                  Zi(Xs.addPhonePhoneNumberPressed, { origin: h, section: g });
                }
              })
            )
          )
      ...
      Uc.propTypes = { translate: c().func.isRequired };
      var Lc = Uc;
      ...
      function Qc(e) {
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (n = t.prefix),
                            (r = t.code),
                            Zi(Xs.addPhoneContinuePressed, { origin: v, section: A }),
                            (e.next = 5),
                            dc({ phone: y, prefix: n, countryCode: r })
                              .then(function () {
                                d({ type: Ps, pageName: zs });
                              })
                              .catch(function (e) {
                                var t = vi(e),
                                  n = Qi(Xs.phoneNumberModalErrorShown, t);
                                (Zi(n, { origin: v, section: A }),
                                  d({ type: xs, errorMessage: Ic(t) }));
                              })
                              .finally(function () {
                                S(!1);
                              })
        ...
        return r().createElement(
          ...
          r().createElement(
            ...
            r().createElement(
              "button",
              { type: "button", className: "close close-button", onClick: o },
              r().createElement("span", { className: "icon-close" })
            )
          ),
          r().createElement(
            ...
            r().createElement(
              ...
              i &&
                r().createElement(
                  ...
                  r().createElement(
                    ...
                    r().createElement("span", { className: "icon-warning-orange" }),
                    r().createElement(
                      "span",
              ...
              r().createElement(Lc, { translate: n }),
              r().createElement(
                "div",
                {
              ...
              r().createElement(_c, { translate: n })
            )
          ),
          r().createElement(
            Tr.Modal.Footer,
      ...
      function el(e) {
        ...
        return r().createElement(
          ...
          r().createElement(
            Tr.Modal.Body,
            null,
            r().createElement("div", { className: "phone-number-verification-upsell-image" }),
            r().createElement(
              "div",
              {
                className:
                  "verification-upsell-title-container phone-number-verification-success-page-title page-title"
              },
              r().createElement(Tr.Modal.Title, { id: "verification-upsell-modal-title" }, t(o))
            ),
            r().createElement(
              "div",
          ...
          r().createElement(
            ...
            r().createElement(
              "button",
              {
                ...
                className: "btn-cta-md btn-max-width phone-number-verify-button",
                onClick: function () {
                  (Zi(Xs.phoneAddedDonePressed, { origin: s, section: u }), n());
                }
              },
              t(l)
            )
      ...
      ((el.propTypes = {
        ...
        (el.defaultProps = { headingKey: _a, descriptionKey: Da }));
      var tl = el,
        nl = function (e, t, n, r) {
                ...
                return rl(this, function (e) {
                  switch (e.label) {
                    case 0:
                      return [
                        4,
                        i.AccessManagementUpsellV2Service.startAccessManagementUpsell({
      ...
      function yl(e) {
        var n = e.translate,
          ...
          p = s.pageName,
          d = s.origin,
          y = pl((0, t.useState)({ code: "", isReadyToSubmitCode: "" }), 2),
          h = y[0],
          m = y[1],
          g = Nc(p),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          (Zi(Xs.verifyPhoneContinuePressed, { origin: d, section: g }),
                          h.code.length === D)
                        ) {
                          e.next = 3;
                          break;
                      ...
                      case 3:
                        return (
                          P(!0),
                          c({ type: xs, errorMessage: "" }),
                          (e.prev = 5),
                          (e.next = 8),
                          yc(h.code)
                        );
                      case 8:
                        return (c({ type: Es, isPhoneVerified: !0 }), (e.next = 11), i());
                      case 11:
                        e.next = 20;
                        break;
                      case 13:
                        ((e.prev = 13),
                          ...
                          (t = vi(e.t0)),
                          (n = Tc(t)),
                          (r = Qi(Xs.phoneNumberModalErrorShown, t)),
                          Zi(r, { origin: d, section: g }),
                          c({ type: xs, errorMessage: n }));
                      case 20:
                        return (
                          (e.prev = 20),
                          m(cl(cl({}, h), {}, { isReadyToSubmitCode: !1 })),
                          P(!1),
                          e.finish(20)
                        );
                      case 24:
          ...
          r().createElement(
            ...
            r().createElement(
              ...
              r().createElement(
                "div",
                { className: "verification-upsell-title-container" },
                r().createElement(Tr.Modal.Title, { id: "verification-upsell-modal-title" }, n(k))
              ),
              r().createElement(
                "button",
                { type: "button", className: "close close-button", onClick: o },
            ...
            r().createElement(
              ...
              r().createElement(
                "button",
                {
                  ...
                  onClick: function () {
                    (Zi(Xs.verifyPhoneChangePhoneNumberPressed, { origin: d, section: g }),
                      c({ type: Ps, pageName: $s }));
                  }
                },
                n(C)
              ),
              ...
              r().createElement("input", {
                ...
                inputMode: "numeric",
                className: "".concat(
                  s.errorMessage ? "input-field-error" : "",
                ...
                onPaste: function (e) {
                  var t = (e.clipboardData || window.clipboardData).getData("text"),
                    n = al(t);
                  m({ code: n, isReadyToSubmitCode: !0 });
                },
                autoComplete: "one-time-code",
                placeholder: "000000",
                onKeyDown: function (e) {
                  e.key === _ && m(cl(cl({}, h), {}, { isReadyToSubmitCode: !0 }));
                },
                onFocus: function () {
                  Zi(Xs.verifyPhoneCodeFieldPressed, { origin: d, section: g });
                },
                value: h.code
              }),
              r().createElement(_c, { translate: n })
            ...
            r().createElement(
              ...
              r().createElement(
                "button",
                {
                  ...
                  onClick: function () {
                    m(cl(cl({}, h), {}, { isReadyToSubmitCode: !0 }));
                  }
                },
                n(R)
              ),
                ...
                ? 0 === b
                  ? r().createElement(
                      "button",
                      {
                        ...
                        disabled: w,
                        onClick: function () {
                          (Zi(Xs.verifyPhoneResendPressed, { origin: d, section: g }),
                            0 === b &&
                              (hc(),
                              (function () {
                                if (0 === b)
                  ...
                  : r().createElement(
                      "button",
                      {
                        type: "button",
                        className:
                          " btn-secondary-md btn-max-width phone-number-resent-button btn-max-width resend-button-disabled"
                      },
                      n(I),
                      r().createElement("span", null, U + b + L)
                    )
                : null
            )
          )
        ...
        return r().createElement(
          ...
          r().createElement(
            ...
            r().createElement(
              "div",
              { className: "verification-upsell-title-container" },
              r().createElement(Tr.Modal.Title, { id: "verification-upsell-modal-title" }, n(s))
            ),
            r().createElement(
              "button",
              { type: "button", className: "close close-button", onClick: i },
              r().createElement("span", { className: "icon-close" })
            )
          ),
          r().createElement(
      ...
      ((bl.propTypes = {
        ...
        (bl.defaultProps = { existingPhoneNumber: null }));
      var xl = bl,
        Sl = function () {
          var t = {
            retryable: !0,
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      return (
                        !0 ===
                          (null == (r = e.sent) ? void 0 : r.isDiscoverabilitySettingsEnabled) &&
                          !0 === (null == r ? void 0 : r.showDiscoverabilityUpsells) &&
                          ((t = Ys),
                          (n = !0 === (null == r ? void 0 : r.prefillDiscoverabilitySetting))),
                        e.abrupt("return", {
                          successPage: t,
      ...
      function Cl(e) {
        var n = e.translate,
          ...
          O = Nc(h.pageName),
          k = function () {
            (Zi(Xs.phoneNumberModalDismissed, { origin: h.origin, section: O }),
              o(h.isPhoneVerified),
              m({ type: bs }));
          },
          C = (function () {
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 12:
                          ((e.prev = 12),
                            (e.t0 = e.catch(1)),
                            console.error(
                              "Error from before success hook in phone verification: ".concat(e.t0),
                              e.t0
                            ));
                        case 15:
                          m({ type: Ps, pageName: v });
                        case 16:
                        case "end":
                          return e.stop();
                      }
        ...
        return (
          (0, t.useEffect)(
            function () {
              h.origin !== Di && Zi(Xs.phoneNumberModalShown, { origin: h.origin, section: O });
            },
            [h.pageName, h.origin]
          ),
          (0, t.useEffect)(function () {
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 2:
                          ((t = e.sent),
                            (n = t.successPage),
                            (r = t.shouldPrefillAffirmativeDiscoverabilityConsent),
                            m({ type: ks, shouldPrefillAffirmativeDiscoverabilityConsent: r }),
                            b(n));
                        case 7:
                        case "end":
                          return e.stop();
          ...
          r().createElement(
            ...
            (function () {
              switch (h.pageName) {
                ...
                case zs:
                  return r().createElement(hl, { translate: n, onHide: k, onVerify: C });
                case Gs:
                ...
                case Js:
                  return r().createElement(xl, { translate: n, existingPhoneNumber: a, onHide: k });
                case Ys:
                  return r().createElement(ol, { onHide: k, origin: i });
                default:
                  return r().createElement(Xc, { translate: n, onHide: k });
              }
            })()
          )
        );
      ...
      ((a().UpsellService = {
        renderEmailUpsell: function (t) {
          (0, e.ready)(function () {
            ...
            e &&
              ((0, o.unmountComponentAtNode)(e),
              (0, o.render)(r().createElement(ua, null), e),
              Ci(t));
          });
        },
        ...
        renderContactMethodPromptModal: function (t) {
          ...
          (0, e.ready)(function () {
            ...
            e &&
              ((0, o.unmountComponentAtNode)(e),
              (0, o.render)(r().createElement(vs, { origin: n, section: i }), e));
          });
        },
        ...
        (a().EmailVerificationService = {
          ...
          handleUserEmailUpsellAtBuyRobux: function (e) {
            return Pi({ origin: bo, skipCallback: e });
          },
          handleUserEmailUpsellOnHomePage: Ci,
          handleUserEmailVerificationRequiredByPurchaseWarning: function () {
            return Pi({ origin: wo, requireVerification: !0 });
          },
          handleUserEmailUpsellAtPremiumSubscription: function (e) {
            return Pi({ origin: So, skipCallback: e });
          },
          handleUserEmailVerificationRequiredByBan: function () {
            return Pi({ origin: Po, requireVerification: !0 });
          },
          openLogoutEmailUpsellModal: ki
        }),
        (0, e.ready)(function () {
          document.getElementById(Xr) &&
            (0, o.render)(r().createElement(ua, null), document.getElementById(Xr));
        }));
    })());
})();
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("VerificationUpsell");
