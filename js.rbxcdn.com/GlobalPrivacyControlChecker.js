!(function () {
  ...
  var n = {
    ...
    l = function () {
      return { withCredentials: !0, url: c + "/v1/user-settings/gpc" };
    },
    C = function () {
      var e = l();
          ...
          switch (e.label) {
              ...
              if (
                null !==
                  (b =
                    null ===
                      (b =
                        null === w.deviceMeta || void 0 === w.deviceMeta
                          ? void 0
                          : w.deviceMeta.getDeviceMeta()) || void 0 === b
                      ? void 0
                      : b.isInApp) &&
                void 0 !== b &&
                b
            ...
            case 2:
              return (
                (a = e.sent()),
                (t = a.gpcVersion),
                (r = a.cooldownPeriodInMs),
                (n = a.cooldownPeriodFuzzyInMs),
                [3, 4]
              );
            case 3:
            ...
            case 8:
              try {
                (null === o && (o = {}),
                  ...
                  (f = new Date(s)),
                  ((h = {}).gpcVersion = t),
                  (h.nextTimeToCheck = f.toISOString()),
                  (p = w.authenticatedUser.id),
                  (o[p] = h),
                  Object.keys(o).length > E &&
                    ((v = null),
                    (d = 1 / 0),
                    Object.keys(o)
                      .filter(function (e) {
                    ...
                    v && delete o[v]),
                  g.localStorageService.setLocalStorage(m, o));
              } catch (e) {
                if (
                  (console.error("Error updating local storage for handleGlobalPrivacyControl"),
                  e instanceof SyntaxError)
                )
                  return (g.localStorageService.removeLocalStorage(m), [2]);
                throw e;
              }
              return [2];
          }
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("GlobalPrivacyControlChecker");
