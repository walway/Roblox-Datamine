!(function () {
    ...
    T = {
      ...
      serviceData: {
        ...
        logConstants: {
          ...
          captchaInitiatedChallengeTypes: { visible: "visible", hidden: "hidden", error: "error" }
        }
      },
      types: {
        signup: "signup",
  ...
  function m(e) {
    ...
    (s &&
      ...
      (t = (function (e) {
        for (
          var t = h.captchaSolvedPrefix, n = h.captchaSolveTimeIntervals, a = 0;
          a < n.length;
          a++
        ) {
          var i = n[a];
      ...
      window.EventTracker && window.EventTracker.fireEvent(E(d + t)),
      (s = null)),
      w(d, e, n));
  }
  function S(e, t, n) {
    p.EventStream &&
      ...
      p.EventStream.SendEventWithTarget(
        "captcha",
        e,
        { solveDuration: t, success: n, provider: "Google" },
        p.EventStream.TargetTypes.WWW
      ));
  }
  function w(e, t, n) {
    t = { "g-Recaptcha-Response": t, isInvisible: v.invisible };
    c().ajax({
      method: "POST",
      data: t,
      success: function () {
        (window.EventTracker && window.EventTracker.fireEvent(E(e + h.successSuffix)),
          S(e, n, !0),
          u && (u(), c()("#" + o).empty()));
      },
      error: function () {
        (window.EventTracker && window.EventTracker.fireEvent(E(e + h.failSuffix)),
          S(e, n, !1),
          l && l(),
          p.BootstrapWidgets &&
            p.BootstrapWidgets.ToggleSystemMessage(
              c()(".alert-warning"),
              100,
              2e3,
              T.messages.error
    ...
    (h = T.serviceData),
    {
      ...
      reset: function (e, t, n, a) {
        ((d = e),
          ...
          (f = a),
          window.grecaptcha &&
            (window.grecaptcha.reset(r), v.invisible && window.grecaptcha.execute(r)));
      },
      render: function (e, t, n, a, i) {
        ((d = t),
          ...
          (o = e),
          window.grecaptcha &&
            ((i = { sitekey: h.sitekey, callback: m, badge: h.badgePosition }),
            v.invisible && (i.size = "invisible"),
            (r = window.grecaptcha.render(e, i)),
            window.EventTracker && window.EventTracker.fireEvent(E(d + h.displayedSuffix)),
            (s = g())));
      },
      execute: function () {
      ...
      ((this.provider = e),
        ...
        (this.setPerAppTypeLoggingEnabled = function (e) {
          ...
          void 0 === n
            ? (p.UrlParser &&
                ...
                o && o.appTypes && o.appTypes.hasOwnProperty(t) && (a = t)),
              null == a &&
                p.DeviceMeta &&
                (0, p.DeviceMeta)().isInApp &&
                (a = (0, p.DeviceMeta)().appType),
              null !== a && ((s = e), (i = a)))
            : (i = n);
        }),
        ...
        (this.fireEvent = function (e, t) {
          (this.fireEventCaptcha(e, t),
            (t = a(e + this.provider + t)),
            window.EventTracker && window.EventTracker.fireEvent(n(t)));
        }),
        ...
        (this.logSuccess = function (e) {
          ...
          (this.fireEvent(e, r.successSuffix),
            this.fireSolveTimeCaptcha(e, r.successSuffix, this.eventTimer.end(t)),
        ...
        (this.logMaxFail = function (e) {
          var t = a(e + this.provider + r.completedTimeSequenceSuffix);
          (this.fireEvent(e, r.maxFailSuffix),
            this.fireSolveTimeCaptcha(e, r.completedTimeSequenceSuffix, this.eventTimer.end(t)),
        ...
        (this.logTriggered = function (e) {
          (this.fireEvent(e, r.triggeredSuffix),
            this.startStatisticsSequence(a(e + this.provider + r.completedTimeSequenceSuffix)));
        }),
        ...
        (this.logCaptchaShownEventToEventStream = function (e, t, n) {
          this.logCaptchaInitiatedEventToEventStream(
            e,
            r.captchaInitiatedChallengeTypes.visible,
            t,
            n
          );
        }),
        (this.logCaptchaSuppressedEventToEventStream = function (e, t, n) {
          this.logCaptchaInitiatedEventToEventStream(
            e,
            r.captchaInitiatedChallengeTypes.hidden,
            t,
            n
          );
        }),
        (this.logCaptchaErrorEventToEventStream = function (e, t, n, a) {
          this.logCaptchaInitiatedEventToEventStream(
            e,
            r.captchaInitiatedChallengeTypes.error,
            t,
            n,
            a.toString()
          );
        ...
        (this.logCaptchaInitiatedEventToEventStream = function (e, t, n, a, i) {
          p.EventStream &&
            ...
            "" !== n && void 0 !== n && (t.session = n),
            "" !== a && void 0 !== a && (t.ucid = a),
            "" !== i && void 0 !== i && (t.message = i),
            p.EventStream.SendEventWithTarget(
              r.eventStreamCaptchaInitiatedEventName,
              e,
              t,
              p.EventStream.TargetTypes.WWW
            ));
        ...
        (this.logCaptchaTokenReceivedEventToEventStream = function (e, t, n) {
          p.EventStream &&
            p.EventStream.SendEventWithTarget(
              r.eventStreamCaptchaTokenReceivedEventName,
              e,
              { provider: this.provider, session: t, ucid: n || "" },
              p.EventStream.TargetTypes.WWW
            );
        }),
  ...
  ((window.Roblox.Captcha = t),
    (window.Roblox.CaptchaLogger = b),
    (window.Roblox.FunCaptcha = e),
    (window.Roblox.CaptchaV2ServiceCaptchaIdBase = 0),
    (window.Roblox.CaptchaConstants = T));
})();
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("CaptchaCore");
