...
Roblox.LangDynamic["Feature.AccountSecurityPrompt"] = {
  ...
  "Description.AddYourEmailUnder13":
    "To keep your account safe, please add your parent's email and reset your password.",
  "Description.AddYourEmail":
    "To keep your account safe, please add your email and reset your password.",
  ...
  "Description.EnterYourAccountPin":
    "Please enter the PIN for this account to change your password.",
  ...
  "Description.ChangeYourPasswordClickHere":
    "To keep your account safe, please click here to change your password.",
  "Message.Error.PasswordValidation.Default": "An unknown error occurred.",
  "Message.Error.PasswordValidation.WeakPassword":
    "Password must be at least 8 characters long and include at least 2 digits, 4 letters, and 1 symbol.",
  ...
  "Description.ChangeYourPasswordImmediately":
    "To keep your account safe, please change your password immediately.",
  "Description.ChangeYourPasswordImmediatelyClickHere":
    "To keep your account safe, please click here to change your password immediately.",
  "Description.NoChangeForceReset":
    "If you don't change it, your password will be automatically reset in {boldStart}{days} days{boldEnd}.",
  ...
  "Label.AuthenticatorUpsellTwoFactorMessage":
    "Enter password and unique codes from another device for logins, big purchases and more.",
  ...
  "Label.AuthenticatorUpsellProtectRobuxMessage":
    "Extra security so that you never lose access to your experiences, robux, limiteds and more.",
  "Label.AuthenticatorUpsellBadActorHeadline": "Keep Bad Actors Out",
  "Label.AuthenticatorUpsellBadActorMessage":
    "Even if your password or email is stolen, it won’t be enough to log into your account.",
  ...
  "Label.AuthenticatorUpsellDownloadInstruction":
    "Download an Authenticator app on your device. We suggest the following apps.",
  ...
  "Description.NoChangeForceResetSingular":
    "If you don't change it, your password will be automatically reset in {boldStart}1 day{boldEnd}.",
  ...
  "Description.AuthenticatorSetupPromptClickHere":
    "Your security is important to us: {styleTagStart}Click here{styleTagEnd} to set up Authenticator.",
  ...
  "Description.ChangeYourPasswordClickHereStyled":
    "To keep your account safe, please {styleTagStart}click here{styleTagEnd} to change your password.",
  ...
  "Header.KeepYourAccountSafeLong":
    "Keep Your Account Safe With 2-Step Verification Via Authenticator",
  ...
  "Header.AccountRestorePolicyMessageSubject":
    "Enable 2-step verification via authenticator to keep your account safe",
  ...
  "Description.ReceiveSecurityCodesMessage":
    "Receive security codes on another device to protect your experiences, robux, limiteds, communities, and more.",
  "Action.SetUpAuthenticatorInBanner": "Set Up Authenticator",
  "Header.AccountRestoresPolicyUpdateV3":
    "Make Sure 2-Step Verification via Authenticator is Enabled",
  ...
  "Description.AccountRestoresPolicyUpdateV3Short":
    "If your account is compromised, it is unlikely that Roblox will be able to restore your account.",
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected(
    "DynamicLocalizationResourceScript_Feature.AccountSecurityPrompt"
  );
