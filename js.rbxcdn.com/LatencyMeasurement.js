!(function (r) {
  ...
  11: function (t, e, r) {
    ...
    function p(t, e, r, n, o, i, s) {
      var a = { start: n, size: r, d: o, ttfb: i, sc: e };
      if ((s && (a.via = s.via), !t || !window.performance || !window.performance.getEntriesByName))
        return a;
      var u = window.performance.getEntriesByName(t);
      if (0 == u.length && 0 == (u = window.performance.getEntriesByName(t + "/")).length) return a;
      var c = u[u.length - 1];
      return (
        "decodedBodySize" in c && 0 < c.decodedBodySize && (a.size = c.decodedBodySize),
        c.duration
          ? (a.d = c.duration)
          : c.startTime && c.responseEnd && (a.d = c.responseEnd - c.startTime),
        c.requestStart &&
          ((a.dns = c.domainLookupEnd - c.domainLookupStart),
          (a.rtt = c.responseStart - c.requestStart),
          (a.ttfb = c.responseStart - c.startTime),
          (a.tcp = c.connectEnd - c.connectStart),
          0 === c.secureConnectionStart
            ? (a.tls = 0)
            : void 0 !== c.secureConnectionStart &&
              ((a.tls = c.connectEnd - c.secureConnectionStart), (a.tcp -= a.tls))),
        a
      );
    }
    function f(t) {
    ...
    var n =
      ((o.prototype.get = function (n, t, o, e) {
        var i;
        try {
          i = u();
        } catch (t) {
      ...
      (o.prototype.getData = function (t, e, r, n) {
        ...
        "withCredentials" in o
          ? (n.withCookies && (o.withCredentials = !0),
            e && (o.timeout = e),
            c(),
            o.open("GET", t, !0),
  ...
  17: function (t, e, r) {
    ...
    var o =
      ((i.prototype.getRecipe = function (t, u) {
        var e = this.url,
          r = -1 === e.indexOf("?") ? "?" : "&";
        ((e = e + r + "iteration=" + t),
          i.requester.getData(
              ...
              if (200 == t && null != r)
                try {
                  ...
                  if (
                    ...
                    throw new Error(o + ".targets: not an array");
                  for (var i = 0, s = n.targets.length; i < s; i++) {
                    ...
                    if (!f(a.target))
                      throw new Error(o + ".targets[" + i + "].target: not a string");
                  }
                  u(n);
                } catch (t) {
  ...
  18: function (t, e, r) {
    ...
    var n =
      ((o.prototype.getRecipe = function (t, e) {
        e(this.recipe);
      }),
      o);
    function o(t) {
  ...
  26: function (t, e, r) {
    ...
    var n =
      ((o.prototype.run = function (t, e) {
        this.requester.get(t.target, this.timeout, e, { withCookies: !1 });
      }),
      o);
    function o(t, e) {
    ...
    var i =
      ((s.prototype.getTester = function (t, e) {
    ...
    var a =
          ...
          this.forEachTarget(i, function (n) {
            for (
              var r = [],
                ...
                t = function () {
                  (a.push({ name: n.name, target: n.target, data: r }), u.done());
                },
                e = i.pulses - 1;
              0 <= e;
              e--
      ...
      (u.prototype.handleResult = function (t, e) {
        (this.reporter({ ctx: t.ctx, name: t.name, type: t.type, data: e }),
          this.nextJob &&
            (0 < t.next
              ? (this.nextJob = this.scheduleAfter(t.next, this.run.bind(this)))
              : ((this.completed = !0), this.stop())));
      }),
      u);
    function u(t, e) {
      ((this.recipeProvider = t),
        (this.reporter = e),
        (this.iteration = 0),
        (this.completed = !1),
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("LatencyMeasurement");
