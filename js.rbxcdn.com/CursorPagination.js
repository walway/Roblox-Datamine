!(function () {
  var t = {
      2966: function (e, r, t) {
        var n = { "./cursorPagiantionResource.js": 5614, "./cursorPaginationConstants.js": 3448 };
        function o(e) {
          e = a(e);
          return t(e);
        }
      ...
      8105: function (e, r, t) {
        var n = { "./cursorPaginationDirective.js": 8290 };
        function o(e) {
          e = a(e);
          return t(e);
        }
      ...
      8386: function (e, r, t) {
        var n = { "./cursorPaginationService.js": 5647, "./cursorPaginationServiceV2.js": 2504 };
        function o(e) {
          e = a(e);
          return t(e);
        }
      ...
      3703: function (e, r, t) {
        var n = { "./directives/templates/cursorPagination.html": 3583 };
        function o(e) {
          e = a(e);
          return t(e);
        }
      ...
      5614: function (e, r, t) {
        "use strict";
        t.r(r);
        var n = { templateUrls: { cursorPagination: "cursor-pagination" } };
      ...
      3448: function (e, r, t) {
        ...
        var n = t(2459),
          o = t(4720);
        (n.Z.constant("cursorPaginationConstants", o.cursorPaginationConstants),
          (r.default = o.cursorPaginationConstants));
      },
      2459: function (e, r, t) {
        "use strict";
        t.d(r, {
      ...
      8290: function (e, r, t) {
        ...
        ((n.$inject = ["cursorPaginationResource"]),
          t.Z.directive("cursorPagination", n),
          (r.default = n));
      },
      5647: function (e, r, t) {
        "use strict";
              ...
              createPager: function (s) {
                ...
                function t(r) {
                  var t = d(),
                    ...
                    o = l.defer();
                  if (
                    (o.promise.then(s.loadSuccess, s.loadError),
                    n.length === s.pageSize || "string" != typeof g[t])
                  )
                    return ((i = r), o.resolve(n), o.promise);
                  ((c[s.cursorName] = g[t]), s.beforeLoad && s.beforeLoad(r, c), (u = !0));
                  var e = { url: s.getRequestUrl(c) },
                    a = s.getQueryParameters(c);
                  return (
                    P.httpGet(e, a).then(
                      function (e) {
                        ((i = r),
                          (g[t] = s.getNextPageCursorFromResponse(e)),
                          s.getDataListFromResponse(e).then(
                            function (e) {
                              Array.isArray(e)
                                ? (f.append(t, e), (n = f.getPage(t, r)), (u = !1), o.resolve(n))
                                : ((u = !1),
                                  o.reject([
                ...
                return (
                  (s.limitName = s.limitName || "limit"),
                  (s.cursorName = s.cursorName || "cursor"),
                  (s.sortOrderName = s.sortOrderName || "sortOrder"),
                  (s.sortOrder = s.sortOrder || this.sortOrder.Asc),
                  (c[s.cursorName] = r),
                  (c[s.sortOrderName] = s.sortOrder),
                  (c[s.limitName] = s.loadPageSize),
                  (s.getDataListFromResponse =
                    s.getDataListFromResponse || this.getDataListFromResponseMethods.defaultV1),
                  (s.getNextPageCursorFromResponse =
                    s.getNextPageCursorFromResponse ||
                    this.getNextPageCursorFromResponseMethods.defaultV1),
                  (s.getErrorsFromResponse =
                    s.getErrorsFromResponse || this.getErrorsFromResponseMethods.defaultV1),
                  (s.getQueryParameters =
                    s.getQueryParameters || this.getQueryParametersMethods.defaultV1),
                  (s.loadSuccess = s.loadSuccess || function () {}),
                  (s.loadError = s.loadError || function () {}),
                  {
                    isBusy: function () {
                      return u;
                    },
        ...
        ((n.$inject = ["$q", "$rootScope", "httpService", "cacheService"]),
          t.Z.service("cursorPaginationService", n),
          (r.default = n));
      },
      2504: function (e, r, t) {
        "use strict";
  ...
  ((o.n = function (e) {
    ...
    (function () {
      ...
      var e = o(5734),
        ...
        t = o(3544),
        e = (o(2459), o(3703));
      ((0, t.templateCacheGenerator)(r(), "cursorPaginationHtmlTemplate", e),
        (0, t.importFilesUnderPath)(o(2966)),
        (0, t.importFilesUnderPath)(o(8105)),
        (0, t.importFilesUnderPath)(o(8386)));
    })());
})();
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("CursorPagination");
