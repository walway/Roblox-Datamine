        ...
        : "undefined" != typeof global
          ...
          : "undefined" != typeof globalThis
            ...
            : "undefined" != typeof self
              ? self
              : {};
    e.SENTRY_RELEASE = { id: "0921efeeb7915525c34339f0bd121e150ef14a90" };
    var n = new e.Error().stack;
    n &&
      ((e._sentryDebugIds = e._sentryDebugIds || {}),
      (e._sentryDebugIds[n] = "d149589c-8da3-43bd-aa73-c743a6a48a31"),
      (e._sentryDebugIdIdentifier = "sentry-dbid-d149589c-8da3-43bd-aa73-c743a6a48a31"));
  } catch (e) {}
})(),
  (function () {
    var e = {
...
*/ (function () {
    ...
    ((t.p = o
      ...
      (function () {
        ...
        var e = window.ReactJSX,
          ...
          i = { banner: "banner", consentTool: "consentTool" },
          a = window.React,
          s = function (e) {
            var n,
              t = "".concat(e, "="),
              o =
                null ==
                (n = document.cookie.split("; ").find(function (e) {
                  return e.startsWith(t);
                }))
                  ? void 0
                  : n.split("=")[1];
            return null == o ? null : { name: e, value: decodeURIComponent(o) };
          },
          c = function (e, n, t) {
            var o,
              r = null == t.sameSite ? "" : ";samesite=".concat(t.sameSite),
            ...
            document.cookie = ""
              .concat(e, "=")
              .concat(encodeURIComponent(n), ";secure")
              .concat(r)
              .concat(i)
              .concat(a)
              .concat(s)
          ...
          u = function (e, n) {
            c(e, "", { domain: n.domain, path: n.path, expires: new Date(0) });
          },
        ...
        var h = function () {
          ...
          g = t.n(x),
          v = function (e, n) {
            s(m) && u(m, { domain: g().domain });
            var t = "",
              o = [];
            (n.forEach(function (r, i) {
              (e.includes(r)
                ? (t += "".concat(r, "=true&"))
                : ((t += "".concat(r, "=false&")), o.push(r)),
                i === n.length - 1 && (t = t.slice(0, -1)));
            }),
              o.forEach(function (e) {
                u(e, { domain: g().domain });
              }),
              l(m, t, { maxAge: 15552e3, domain: g().domain }));
          },
          k = function () {
            var e = s(m);
            return (
          ...
          E = function (n) {
            var t = n.nonEssentialCookieList,
              ...
              d = (0, e.jsx)("span", { className: "text", children: c.substring(0, l) }),
              f = y.length,
              p = (0, e.jsx)("span", { className: "text", children: c.substring(l + f) }),
              h = (0, e.jsx)("a", {
                className: "text-link",
                target: "_blank",
                href: u,
          ...
          _ = function (n) {
            ...
            return (0, e.jsxs)("div", {
              ...
              children: [
                (0, e.jsx)("p", { className: "cookie-name font-body text", children: t }),
                (0, e.jsx)("p", { className: "cookie-description font-footer", children: o })
              ]
            });
          },
          H = function (n) {
            var t = n.translate,
              ...
              d = (0, e.jsxs)("div", {
                ...
                children: [
                  (0, e.jsx)(_, { cookieName: T, description: t(L) }),
                  (0, e.jsx)(_, { cookieName: B, description: t(O) })
                ]
              });
            return (0, e.jsxs)("div", { className: r, children: [d, u] });
          };
        function G(e, n) {
            ...
            (function (e, n) {
              ...
              if (null != r) {
                ...
                try {
                  for (
                    r = r.call(e);
                    !(a = (t = r.next()).done) && (i.push(t.value), !n || i.length !== n);
                    a = !0
                  );
                } catch (e) {
                  ((s = !0), (o = e));
        ...
        var V = M((0, N.createModal)(), 2),
          ...
          W = function (n) {
            ...
            var g = R()({ hidden: !p }),
              j = R()("cookie-consent-tool-collaps", { on: y }),
              C = R()("cookie-consent-tool-collaps font-header-2 text-emphasis ", { on: p }),
              ...
              P = o.map(function (n) {
                return (0, e.jsx)(
                  _,
                  { cookieName: n.cookieName, description: r(n.description) },
                  n.cookieName
                );
              }),
              U = (0, e.jsxs)("div", { children: [L, T] }),
              G = (0, e.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, e.jsx)("div", { className: g, children: P })
                ]
              }),
              V = (0, e.jsxs)("div", {
                ...
                children: [
                  ...
                  G,
                  O,
                  (0, e.jsx)(H, { isNonEssentialCookieListVisible: y, translate: r })
                ]
              });
            return (0, e.jsx)(X, {
                ...
                ((e = function () {
                  ...
                  return (function (e, n) {
                    ...
                    switch (n.label) {
                      ...
                      case 1:
                        return (
                          (e = n.sent()).ShouldDisplayCookieBannerV3 && e.EssentialCookieList
                            ? (c(e.NonEssentialCookieList), d(e.EssentialCookieList), b(i.banner))
                            : v(e.NonEssentialCookieList, e.NonEssentialCookieList),
                          [2]
                        );
                    }
                  });
  ...
  window.Roblox &&
    ...
    window.Roblox.BundleDetector.bundleDetected("CookieBannerV3"));
