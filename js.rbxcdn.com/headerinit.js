...
(function (window, undefined) {
  var document = window.document,
    ...
    resourceMap = {},
    config = { baseUrl: "", modulePath: "/js/modules", paths: {}, externalResources: [] };
...
Roblox.Constants = (function () {
  return {
    ...
    keyCodes: { enter: 13 },
    events: { ClickShareGameToChat: { name: "ShareGameToChat", context: "ClickShareIcon" } }
  };
})(); // jquery.cookie.js
...
if (typeof Roblox.EventStream === "undefined") {
  Roblox.EventStream = (function () {
    ...
    function getEventParameters(eventName, context, additionalProperties) {
      ...
      var defaultParams = { evt: eventName, ctx: context, url: url, lt: new Date().toISOString() };
      if (!serviceWorkerMode) {
...
Roblox.Utilities.ExponentialBackoffSpecification = function (options) {
  ...
  var firstAttemptDelay =
    typeof options.firstAttemptDelay === "number" ? options.firstAttemptDelay : 5000;
  ...
  var maximumDelayBase =
    typeof options.maximumDelayBase === "number" ? options.maximumDelayBase : 5 * 60 * 1000;
