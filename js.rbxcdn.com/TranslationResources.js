(!(function () {
        ...
        (r = [
          {
            ...
            value: function (r, e) {
              if (!r || "string" != typeof r)
                throw TypeError("Parameter 'key' must be provided and it should be a string");
              var t,
                n = this.resourceMap[r] || "";
              if (
                (n ||
                  console.warn(
                ...
                if (
                  ...
                  try {
                    ...
                    console.warn(
                      "Failed to format translation key '"
                        .concat(r, "': ")
                        .concat(
                          null != (t = null == e ? void 0 : e.message) ? t : e,
                          ". Check that the provided parameters match the translation string."
                        )
                    );
                  }
                else
      ...
      (r = [
          ...
          value: function (r) {
            ...
            return (
              0 === Object.keys(a).length &&
                console.warn("The namespace ".concat(r, " was not found")),
              new i(this.intl, a, r)
            );
          }
        },
        {
          ...
          value: function () {
            ...
            return t.combineTranslationResources.apply(
              t,
              [this.intl].concat(
                (function (r) {
  ...
  (a(["Roblox", "core-scripts", "intl", "translation"], n),
    a(["Roblox", "TranslationResourceProvider"], f));
})(),
  window.Roblox &&
