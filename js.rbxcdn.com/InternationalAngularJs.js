!(function () {
  var r = {
      ...
      268: function (t, e, r) {
        var n = { "./languageResourceProvider.js": 488 };
        function o(t) {
          t = u(t);
          return r(t);
        }
        ...
        function n(u) {
          return function (t, o) {
            ...
            return (
              ...
              e.replace(/(\d+)/g, function (t, e, r, n) {
                if (e) {
                  e = Number(e);
      ...
      226: function (t, e, r) {
        ...
        ((n.$inject = ["languageResource", "$log"]),
          r.Z.filter("translateParams", n),
          (e.default = n));
      },
      341: function (t, e, r) {
        "use strict";
      ...
      488: function (t, e, r) {
        ...
        function i() {
          ...
          ((this.setTranslationResources = function (t) {
            t = o.TranslationResourceProvider.combineTranslationResources.apply(
              o.TranslationResourceProvider,
              [e].concat(u(t))
            );
